...
---
= Sustituir un módulo de E/S en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para sustituir un módulo de E/S en tu sistema FAS9500, debes apagar el nodo afectado, retirar e instalar el módulo de E/S y luego reiniciar el nodo.
