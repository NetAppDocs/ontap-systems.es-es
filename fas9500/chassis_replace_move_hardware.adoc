...
+
.. Cuando cada nodo inicie el arranque, pulse `Ctrl-C` Para interrumpir el proceso de arranque cuando aparezca el mensaje Pulse Ctrl-C para Boot Menu (Menú de inicio).
+
