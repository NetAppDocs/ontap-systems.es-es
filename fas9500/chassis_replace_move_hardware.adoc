...
summary: Para sustituir el chasis, debe quitar los componentes del chasis dañado e instalarlos en el chasis de reemplazo. 
---
= Sustituir el chasis en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Debes retirar los seis módulos de ventilación, situados en la parte delantera del chasis, al sustituir el chasis.
...
. Deja el módulo controlador a un lado en un lugar seguro y toma nota de la ranura del chasis de la que procede, para poder instalarlo en la misma ranura del chasis de recambio.
...
Una vez instalado el chasis de recambio en el rack o en el armario del sistema, debes volver a instalar en él los módulos de alimentación del controlador de desescalado.
