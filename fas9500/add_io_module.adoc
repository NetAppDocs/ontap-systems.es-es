...
. Si ha instalado un módulo de I/o de almacenamiento, instale y cablee las bandejas SAS, como se describe en https://["Adición en caliente de una bandeja SAS"^].
...
Módulo de almacenamiento
 a| 
Instale y conecte los cables de las bandejas SAS, como se describe enhttps://["Adición en caliente de una bandeja SAS"^].
