...
Puede añadir un módulo de I/o a una ranura para módulos vacía del sistema como NIC o módulo de almacenamiento para las bandejas de almacenamiento SAS.
...
+
La conexión de la consola muestra que el nodo cae al aviso del CARGADOR cuando se completa la toma.
