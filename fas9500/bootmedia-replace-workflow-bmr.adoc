...
summary: Comience a reemplazar el medio de arranque en su sistema de almacenamiento FAS9500 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el medio de arranque, restaurando la imagen en el medio de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo para reemplazar el soporte de arranque en un sistema FAS9500 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comienza a sustituir el soporte de arranque de tu sistema de almacenamiento FAS9500 mediante el proceso automatizado de recuperación del arranque. El sistema identifica y selecciona automáticamente la opción adecuada del menú de arranque y luego utiliza la imagen de arranque del nodo asociado para reinstalar ONTAP en el soporte de arranque de sustitución.
