...
sidebar: sidebar 
keywords: FAS9500 
summary: En esta página encontrarás instrucciones detalladas paso a paso para instalar tu sistema FAS9500. 
---
= Instala un sistema de almacenamiento FAS9500 usando instrucciones detalladas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esta página ofrece instrucciones detalladas paso a paso para instalar tu sistema FAS9500. Usa estas instrucciones si quieres instrucciones de instalación más detalladas.
...
X66033A (112-00438), 3 m.
 a| 
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Conector mini SAS]
 a| 
Reducida
...
Conecta los puertos b del lado del host en las ranuras A4 y B4 (e4b) y en las ranuras A8 y B8 (e8b) al conmutador del host.
...
** Conecta los cables de alimentación a las PSUs y conéctalos a diferentes fuentes de alimentación (no se muestran). PSU1 y PSU3 suministran energía a todos los componentes del lado A, mientras que PSU2 y PSU4 suministran energía a todos los componentes del lado B.
...
* Asegúrate de consultar la flecha de la ilustración para ver la orientación correcta de la lengüeta de extracción del conector del cable. La lengüeta de extracción del cable de los módulos de almacenamiento está hacia arriba, mientras que las de los estantes están hacia abajo.
...
.Pasos
. Utiliza la siguiente animación o los dibujos para conectar tus controladores a tres (una pila de un bastidor de unidades y una pila de dos bastidores de unidades) estantes de unidades DS224C.
+
...
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Cable de disco duro mini-SAS]
...
+
image::../media/drw_a900_power-on_IEOPS-941.svg[Encienda el sistema]
