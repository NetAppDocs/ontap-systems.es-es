...
---
= Intercambia en caliente un módulo de ventilador en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para realizar un intercambio en caliente de un módulo de ventilador en tu sistema FAS9500 sin interrumpir el servicio, debes seguir una secuencia específica de tareas.


IMPORTANT: Se recomienda sustituir el módulo del ventilador en un plazo de dos minutos tras haberlo extraído del chasis. El sistema sigue funcionando, pero ONTAP envía mensajes a la consola sobre el módulo del ventilador degradado hasta que se sustituya el módulo del ventilador.
