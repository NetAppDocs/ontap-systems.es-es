...
---
= Especificaciones clave de un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta las especificaciones seleccionadas del sistema de almacenamiento FAS9500 en un único par de alta disponibilidad (HA) y visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para ver la lista completa de especificaciones del FAS9500.
...
* Temperatura/altitud/humedad de funcionamiento: 10 °C a 35 °C (50 °F a 95 °F) a una altitud de hasta 3048 m (10 000 pies); humedad relativa del 8 % al 90 %, sin condensación
...
* Ruido acústico: Potencia sonora declarada (LwAd): 7,4; Presión sonora (LpAm) (posición de transeúntes): 65,0 dB
