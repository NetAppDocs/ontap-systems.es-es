...
sidebar: sidebar 
keywords: FAS9500 
summary: Para intercambiar en caliente un módulo de alimentación de controlador de destage DCPM, que contiene la batería NVRAM11, debes localizar el módulo DCPM averiado, extraerlo del chasis e instalar el módulo DCPM de sustitución. 
---
= Sustituye el módulo DCPM y la batería NVRAM11 de tu sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Debes tener a mano un módulo DCPM de repuesto antes de retirar el módulo averiado del chasis. Debes sustituirlo en un plazo de cinco minutos tras su retirada. Después de retirar el módulo DCPM del chasis, el módulo controlador que posee el módulo DCPM no tiene protección contra el apagado, salvo la conmutación por error al otro módulo controlador.
...
+
El LED permanece en color ámbar fijo si el módulo está defectuoso.
