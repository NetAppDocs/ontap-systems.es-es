...
summary: Sustituye el DIMM en un sistema FAS9500 cuando el sistema notifique un número excesivo de errores de memoria ECC corregibles a través de alertas de Health Monitor, o errores ECC no corregibles. Un DIMM defectuoso puede impedir que el sistema de almacenamiento arranque ONTAP, así que al reemplazarlo se restablece el funcionamiento estable. 
---
= Sustituye un módulo DIMM en un sistema FAS9500 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM en un sistema FAS9500 cuando el sistema notifique un número excesivo de errores de memoria ECC corregibles a través de alertas de Health Monitor, o errores ECC no corregibles. Un DIMM defectuoso puede impedir que el sistema de almacenamiento arranque ONTAP, así que al reemplazarlo se restablece el funcionamiento estable.
