...
+
*** Si aparece un aviso y advierte que al entrar en modo de mantenimiento en una configuración de alta disponibilidad, debe asegurarse de que el nodo en buen estado permanece inactivo.
