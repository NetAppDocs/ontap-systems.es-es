...
NOTE: Consulte https://docs.netapp.com/ontap-9/topic/com.netapp.nav.cr/home.html["Páginas manuales de comandos"^] Para su versión de ONTAP para obtener más información.
