...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[el controlador de detección automática drw selecciona ieops 1849]

+
.. Abra el Explorador de archivos.
.. Haga clic en Red en el panel izquierdo, haga clic con el botón derecho y seleccione Actualizar.
