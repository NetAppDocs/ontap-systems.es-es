...
Debe tener acceso a https://["Hardware Universe de NetApp"^] para obtener información acerca de los requisitos del sitio así como información adicional sobre el sistema configurado.

.Lo que necesita
Puede que también desee tener acceso a http://["Notas de la versión de ONTAP 9"^] Para su versión de ONTAP para obtener más información sobre este sistema.
...
|===
. Revise la https://["Guía de configuración de ONTAP"^] y recopilar la información necesaria que aparece en esa guía.
...
image::../media/oie_cable_pull_tab_up.svg[lengüeta para tirar del cable de la oie]
...
NOTE: Para obtener más información y hojas de trabajo sobre el cableado SAS, consulte https://["Información general sobre las reglas, hojas de trabajo y ejemplos de cableado SAS: Bandejas con módulos IOM12"^]

.Antes de empezar
* Rellene la hoja de datos del cableado SAS para el sistema. Consulte https://["Información general sobre las reglas, hojas de trabajo y ejemplos de cableado SAS: Bandejas con módulos IOM12"^].
...
. Utilice la configuración guiada de System Manager para configurar el sistema con los datos recogidos en el https://["Guía de configuración de ONTAP"^].
