...
---
= Restablece el cifrado en el soporte de arranque de un sistema FAS9500 después del proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de que reemplaces el soporte de arranque en tu sistema FAS9500, restaura el cifrado siguiendo los pasos para tu tipo de gestor de claves, como el Onboard Key Manager (OKM).
