...
---
= Restaurar y verificar la configuración del controlador en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la sustitución del hardware, verificas la configuración de bajo nivel del sistema del controlador de reemplazo, incluyendo la hora del sistema y el estado de HA, y vuelves a configurar los ajustes del sistema según sea necesario.
