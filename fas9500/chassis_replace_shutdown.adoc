...
summary: Antes de poder sustituir el chasis, debes apagar el controlador averiado de tu sistema FAS9500. 
---
= Apaga los controladores del FAS9500 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de poder sustituir el chasis, debes apagar el controlador averiado de tu sistema FAS9500.
