...
---
= Completa la sustitución del chasis de un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del chasis en tu sistema FAS9500, debes comprobar y configurar el estado de alta disponibilidad (HA) del chasis, volver a poner en marcha el sistema y devolver el chasis averiado a NetApp, como se describe en las instrucciones de RMA incluidas con el kit.
