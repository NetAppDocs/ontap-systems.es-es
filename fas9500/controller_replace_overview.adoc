...
---
= Revisa los requisitos antes de sustituir el controlador en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* En este procedimiento, el dispositivo de arranque se traslada del nodo averiado al nodo de sustitución, de modo que el nodo de sustitución se inicie con la misma versión de ONTAP que el módulo controlador antiguo.
