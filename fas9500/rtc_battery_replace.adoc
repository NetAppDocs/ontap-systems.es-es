...
summary: Sustituye la batería del reloj en tiempo real en el módulo controlador. 
---
= Sustituir la batería del reloj en tiempo real en un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_9500_remove_RTC_battery.svg[Sustituya la batería del RTC]
...
Una vez sustituida la batería del RTC, debes volver a instalar el módulo controlador. Si la batería del RTC ha estado fuera del módulo controlador durante más de 10 minutos, es posible que tengas que volver a ajustar la hora y la fecha.
