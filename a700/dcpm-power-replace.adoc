...
---
= Sustituye el módulo DCPM de tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo DCPM de tu sistema AFF A700 para restablecer la gestión adecuada de la energía para la NVRAM10.
