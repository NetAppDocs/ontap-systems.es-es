...
---
= Agrega un módulo X91148A a tu sistema AFF A700 utilizando una ranura libre
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Añade un módulo X91148A a tu sistema AFF A700 usando una ranura libre disponible en el chasis.
