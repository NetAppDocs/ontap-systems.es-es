...
---
= Revisa los requisitos antes de sustituir el controlador en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF A700, revisa los requisitos previos para el procedimiento de sustitución y selecciona el adecuado para tu versión de ONTAP.
