...
summary: Después de completar la sustitución del medio de arranque, realiza la operación de conmutación MetroCluster para devolver la configuración a su estado de funcionamiento normal. El sistema AFF A700 solo admite procedimientos manuales de recuperación del medio de arranque. 
---
= Cambia de nuevo los agregados en una configuración de dos nodos de MetroCluster para tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
