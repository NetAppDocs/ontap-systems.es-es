...
---
= Sustituye un módulo LED USB en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo LED USB de tu sistema AFF A700 para restablecer el LED indicador de estado y la funcionalidad USB.
