...
summary: Restaura la encriptación en el medio de arranque de sustitución. El sistema AFF A700 solo admite procedimientos manuales de recuperación de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
