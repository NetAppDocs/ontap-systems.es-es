...
summary: Sustituye un DIMM en tu módulo controlador AFF A700 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituir un módulo DIMM en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM de tu sistema AFF A700 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC incorregible.
