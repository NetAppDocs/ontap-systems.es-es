...
---
= Cambia un ventilador intercambiable en caliente en tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de un ventilador en tu sistema AFF A700 sin interrumpir el servicio para mantener un flujo de aire adecuado y la refrigeración del sistema.
