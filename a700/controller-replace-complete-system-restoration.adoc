...
summary: Para restablecer el funcionamiento completo de tu sistema AFF A700, vuelve a cablear el almacenamiento, restablece la configuración de NetApp Storage Encryption si es necesario e instala licencias para el nuevo controlador. 
---
= Completa la sustitución del controlador de un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF A700 volviendo a cablear el almacenamiento, restaurando la configuración de cifrado de almacenamiento de NetApp (si es necesario) e instalando licencias para el nuevo controlador.
