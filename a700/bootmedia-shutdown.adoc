...
summary: Apague el controlador dañado en un sistema AFF A700 después de completar las comprobaciones de cifrado. El sistema AFF A700 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Apaga el controlador defectuoso de tu sistema AFF A700 durante el proceso de recuperación del arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en un sistema AFF A700 después de completar las comprobaciones de cifrado. Este procedimiento incluye llevar el controlador al indicador LOADER, capturar variables ambientales de arranque como referencia y preparar el controlador para el reemplazo del medio de arranque, con pasos específicos que varían según la configuración del sistema.
...
Después de completar las tareas de NVE o NSE, necesita completar el apagado del nodo dañado. NOTA: No utilice este procedimiento si el sistema está en una configuración MetroCluster de dos nodos.
