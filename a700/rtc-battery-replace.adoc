...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador AFF A700 para garantizar que los servicios y aplicaciones que dependen de una sincronización precisa del tiempo sigan funcionando. 
---
= Sustituir la batería del reloj en tiempo real en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A700 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
