...
---
= Sustituir un módulo de E/S en un sistema AFF A700 o un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de E/S en tu sistema AFF A700 o FAS9000 desconectando los cables, retirando el elevador, cambiando el módulo y volviendo a conectar los cables.
