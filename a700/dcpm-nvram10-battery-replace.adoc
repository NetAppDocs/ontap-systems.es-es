...
summary: Para intercambiar en caliente un módulo de alimentación del controlador de etapas, que contiene la batería NVRAM10, localiza el módulo DCPM averiado, extráelo del chasis e instala el módulo DCPM de repuesto. 
---
= Intercambia en caliente un módulo de alimentación del controlador de desescalado (DCPM) en tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de un módulo de alimentación del controlador de desescalonamiento (DCPM) en tu sistema AFF A700 para reemplazar el módulo averiado sin interrumpir el servicio.
