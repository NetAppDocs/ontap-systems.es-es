...
---
= Agrega un módulo de almacenamiento X91148A a un sistema AFF A700 cuando todos los slots están ocupados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Añade un módulo de almacenamiento X91148A a tu sistema AFF A700 cuando todas las ranuras estén ocupadas reemplazando un módulo existente.
