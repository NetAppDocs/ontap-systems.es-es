...
---
= Instalar y configurar un sistema de almacenamiento AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y configura tu sistema de almacenamiento AFF A700 eligiendo entre diferentes formatos de contenido según tu preferencia.
