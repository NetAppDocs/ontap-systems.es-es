...
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una fuente de alimentación de tu sistema AFF A700 para mantener el suministro continuo de energía al sistema.
