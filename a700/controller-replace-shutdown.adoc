...
summary: Para apagar el nodo dañado, debe determinar el estado del nodo y, si es necesario, tomar el control del nodo para que el nodo en buen estado siga sirviendo datos desde el almacenamiento de los nodos dañados. 
---
= Apaga el controlador defectuoso de un sistema AFF A700 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A700 antes de reemplazarlo, usando el procedimiento adecuado para tu configuración.
