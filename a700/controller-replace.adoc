...
---
= Sustituye el controlador de tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A700 retirando el controlador defectuoso, trasladando los componentes FRU al módulo de recambio, instalándolo en el chasis e iniciando el sistema en modo de mantenimiento.
