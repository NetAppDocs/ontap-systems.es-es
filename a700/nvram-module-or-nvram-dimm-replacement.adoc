...
---
= Sustituye el módulo NVRAM o los módulos DIMM de NVRAM de tu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo NVRAM o los módulos DIMM de NVRAM de tu sistema AFF A700 para restablecer el correcto funcionamiento de la NVRAM y el rendimiento del sistema.
