...
summary: Sustituye el soporte de arranque defectuoso en un sistema AFF A700. El sistema AFF A700 solo admite procedimientos manuales de recuperación del soporte de arranque. No se admite la recuperación automática del soporte de arranque. 
---
= Sustituye el soporte de arranque en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
