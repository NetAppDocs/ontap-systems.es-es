...
---
= Instala un sistema de almacenamiento AFF A700 siguiendo estos pasos detallados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A700 siguiendo las instrucciones detalladas paso a paso, desde el montaje en bastidores y el cableado hasta la puesta en marcha inicial del sistema.
