...
---
= Vuelve a cablear el sistema y reasigna los discos en un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF A700 volviendo a cablear el almacenamiento, restaurando NetApp Storage Encryption (si es necesario) e instalando licencias para el nuevo controlador.
