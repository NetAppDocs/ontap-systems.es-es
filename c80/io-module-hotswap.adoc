...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF C80 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Intercambia en caliente un módulo de E/S en tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF C80 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
