...
summary: Los medios de arranque de su sistema AFF C80 almacenan datos esenciales del firmware y de configuración. Si el soporte de arranque falla, debe desconectar el módulo del controlador, extraer el módulo de gestión del sistema, retirar el soporte de arranque dañado y sustituir el soporte de arranque en el módulo de gestión del sistema. 
---
...
[role="lead"]
Los medios de arranque de su sistema AFF C80 almacenan datos esenciales del firmware y de configuración. Si el soporte de arranque falla, debe desconectar el módulo del controlador, extraer el módulo de gestión del sistema, retirar el soporte de arranque dañado y sustituir el soporte de arranque en el módulo de gestión del sistema.
