...
summary: Sustituye en caliente una unidad de tu sistema AFF C80 cuando una unidad tenga error o sea necesario actualizarla. Este proceso consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad SSD en un sistema AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema AFF C80 cuando una unidad tenga error o sea necesario actualizarla. Este proceso consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema.
