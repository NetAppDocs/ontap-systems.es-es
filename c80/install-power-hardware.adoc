...
---
= Enciende tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de encender su sistema de almacenamiento AFF C80, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura tu cluster"] .
