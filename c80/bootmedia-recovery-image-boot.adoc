...
summary: Si el soporte de arranque del sistema AFF C80 está dañado, puede iniciar la imagen de recuperación desde una unidad USB, restaurar la configuración desde el nodo asociado y verificar las variables de entorno 
---
= Inicie la imagen de recuperación - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Si el soporte de arranque del sistema AFF C80 está dañado, puede iniciar la imagen de recuperación desde una unidad USB, restaurar la configuración desde el nodo asociado y verificar las variables de entorno.
