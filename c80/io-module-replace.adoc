...
summary: Sustituye un módulo IO en tu sistema AFF C80 cuando el módulo falle o requiera una actualización para soportar un mayor rendimiento o funciones adicionales. 
---
= Sustituye un módulo de E/S en tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
