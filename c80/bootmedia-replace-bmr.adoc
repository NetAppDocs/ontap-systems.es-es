...
summary: El medio de arranque de su sistema de almacenamiento AFF C80 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo de administración del sistema, retirar el medio de arranque dañado, instalar el nuevo medio de arranque en el módulo y, finalmente, reinstalarlo. 
---
= Sustituye el soporte de arranque de tu sistema de almacenamiento AFF C80 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El medio de arranque de su sistema de almacenamiento AFF C80 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo de administración del sistema, retirar el medio de arranque dañado, instalar el nuevo medio de arranque en el módulo y, finalmente, reinstalarlo.
