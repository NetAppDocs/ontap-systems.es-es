...
---
= Mantenimiento de los sistemas de almacenamiento C80 de AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Los procedimientos de mantenimiento se dan por sentado que los sistemas C80 de AFF ya se han puesto en marcha como nodo de almacenamiento en el entorno de ONTAP.
