...
summary: Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF C80 preparando el medio de reemplazo, instalándolo en el sistema, restaurando la imagen de arranque y verificando la funcionalidad del sistema. 
---
...
[role="lead"]
Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF C80 preparando el medio de reemplazo, instalándolo en el sistema, restaurando la imagen de arranque y verificando la funcionalidad del sistema.
