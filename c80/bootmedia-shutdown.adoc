...
---
= Apague la controladora para sustituir el soporte de arranque: AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague la controladora en su sistema de almacenamiento AFF C80 cuando necesite reemplazar el medio de arranque. Antes de realizar tareas de mantenimiento o sustitución de componentes, es crítico apagar la controladora de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema.
