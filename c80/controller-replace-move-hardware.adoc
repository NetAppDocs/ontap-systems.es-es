...
---
= Sustituye el controlador de tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de haber reemplazado el controlador AFF C80 defectuoso, necesitalink:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"] .
