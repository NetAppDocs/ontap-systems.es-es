...
summary: Puedes reemplazar un módulo IO averiado en tu sistema de almacenamiento AFF C80 con el mismo tipo de módulo IO o con un tipo diferente de módulo IO. También puedes agregar un módulo IO en un sistema con ranuras vacías. 
---
= Descubre cómo añadir y sustituir módulos de E/S en tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
