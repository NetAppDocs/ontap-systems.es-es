...
summary: Sustituye una fuente de alimentación de CA o CC de tu sistema AFF C80 cuando falle o se averíe, asegurándote de que tu sistema sigue recibiendo la energía necesaria para un funcionamiento estable. El proceso de sustitución consiste en desconectar la fuente de alimentación averiada de la toma de corriente, desenchufar el cable de alimentación, reemplazar la unidad averiada y luego volver a conectarla a la toma de corriente. 
---
= Cambia en caliente una fuente de alimentación en tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
