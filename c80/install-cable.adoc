...
---
= Conecta tu hardware AFF C80 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Las ranuras de I/O de una controladora AFF C80 están numeradas entre 1 y 11.
+
...
.Acerca de esta tarea
El sistema de almacenamiento AFF C80 es compatible con las unidades NS224 que incorporen el módulo NSM100 o el NSM100B. Las principales diferencias entre ambos módulos son:
