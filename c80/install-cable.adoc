...
--
Utilice el cable de 100 GbE para conectar los puertos e1a y e7a de los controladores A y B a los conmutadores de red del clúster A y B. .Pasos . Conecte el puerto e1a en el controlador A y el puerto e1a en el controlador B al conmutador de red del clúster A. Conecte el puerto e7a en el controlador A y el puerto e7a en el controlador B al conmutador de red del clúster B.
...
NOTE: No utilice los puertos e1b y e7b para conexiones de red del host. Utilice una tarjeta host independiente.
