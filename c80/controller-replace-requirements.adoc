...
.El futuro
Una vez que haya revisado los requisitos para reemplazar su controlador AFF C80, es necesario link:controller-replace-shutdown.html["apague el controlador defectuoso"].
