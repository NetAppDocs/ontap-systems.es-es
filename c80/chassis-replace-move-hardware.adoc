...
summary: 'Reemplace el chasis del sistema AFF C80 cuando un fallo de hardware lo requiera. El proceso de sustitución implica la retirada de las unidades de alimentación (PSU), la extracción del chasis existente, la instalación del nuevo y la reinstalación de los componentes del chasis.' 
---
...
[role="lead"]
Reemplace el chasis del sistema AFF C80 cuando un fallo de hardware lo requiera. El proceso de sustitución implica la retirada de las unidades de alimentación (PSU), la extracción del chasis existente, la instalación del nuevo y la reinstalación de los componentes del chasis.
