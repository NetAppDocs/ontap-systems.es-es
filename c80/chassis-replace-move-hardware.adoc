...
---
= Sustituye el chasis de tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el chasis de su sistema AFF C80 cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar los controladores y las unidades de fuente de alimentación (PSU), quitar las unidades, instalar el chasis de reemplazo y reinstalar los componentes del chasis.
