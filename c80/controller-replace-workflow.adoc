...
summary: Comience a sustituir la controladora en su sistema de almacenamiento AFF C80. Para ello, apague la controladora dañada, quite y sustituya la controladora, restaure la configuración del sistema y verifique las operaciones del sistema. 
---
= Inicio rápido para el reemplazo del controlador - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comience a sustituir la controladora en su sistema de almacenamiento AFF C80. Para ello, apague la controladora dañada, quite y sustituya la controladora, restaure la configuración del sistema y verifique las operaciones del sistema.
