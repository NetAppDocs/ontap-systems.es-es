...
summary: La sustitución de la controladora AFF C80 incluye los pasos necesarios para apagar la controladora, quitar y sustituir la controladora, volver a configurar los ajustes del sistema y verificar las operaciones del sistema. 
---
...
[role="lead"]
La sustitución de la controladora AFF C80 incluye los pasos necesarios para apagar la controladora, quitar y sustituir la controladora, volver a configurar los ajustes del sistema y verificar las operaciones del sistema.
