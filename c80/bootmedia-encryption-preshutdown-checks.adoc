...
summary: Para garantizar la seguridad de los datos en su sistema de almacenamiento AFF C80, debe verificar la compatibilidad y el estado de la clave de cifrado en el medio de arranque. Compruebe si su versión de ONTAP es compatible con NetApp Volume Encryption y, antes de apagar la controladora, compruebe si el administrador de claves está activo. 
---
= Comprobar la compatibilidad con cifrado para la recuperación manual de medios de arranque - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
