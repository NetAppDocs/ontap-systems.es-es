...
---
= Compruebe la compatibilidad y el estado de la clave de cifrado: AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en su sistema de almacenamiento AFF C80, debe comprobar la compatibilidad y el estado de la clave de cifrado. Compruebe si la versión de ONTAP es compatible con el cifrado de volúmenes de NetApp (NVE) y antes de apagar la controladora compruebe si el gestor de claves está activo.
