...
summary: Sustituya un módulo de ventilador en su sistema AFF C80 cuando se produzca un fallo o no esté funcionando de manera eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general. 
---
...
[role="lead"]
Sustituya un módulo de ventilador en su sistema AFF C80 cuando se produzca un fallo o no esté funcionando de manera eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general.
