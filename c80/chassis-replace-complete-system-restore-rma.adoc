...
---
= Realiza la sustitución del chasis de tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Paso 1: Encienda los controladores y realice la devolución.

Inicie ONTAP en los controladores y realice la devolución del controlador para devolver la propiedad del almacenamiento.
