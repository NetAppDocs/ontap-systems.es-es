...
summary: Reinicie las controladoras, verifique el estado del sistema y devuelva la parte con errores a NetApp para completar el paso final del flujo de trabajo de reemplazo del chasis de AFF C80. 
---
...
[role="lead"]
Reinicie las controladoras, verifique el estado del sistema y devuelva la parte con errores a NetApp para completar el paso final del flujo de trabajo de reemplazo del chasis de AFF C80.
