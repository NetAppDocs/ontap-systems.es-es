...
---
= Prepárate para instalar tu sistema de almacenamiento AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que hayas preparado todo para instalar el hardware del AFF C80, link:install-hardware.html["Instale el hardware en el sistema de almacenamiento de AFF C80"].
