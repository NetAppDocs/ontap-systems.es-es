...
summary: Para restaurar tu sistema FAS2600 a su pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption, instalar las licencias para la nueva controladora y devolver la pieza con error a NetApp. 
---
= Completa la sustitución del controlador de un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para restaurar tu sistema FAS2600 a su pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption (si es necesario), instalar las licencias para la nueva controladora y devolver la pieza con error a NetApp, tal como se describe en las instrucciones de RMA enviadas con el kit.
