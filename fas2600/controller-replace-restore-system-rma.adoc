...
summary: Para restablecer el funcionamiento completo del sistema, debes restaurar la configuración de NetApp Storage Encryption si es necesario, instalar licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp como se describe en las instrucciones de RMA enviadas con el kit. 
---
