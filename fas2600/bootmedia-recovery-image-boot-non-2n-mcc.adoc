...
summary: Arranque la imagen de recuperación de ONTAP desde la unidad USB en un sistema FAS2600 para restaurar el medio de arranque. El sistema FAS2600 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Arranca la imagen de recuperación en un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
. Comprueba que las variables de entorno estén configuradas según lo previsto:
+
