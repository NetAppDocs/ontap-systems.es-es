...
summary: Apaga los controladores de tu sistema FAS2600 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis. 
---
= Apaga los controladores FAS2600 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema FAS2600 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis.
