...
summary: Apaga o toma el control del controlador defectuoso de tu sistema FAS2600 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis. 
---
= Apaga el controlador FAS2600 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga o toma el control del controlador defectuoso de tu sistema FAS2600 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis.
