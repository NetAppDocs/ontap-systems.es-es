...
summary: Sustituye una unidad de tu sistema FAS2600 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se iluminan tanto el LED de fallo del panel de control del operador como el LED de fallo de la unidad con error. 
---
= Sustituye una unidad en tu sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad de tu sistema FAS2600 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se iluminan tanto el LED de fallo del panel de control del operador como el LED de fallo de la unidad con error.
