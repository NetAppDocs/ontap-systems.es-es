...
[role="lead"]
Sustituye en caliente una unidad con error en tu sistema FAS2600 sin interrumpir el servicio, incluso mientras se están realizando operaciones de E/S, para restablecer la capacidad de almacenamiento y el rendimiento del sistema.
