...
summary: Realiza un intercambio en caliente de una unidad en tu sistema FAS2600 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se iluminan tanto el LED de fallo del panel de control como el LED de fallo de la unidad con error. 
---
= Intercambia en caliente una unidad en un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad en tu sistema FAS2600 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se iluminan tanto el LED de fallo del panel de control como el LED de fallo de la unidad con error.
