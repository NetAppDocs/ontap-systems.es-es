...
summary: Sustituye la batería NVMEM de tu sistema FAS2600 quitando el módulo controlador, cambiando la batería y volviendo a instalar el módulo controlador. 
---
= Sustituye la batería NVMEM en un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVMEM de tu sistema FAS2600 quitando el módulo del controlador, abriéndolo, cambiando la batería y luego cerrando y reinstalando el módulo del controlador.

Si algún otro componente del sistema no funciona correctamente, ponte en contacto con el soporte técnico.

link:https://youtu.be/dgEMcYxya5M["Vídeo de reemplazo de la batería NVMEM FAS2600 de AFF"^]
...
.. Si aún no lo ha hecho, vuelva a instalar el dispositivo de administración de cables.
.. Conecte los cables al dispositivo de gestión de cables con la correa de gancho y lazo.
.. Vuelva a conectar los cables de alimentación a las fuentes de alimentación y a las fuentes de alimentación, y encienda la alimentación para iniciar el proceso de arranque.
