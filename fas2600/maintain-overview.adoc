...
---
= Infórmate sobre el mantenimiento de tu sistema de almacenamiento FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes realizar procedimientos de mantenimiento en estos componentes de tu sistema de almacenamiento FAS2600.
