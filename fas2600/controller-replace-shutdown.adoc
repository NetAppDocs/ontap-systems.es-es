...
summary: Apaga el controlador defectuoso de tu sistema FAS2600 antes de sustituirlo, comprobando primero su estado y, si es necesario, asumiendo sus funciones para que el controlador en buen estado siga proporcionando datos. 
---
= Apaga el controlador defectuoso en un sistema FAS2600 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema FAS2600 antes de sustituirlo, comprobando primero su estado y, si es necesario, asumiendo su función para que el controlador en buen estado siga proporcionando datos desde el almacenamiento del controlador defectuoso.
