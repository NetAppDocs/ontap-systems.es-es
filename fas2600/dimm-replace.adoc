...
summary: Sustituye un DIMM en tu sistema FAS2600 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles según las alertas de Health Monitor, o errores ECC no corregibles provocados por el fallo de un solo DIMM que impidan que el sistema arranque ONTAP. 
---
= Sustituye un módulo DIMM en tu sistema FAS2600 para solucionar los errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema FAS2600 cuando el sistema de almacenamiento detecte un número excesivo de errores CECC (códigos de corrección de errores corregibles) según las alertas del Health Monitor, o errores ECC no corregibles, que normalmente son causados por el fallo de un solo DIMM e impiden que el sistema de almacenamiento arranque ONTAP.

Si algún otro componente no funciona correctamente, ponte en contacto con soporte técnico.

Debe sustituir el componente con errores por un componente FRU de repuesto que haya recibido de su proveedor.

link:https://youtu.be/ywwsMltvuXg["Vídeo de sustitución de DIMM del FAS2600 de AFF"^]
...
. Vuelva a comprobar el LED de NVMEM.
