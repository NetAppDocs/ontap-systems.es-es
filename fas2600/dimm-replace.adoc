...
summary: Debes sustituir un módulo DIMM en el controlador cuando tu sistema de almacenamiento se encuentre con errores como errores excesivos de los códigos de corrección de errores corregibles basados en alertas de Health Monitor o errores ECC no corregibles, normalmente causados por una falla de un solo módulo DIMM que impide que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituya un DIMM - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
