...
summary: Sustituye el DIMM de tu sistema FAS2600 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles según las alertas de Health Monitor, o errores ECC incorregibles provocados por el fallo de un solo DIMM que impidan que el sistema arranque ONTAP. 
---
= Sustituir un módulo DIMM en un sistema FAS2600 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM de tu sistema FAS2600 cuando el sistema de almacenamiento registre un número excesivo de errores CECC (Correctable Error Correction Codes) según las alertas de Health Monitor, o errores ECC no corregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP.
