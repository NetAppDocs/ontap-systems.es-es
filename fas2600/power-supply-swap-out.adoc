...
---
= Cambie un suministro de alimentación: FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:https://youtu.be/fTOMwENNi9M["Vídeo de reemplazo del suministro de alimentación FAS2600 de AFF"^]
...
+
image::../media/drw_2600_psu_repl_animated_gif.png[gif animados drw 2600 psu repl]
