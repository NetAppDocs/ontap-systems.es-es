...
+
image::../media/drw_2600_nvmem_battery_move_animated_gif.png[gif animados de movimiento de batería de nvmem drw 2600]
...
+
image::../media/drw_2600_fcache.png[fcache drw 2600]
