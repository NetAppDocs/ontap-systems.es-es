...
summary: Sustituye el módulo de almacenamiento en caché de tu sistema FAS2600 cuando tu sistema registre un solo mensaje de AutoSupport indicando que el módulo se ha desconectado. Si no lo haces, el rendimiento disminuirá. 
---
= Sustituye el módulo de almacenamiento en caché de tu sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo de almacenamiento en caché de tu sistema FAS2600 cuando tu sistema registre un solo mensaje AutoSupport (ASUP) que indique que el módulo se ha desconectado. Si no lo haces, el rendimiento disminuirá.
...
El módulo de almacenamiento en caché aparece indicado como "tarjeta PCIe M.2" en la etiqueta del controlador. Localiza la ranura en el interior del controlador y sigue esta secuencia de pasos.
