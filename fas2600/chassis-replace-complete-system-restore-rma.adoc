...
summary: 'Completa la sustitución del chasis de tu sistema FAS2600 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente defectuoso a NetApp.' 
---
= Completa la sustitución del chasis de un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de tu sistema FAS2600 verificando el estado de alta disponibilidad (HA) del chasis y devolviendo la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA incluidas con el kit.
