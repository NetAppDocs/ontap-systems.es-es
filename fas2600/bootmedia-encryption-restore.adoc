...
summary: Restaura la configuración de cifrado en el medio de arranque de reemplazo para un sistema FAS2600. Este procedimiento incluye completar los pasos posteriores al reemplazo para sistemas con Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption habilitados para asegurar el acceso seguro a los datos y el funcionamiento correcto del sistema. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurar la configuración de cifrado en el medio de arranque de reemplazo para un sistema FAS2600. Este procedimiento incluye completar los pasos posteriores al reemplazo para sistemas con Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) o NetApp Volume Encryption (NVE) habilitados para garantizar el acceso seguro a los datos y el funcionamiento adecuado del sistema.
