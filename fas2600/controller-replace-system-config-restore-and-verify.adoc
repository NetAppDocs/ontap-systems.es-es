...
summary: Restaura y verifica la configuración del controlador en tu sistema FAS2600 después de completar el reemplazo del hardware y arrancar en modo de mantenimiento. 
---
= Restaurar y verificar la configuración del controlador en un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura y verifica la configuración del controlador en tu sistema FAS2600 después de completar el reemplazo del hardware y arrancar en modo de mantenimiento, verificando la configuración de bajo nivel del controlador de reemplazo y reconfigurando los ajustes del sistema según sea necesario.
