...
summary: Traslada las fuentes de alimentación, los discos duros y los módulos controladores del chasis averiado al chasis de recambio de tu sistema FAS2600 y luego cambia el chasis antiguo en el espacio en rack o armario del sistema por el nuevo del mismo modelo. 
---
= Sustituye el chasis en un sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Traslada las fuentes de alimentación, los discos duros y los módulos controladores del chasis averiado al chasis de recambio de tu sistema FAS2600 y luego cambia el chasis antiguo en el espacio en rack o armario del sistema por el nuevo del mismo modelo.
...
Quite el chasis existente del rack del equipo o armario del sistema antes de poder instalar el chasis de reemplazo.
...
En el caso de los pares de alta disponibilidad (HA) con dos módulos controladores en el mismo chasis, el orden de instalación es importante porque cada controlador se reinicia en cuanto queda completamente encajado en el chasis.
