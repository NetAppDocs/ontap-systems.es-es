...
summary: Antes de sustituir el controlador en tu sistema FAS2600, revisa los requisitos previos para el procedimiento de sustitución y selecciona el correcto para tu versión del sistema operativo ONTAP. 
---
= Revisa los requisitos antes de sustituir el controlador de tu sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador en tu sistema FAS2600, revisa los requisitos previos para el procedimiento de sustitución y selecciona el correcto para tu versión del sistema operativo ONTAP.
