...
summary: Vuelve a conectar el almacenamiento, confirma la reasignación de discos y completa las tareas restantes para devolver el controlador y restaurar tu sistema FAS2600 a pleno funcionamiento. 
---
= Devuelve el controlador en un sistema FAS2600 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vuelve a conectar el almacenamiento, confirma la reasignación de discos y completa las tareas restantes para devolver el controlador y restaurar tu sistema FAS2600 a pleno funcionamiento.
