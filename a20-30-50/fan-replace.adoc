...
Para sustituir un ventilador, debe retirar la controladora, quitar el ventilador defectuoso, instalar el ventilador de reemplazo y, a continuación, reinstalar la controladora.
