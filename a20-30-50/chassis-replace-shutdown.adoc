...
summary: Apague las controladoras del sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el chasis. 
---
= Apague las controladoras para reemplazar el chasis: AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras del sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el chasis.
