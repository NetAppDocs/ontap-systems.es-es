...
summary: Revise los requisitos del sistema de almacenamiento AFF A20, AFF A30 o AFF A50. 
---
= Revisa los requisitos para instalar un sistema de almacenamiento AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
