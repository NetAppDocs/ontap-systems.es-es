...
summary: Para garantizar la seguridad de los datos en el sistema de almacenamiento A20, AFF A30 o AFF A50, debe verificar la compatibilidad y el estado de la clave de cifrado del soporte de arranque. Compruebe si la versión de ONTAP es compatible con el cifrado de volúmenes NetApp y antes de apagar la controladora, compruebe si el gestor de claves está activo. 
---
= Comprueba el soporte de cifrado en el soporte de arranque de un sistema AFF A20, AFF A30 o AFF A50 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
