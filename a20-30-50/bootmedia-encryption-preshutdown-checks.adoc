...
---
= Verifique la compatibilidad con cifrado para la recuperación manual de medios de arranque: AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en su sistema de almacenamiento AFF A20, AFF A30 o AFF A50, debe verificar la compatibilidad y el estado de la clave de cifrado en su medio de arranque.  Compruebe si su versión de ONTAP admite NetApp Volume Encryption (NVE) y, antes de apagar el controlador, compruebe si el administrador de claves está activo.
