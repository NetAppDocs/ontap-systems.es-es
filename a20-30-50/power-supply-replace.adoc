...
summary: Sustituye una fuente de alimentación de CA o CC en tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. El proceso de sustitución implica desconectar la fuente de alimentación averiada de la toma de corriente, desenchufar el cable de alimentación, reemplazar la fuente de alimentación averiada y luego volver a conectarla a la toma de corriente. 
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
