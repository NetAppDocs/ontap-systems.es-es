...
summary: Prepárese para instalar su sistema de almacenamiento AFF A20, AFF A30 o AFF A50. Para ello, prepare el sitio, desembale las cajas y compare el contenido de las cajas con la hoja de embalaje y registre el sistema de almacenamiento para acceder a los beneficios de soporte. 
---
= Prepárate para instalar tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
