...
summary: 'El módulo de E/S de clúster y alta disponibilidad (HA) admite interconexiones para agrupamiento en clústeres y alta disponibilidad. Puede intercambiar el módulo en caliente en su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando el módulo falla y si su sistema de almacenamiento cumple con los requisitos específicos.' 
---
