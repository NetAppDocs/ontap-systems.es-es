...
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema AFF A20, AFF A30 o AFF A50 usando el proceso manual de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si tu sistema ejecuta ONTAP 9.17.1 o una versión posterior, utiliza la link:bootmedia-replace-workflow-bmr.html["procedimiento de recuperación de arranque automático"].
