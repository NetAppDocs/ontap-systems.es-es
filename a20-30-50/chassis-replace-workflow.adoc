...
---
= Flujo de trabajo para la sustitución de los chasis AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
La sustitución del chasis implica trasladar las unidades, los paneles ciegos de las unidades, los controladores (con sus fuentes de alimentación) y el frontal del chasis defectuoso al nuevo chasis. Luego, cambias el chasis defectuoso por un chasis nuevo del mismo modelo.
