...
summary: Comience a sustituir el chasis de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 revisando los requisitos de reemplazo, apagando las controladoras, quitando y sustituyendo el chasis, y verificando operaciones del sistema. 
---
...
[role="lead"]
Comience a sustituir el chasis de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 revisando los requisitos de reemplazo, apagando las controladoras, quitando y sustituyendo el chasis, y verificando operaciones del sistema.
