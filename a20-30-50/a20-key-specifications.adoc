...
summary: Especificaciones clave del AFF A20 
---
= Especificaciones clave para un sistema AFF A20
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas especificaciones seleccionadas describen el sistema de almacenamiento AFF A20 configurado en un único par de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para consultar las especificaciones completas de este sistema.



[[aff-a20-specifications-at-a-glance]]
== Especificaciones del AFF A20 de un vistazo
...
* Tipo: NAS; Pares HA: 3; Capacidad bruta: 12,1 PB / 10,8 PiB; Memoria máxima: 384 GB
* Tipo: SAN; Pares HA: 3; Capacidad bruta: 12,1 PB / 10,8 PiB; Memoria máxima: 384 GB
...
* Protocolo: Ethernet 100 Gbps; Puertos: 12
* Protocolo: Ethernet 25 Gbps; Puertos: 32
