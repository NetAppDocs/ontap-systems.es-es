...
summary: 'Para completar el reemplazo del controlador de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50, primero restaure la configuración de cifrado de almacenamiento de NetApp (si es necesario) e instale las licencias necesarias en el nuevo controlador.  A continuación, confirme que las interfaces lógicas (LIF) estén informando a sus puertos de origen y realice una verificación del estado del clúster.  Por último, registre el número de serie del nuevo controlador y luego devuelva la pieza defectuosa a NetApp.' 
---
