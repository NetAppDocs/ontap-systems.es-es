...
summary: Para restaurar el sistema AFF A20, AFF A30 o AFF A50 a su funcionamiento completo, instale las licencias requeridas en la nueva controladora, confirme que las interfaces lógicas informan a sus puertos iniciales y realice una comprobación del estado del clúster. Finalmente, registre el número de serie de la nueva controladora y luego devuelva la pieza fallida a NetApp. 
---
