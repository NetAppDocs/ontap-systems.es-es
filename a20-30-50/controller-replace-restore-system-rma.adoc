...
summary: Para completar la sustitución del controlador de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50, restaura la configuración de NetApp Storage Encryption e instala las licencias necesarias en el nuevo controlador. Confirma que las interfaces lógicas están informando a sus puertos de origen y realiza una comprobación del estado del clúster. Registra el número de serie del nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Realiza la sustitución del controlador de un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar el reemplazo del controlador de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50, primero restaure la configuración de cifrado de almacenamiento de NetApp (si es necesario) e instale las licencias necesarias en el nuevo controlador.  A continuación, confirme que las interfaces lógicas (LIF) estén informando a sus puertos de origen y realice una verificación del estado del clúster.  Por último, registre el número de serie del nuevo controlador y luego devuelva la pieza defectuosa a NetApp.
