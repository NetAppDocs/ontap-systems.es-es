...
summary: Compruebe el estado de alta disponibilidad del chasis y, a continuación, devuelva la pieza con error a NetApp para completar el paso final del procedimiento de sustitución del chasis AFF A20, AFF A30 y AFF A50. 
---
= Completa la sustitución del chasis de un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
