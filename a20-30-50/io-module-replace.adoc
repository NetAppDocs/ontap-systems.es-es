...
---
= Sustituya el módulo de E/S: AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya un módulo de E/S en su sistema AFF A20, AFF A30 o AFF A50 cuando el módulo falle o necesite una actualización para admitir un mayor rendimiento o funciones adicionales. El proceso de sustitución implica apagar la controladora, sustituir el módulo de I/O fallido, reiniciar la controladora y devolver la parte fallida al NetApp.
