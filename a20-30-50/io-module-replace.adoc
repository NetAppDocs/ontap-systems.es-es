...
summary: Reemplace un módulo de E/S en su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando falle o requiera una actualización para ofrecer un mayor rendimiento o funciones adicionales. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de E/S defectuoso, reiniciar la controladora y devolver la pieza defectuosa a NetApp. 
---
= Reemplaza un módulo de E/S en un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de E/S en tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando el módulo falle o necesite una actualización para admitir mayor rendimiento o funciones adicionales.

El proceso de sustitución implica apagar el controlador, reemplazar el módulo de E/S averiado, reiniciar el controlador y devolver la pieza averiada a NetApp.
