...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Intercambia en caliente un módulo de E/S en un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
...
+
Puedes desactivarlos introduciendo el comando  `system location-led _off_`. Si no estás seguro de si los LED están encendidos o apagados, puedes comprobar su estado introduciendo el comando  `system location-led show`.
