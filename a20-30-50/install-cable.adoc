...
---
= Conecta el hardware AFF A20, AFF A30 o AFF A50 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["a20 diagrama de cableado de clúster conmutado utilizando un módulo io 25 GbE"]
...
.AFF A20, AFF A30 o AFF A50 con un módulo de E/S 10/25 GbE de 4 puertos
...
.AFF A20, AFF A30 o AFF A50 con un módulo de E/S FC de 4 puertos a 64 Gb/s
