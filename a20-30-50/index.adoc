...
summary: Para los sistemas de almacenamiento AFF A20, AFF A30 o AFF A50, se pueden realizar procedimientos de mantenimiento en los siguientes componentes. 
---
= Mantener el hardware de AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para los sistemas de almacenamiento AFF A20, AFF A30 o AFF A50, se pueden realizar procedimientos de mantenimiento en los siguientes componentes.
