...
** La pantalla de ID de bandeja en la parte frontal del chasis del sistema no se ilumina. El ID de bandeja interna del sistema está fijado en 00.


. Asegure los cables de alimentación con el dispositivo de seguridad de cada fuente de alimentación. :a20-30-50!:
