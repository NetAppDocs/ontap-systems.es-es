...
---
= Agrega un módulo de I/O a tu sistema AFF A20, AFF A30 o AFF A50 para mejorar la conectividad de red
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
El proceso de adición implica apagar un controlador, añadir el nuevo módulo de E/S, reiniciar el controlador, apagar el otro controlador, añadir el nuevo módulo de E/S y reiniciar el controlador.
