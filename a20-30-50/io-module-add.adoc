...
---
= Agrega un módulo de I/O a un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agregue un módulo de E/S a su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Para añadir el módulo de E/S tienes que apagar un controlador, instalar el módulo y reiniciarlo, y luego repetir estos pasos con el otro controlador.

.Acerca de esta tarea
* Puedes añadir un módulo de I/O a tus sistemas de almacenamiento cuando haya ranuras disponibles o cuando todas las ranuras estén completamente ocupadas.
