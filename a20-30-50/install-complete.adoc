...
summary: Después de encender el sistema de almacenamiento AFF A20, AFF A30 o AFF A50, está listo para detectar la red del clúster y configurar un clúster de ONTAP. 
---
