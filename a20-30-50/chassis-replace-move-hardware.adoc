...
[role="lead"]
Reemplace el chasis del sistema AFF A20, AFF A30 o AFF A50 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar la controladora y las unidades de fuente de alimentación (PSU), retirar las unidades del chasis dañado, instalar el chasis de reemplazo y reinstalar los componentes del chasis.
