...
summary: Reemplace el controlador de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando una falla de hardware lo requiera.  El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo. 
---
= Sustituye el controlador en tu sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando una falla de hardware lo requiera.  El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
