...
summary: Especificaciones clave para las plataformas AFF A20, AFF A30 y AFF A50 
---
= Especificaciones clave para las plataformas AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas son algunas especificaciones seleccionadas del grupo de plataformas AFF A20, AFF A30 y AFF A50. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para consultar la lista completa de especificaciones. Las especificaciones se refieren a un único par de alta disponibilidad.
...
* Potencia típica: 2040 BTU/h
* Potencia en el peor de los casos: 2907 BTU/h
* Peso: 60,7 lb 27,5 kg
* Altura: 2U
* Ancho: compatible con rack IEC de 19" (17,6" 44,7 cm)
* Profundidad:
