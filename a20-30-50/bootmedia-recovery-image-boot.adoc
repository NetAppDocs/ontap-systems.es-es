...
---
= Inicie la imagen de recuperación: AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead lead"]
Después de instalar el nuevo dispositivo multimedia de arranque en el sistema AFF A20, AFF A30 o AFF A50, puede iniciar la imagen de recuperación desde una unidad USB y restaurar la configuración desde el nodo asociado.
