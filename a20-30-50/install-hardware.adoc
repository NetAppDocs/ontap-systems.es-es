...
summary: Después de preparar la instalación del sistema de almacenamiento AFF A20, AFF A30 o AFF A50, instale el hardware para el sistema de almacenamiento. En primer lugar, instale los kits de guías. A continuación, instale y proteja su sistema de almacenamiento en un armario o rack de telecomunicaciones. 
---
= Instala el hardware AFF A20, AFF A30 o AFF A50 en un armario o rack
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
