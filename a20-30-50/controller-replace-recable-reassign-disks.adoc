...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 pueda reanudar su funcionamiento normal. El procedimiento de devolución varía según si tu sistema no utiliza cifrado, utiliza cifrado con Onboard Key Manager o utiliza cifrado con External Key Manager. 
---
= Devuelve el controlador en tu sistema AFF A20, AFF A30 o AFF A50 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado, cifrado mediante el Administrador de claves integrado (OKM) o cifrado mediante el Administrador de claves externo (EKM).
