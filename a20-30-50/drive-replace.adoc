...
summary: Sustituya una unidad en el sistema AFF A20, AFF A30 o AFF A50 cuando se produzca un error en una unidad o requiera una actualización. El proceso de sustitución implica identificar la unidad defectuosa, extraerla de forma segura e instalar una nueva unidad para garantizar un acceso continuo a los datos y el rendimiento del sistema. 
---
...
[role="lead"]
Sustituya una unidad en el sistema AFF A20, AFF A30 o AFF A50 cuando se produzca un error en una unidad o requiera una actualización. El proceso de sustitución implica identificar la unidad defectuosa, extraerla de forma segura e instalar una nueva unidad para garantizar un acceso continuo a los datos y el rendimiento del sistema.
