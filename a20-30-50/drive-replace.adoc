...
summary: Sustituye en caliente una unidad de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando una unidad tenga error o sea necesario actualizarla. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad en un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 cuando una unidad tenga error o sea necesario actualizarla. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
