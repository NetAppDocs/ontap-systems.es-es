...
[role="lead"]
Para instalar y configurar el sistema de almacenamiento AFF A20, AFF A30 o AFF A50, debe revisar los requisitos y consideraciones de instalación, preparar el sitio, instalar y cablear los componentes de hardware, encender el sistema de almacenamiento y configurar el clúster de ONTAP.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Uno"]link:install-requirements.html["Revise los requisitos y las consideraciones de instalación"]
[role="quick-margin-para"]
Antes de instalar el sistema de almacenamiento, el sistema de almacenamiento debe cumplir los requisitos de instalación y debe revisar las consideraciones de la instalación.
