...
---
= Flujo de trabajo de instalación y configuración de AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Antes de instalar tu sistema de almacenamiento, debe cumplir los requisitos de instalación.
