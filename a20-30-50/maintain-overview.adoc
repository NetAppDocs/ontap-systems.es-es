...
[role="lead"]
Mantener el hardware de sus sistemas de almacenamiento AFF A20, AFF A30 o AFF A50 para garantizar una fiabilidad a largo plazo y un rendimiento óptimo. Lleve a cabo tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, ya que esto ayuda a evitar el tiempo de inactividad y la pérdida de datos.

Los procedimientos de mantenimiento se dan por sentado que ya se han puesto en marcha los sistemas AFF A20, AFF A30 y AFF A50 como nodos de almacenamiento en el entorno de ONTAP.
