...
summary: Mantener el hardware de sus sistemas de almacenamiento AFF A20, AFF A30 o AFF A50 para garantizar una fiabilidad a largo plazo y un rendimiento óptimo. Lleve a cabo tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, ya que esto ayuda a evitar el tiempo de inactividad y la pérdida de datos. 
---
= Infórmate sobre el mantenimiento de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realice el mantenimiento del hardware de su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para garantizar la fiabilidad a largo plazo y un rendimiento óptimo. Realice tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, para evitar tiempos de inactividad y la pérdida de datos.

Los procedimientos de mantenimiento suponen que el sistema de almacenamiento AFF A20, AFF A30 o AFF A50 ya se ha implementado como un nodo de almacenamiento en el entorno ONTAP .
...
Para el sistema de almacenamiento AFF A20, AFF A30 o AFF A50, puede realizar procedimientos de mantenimiento en los siguientes componentes.
