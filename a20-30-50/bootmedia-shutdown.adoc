...
summary: Apaga el controlador de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque. 
---
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque.
