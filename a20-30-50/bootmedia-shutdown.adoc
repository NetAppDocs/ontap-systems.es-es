...
summary: Apague el controlador dañado en su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación del medio de arranque manual. 
---
= Apaga el controlador de tu sistema AFF A20, AFF A30 o AFF A50 durante el proceso de recuperación del arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFF A20, AFF A30 o AFF A50 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación del medio de arranque manual.
