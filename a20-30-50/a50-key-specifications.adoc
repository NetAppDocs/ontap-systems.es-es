...
---
= Especificaciones clave para un sistema AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas especificaciones seleccionadas describen el sistema de almacenamiento AFF A50 configurado en un único par de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para consultar las especificaciones completas de este sistema.
