...
summary: Los medios de arranque del sistema AFF A20, AFF A30 o AFF A50 almacenan datos esenciales del firmware y de configuración. El proceso de sustitución implica la extracción del módulo del controlador, la extracción del soporte de arranque dañado, la instalación del soporte de arranque de reemplazo y, a continuación, la transferencia de la imagen ONTAP al soporte de arranque de reemplazo. 
---
= Sustituya el soporte de arranque: AFF A20, AFF A30 y AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Los medios de arranque del sistema AFF A20, AFF A30 o AFF A50 almacenan datos esenciales del firmware y de configuración. El proceso de sustitución implica la extracción del módulo del controlador, la extracción del soporte de arranque dañado, la instalación del soporte de arranque de reemplazo y, a continuación, la transferencia de la imagen ONTAP al soporte de arranque de reemplazo.
