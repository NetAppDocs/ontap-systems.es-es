...
summary: Apaga el controlador de tu sistema de almacenamiento FAS9000 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque. 
---
= Apaga el controlador de tu sistema FAS9000 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS9000 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque.
...
Una vez completadas las tareas de NVE o NSE, apaga el nodo. Nota: No uses este procedimiento si tu sistema está en una configuración de dos nodos MetroCluster.
...
Una vez completadas las tareas de NVE o NSE, apaga el nodo.
