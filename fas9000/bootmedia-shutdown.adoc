...
summary: Puede apagar o tomar el control del controlador dañado mediante diferentes procedimientos, dependiendo de la configuración del hardware del sistema de almacenamiento. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Apaga el controlador defectuoso de tu sistema FAS9000 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague o tome el control del controlador dañado utilizando el procedimiento apropiado para su configuración. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
...
Una vez completadas las tareas de NVE o NSE, apaga el nodo afectado. Nota: No uses este procedimiento si tu sistema está en una configuración de dos nodos MetroCluster.
...
Una vez completadas las tareas de NVE o NSE, apaga el nodo afectado.
