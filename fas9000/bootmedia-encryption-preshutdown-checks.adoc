...
summary: Antes de apagar el nodo dañado y verificar el estado de las claves de cifrado integradas, debe verificar el estado del nodo dañado, deshabilitar la devolución automática y verificar qué versión de ONTAP está ejecutando el sistema. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
