...
summary: Antes de apagar el controlador afectado y comprobar el estado de las claves de cifrado integradas, debes comprobar el estado del controlador afectado, desactivar la función de recuperación automática y comprobar qué versión de ONTAP está ejecutando el sistema. El sistema FAS9000 solo admite procedimientos manuales de recuperación del soporte de arranque. 
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en tu sistema de almacenamiento, verifica la compatibilidad y el estado de la clave de cifrado en tu medio de arranque. Comprueba si tu versión de ONTAP es compatible con NetApp Volume Encryption (NVE), y antes de apagar el controlador, revisa si el gestor de claves está activo. El sistema FAS9000 solo admite procedimientos manuales de recuperación del medio de arranque.
