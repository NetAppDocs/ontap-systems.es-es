...
summary: Para intercambiar en caliente un módulo de alimentación de controlador de etapa DCPM, que contiene la batería NVRAM10, debes localizar el módulo DCPM averiado, extraerlo del chasis e instalar el módulo DCPM de sustitución. 
---
= Intercambio en caliente de un módulo de alimentación del controlador de eliminación de etapas (DCPM) - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
