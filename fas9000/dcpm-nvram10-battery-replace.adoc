...
summary: 'Realiza el intercambio en caliente del módulo de alimentación del controlador de desescalado (DCPM), que contiene la batería NVRAM10, en un sistema FAS9000 sin interrumpir el servicio.' 
---
= Intercambia en caliente un módulo DCPM en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza el intercambio en caliente del módulo de alimentación del controlador de desescalado (DCPM), que contiene la batería NVRAM10, en un sistema FAS9000 sin interrumpir el servicio.
