...
summary: Sustituye un módulo DCPM averiado en un sistema FAS9000. El módulo debe sustituirse en el chasis en un plazo de cinco minutos tras su extracción o el controlador asociado se apagará. 
---
= Sustituir el módulo DCPM en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DCPM averiado en un sistema FAS9000. El módulo debe sustituirse en el chasis en un plazo de cinco minutos tras su extracción o el controlador asociado se apagará.
