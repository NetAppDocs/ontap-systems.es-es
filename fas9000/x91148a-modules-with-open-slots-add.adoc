...
summary: Agrega un módulo X91148A en una ranura de módulo vacía en un sistema FAS9000, ya sea como una NIC 100GbE o como un módulo de almacenamiento para estantes de almacenamiento NS224. 
---
= Agrega un módulo X91148A a un sistema FAS9000 usando una ranura libre
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agrega un módulo X91148A en una ranura de módulo vacía en un sistema FAS9000, ya sea como una NIC 100GbE o como un módulo de almacenamiento para estantes de almacenamiento NS224.
