...
summary: Retira uno o varios módulos de red o de almacenamiento existentes de un sistema FAS9000 con todas las ranuras ocupadas para instalar uno o varios módulos de almacenamiento X91148A. 
---
= Agrega un módulo de almacenamiento X91148A a un sistema FAS9000 cuando todos los slots están ocupados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Retira uno o varios módulos de red o de almacenamiento existentes de un sistema FAS9000 con todas las ranuras ocupadas para instalar uno o varios módulos de almacenamiento X91148A.
