...
---
= Elige tu experiencia de instalación y configuración del FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
En la mayoría de las configuraciones de FAS9000, puedes elegir el formato de instalación y configuración que mejor se adapte a tus necesidades: pasos rápidos, pasos en vídeo o pasos detallados.
