...
summary: Vuelve a conectar el almacenamiento y confirma la reasignación del disco en un sistema FAS9000 para que el controlador de recambio pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema FAS9000 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vuelve a conectar el almacenamiento y confirma la reasignación del disco en un sistema FAS9000 para que el controlador de recambio pueda reanudar su funcionamiento normal.
