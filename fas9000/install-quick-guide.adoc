...
---
= Instala un sistema de almacenamiento FAS9000 siguiendo unos sencillos pasos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema FAS9000 siguiendo las instrucciones gráficas rápidas, desde el montaje en bastidor y el cableado hasta la puesta en marcha inicial del sistema. Sigue estos pasos si ya estás familiarizado con la instalación de sistemas NetApp.
