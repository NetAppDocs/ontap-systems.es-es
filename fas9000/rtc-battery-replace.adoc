...
summary: Sustituye la batería del reloj en tiempo real del módulo controlador de un sistema FAS9000 para que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería del reloj en tiempo real (RTC) del módulo controlador de un sistema FAS9000 para que los servicios y las aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
