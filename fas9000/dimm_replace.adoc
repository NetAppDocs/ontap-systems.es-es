...
---
= Sustituya un DIMM - AFF A700 y FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_9000_dimm_map.png[mapa dimm drw 9000]
...
+
*** Una advertencia de que al entrar en el modo de mantenimiento en una configuración de alta disponibilidad, debe asegurarse de que el nodo en buen estado permanece inactivo.
...
_SLDIAG: No hay mensajes de registro._
