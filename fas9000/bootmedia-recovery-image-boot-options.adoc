...
---
= Inicie la imagen de recuperación - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El procedimiento para iniciar el nodo dañado desde la imagen de recuperación depende de si el sistema está en una configuración MetroCluster de dos nodos. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
