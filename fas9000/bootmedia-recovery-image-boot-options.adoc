...
summary: El procedimiento para iniciar el nodo dañado desde la imagen de recuperación depende de si el sistema está en una configuración MetroCluster de dos nodos. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Arranca la imagen de recuperación en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el soporte de arranque de reemplazo en tu sistema FAS9000, arranca la imagen de recuperación desde una unidad USB. El procedimiento para arrancar el controlador afectado depende de si el sistema está en una configuración de dos nodos MetroCluster. El sistema FAS9000 solo admite procedimientos manuales de recuperación de soportes de arranque.
