...
summary: 'Sustituye el módulo de almacenamiento en caché o el módulo de volcado de memoria en un sistema FAS9000 cuando el sistema registre un único mensaje AutoSupport (ASUP) que informe que el módulo se ha desconectado. Si no lo sustituyes, el rendimiento disminuirá.' 
---
= Sustituye el módulo de almacenamiento en caché o el módulo de volcado de memoria en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo de almacenamiento en caché o el módulo de volcado de memoria en un sistema FAS9000 cuando el sistema registre un único mensaje AutoSupport (ASUP) que informe que el módulo se ha desconectado. Si no lo sustituyes, el rendimiento disminuirá.
