...
---
= Instala un sistema de almacenamiento FAS9000 siguiendo unos pasos detallados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas instrucciones detalladas, paso a paso, te guían a lo largo del proceso de instalación de tu sistema FAS9000, desde el montaje en bastidor y el cableado hasta la configuración inicial. Sigue estos pasos si quieres una guía de instalación más detallada que la que ofrecen los pasos rápidos.
...
Puedes conectar tu nuevo sistema a los shelves DS212C, DS224C o NS224, dependiendo de si es un sistema AFF o FAS.
...
Debes conectar cada controlador a los módulos NSM del bastidor de unidades NS224 en un sistema AFF A700 o ASA AFF A700 que ejecute ONTAP 9.8 o una versión posterior.

* Esta tarea se aplica solo a ASA AFF A700 que ejecuta ONTAP 9,8 o posterior.
* Los sistemas deben tener al menos un módulo X91148A instalado en la ranura 3 o 7 de cada controlador. La animación o las ilustraciones muestran este módulo instalado tanto en la ranura 3 como en la 7.
...
Debes conectar cada controlador a los módulos NSM de los bastidores de unidades NS224 en un sistema AFF A700 o ASA AFF A700 que ejecute ONTAP 9.8 o una versión posterior.
...
+
Si tu sistema cuenta con bastidores de unidades NS224, estos vienen preconfigurados con los ID de bastidor 00 y 01. Si deseas cambiar los ID de los bastidores, debes crear una herramienta para insertarla en el orificio donde se encuentra el botón.
...
NOTE: El valor que se muestra es el número de serie del sistema del nodo de destino.
