...
summary: Sustituye un módulo LED USB en un sistema FAS9000 sin interrumpir el servicio. El módulo proporciona conectividad a los puertos de consola y al estado del sistema y no requiere herramientas para reemplazarlo. 
---
= Intercambia en caliente un módulo USB LED en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo LED USB en un sistema FAS9000 sin interrumpir el servicio. El módulo proporciona conectividad a los puertos de consola y al estado del sistema y no requiere herramientas para reemplazarlo.
