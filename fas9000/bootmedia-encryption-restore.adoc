...
summary: Una vez verificadas las variables de entorno, debes completar los pasos específicos para los sistemas que tengan habilitados Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE. El sistema FAS9000 solo admite procedimientos manuales de recuperación de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura el cifrado en el soporte de arranque de reemplazo de tu sistema FAS9000 completando los pasos para tu tipo de gestor de claves, como el Onboard Key Manager (OKM). El sistema FAS9000 solo admite procedimientos manuales de recuperación del soporte de arranque.
