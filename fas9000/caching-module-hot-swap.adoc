...
summary: Intercambia en caliente el módulo de caché en un sistema FAS9000. A partir de ONTAP 9.4, puedes intercambiar en caliente el módulo NVMe SSD Flash Cache, que está ubicado delante del módulo NVRAM10 en la ranura 6, por un módulo de caché de la misma capacidad del mismo fabricante o de otro compatible. 
---
= Intercambia en caliente un módulo de caché en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Intercambia en caliente el módulo de caché en un sistema FAS9000. A partir de ONTAP 9.4, puedes intercambiar en caliente el módulo NVMe SSD Flash Cache, que está ubicado delante del módulo NVRAM10 en la ranura 6, por un módulo de caché de la misma capacidad del mismo fabricante o de otro compatible.
