...
summary: 'Una vez que haya completado el reemplazo de FRU en una configuración de MetroCluster de dos nodos, puede realizar la operación de retroceso de MetroCluster . Esto devuelve la configuración a su estado operativo normal, con las máquinas virtuales de almacenamiento de origen de sincronización (SVM) en el sitio anteriormente dañado ahora activas y entregando datos desde los grupos de discos locales. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales.' 
---
= Vuelva a cambiar los agregados en una configuración MetroCluster de dos nodos: FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar el reemplazo del medio de arranque, realice la operación de retroceso de MetroCluster . El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
