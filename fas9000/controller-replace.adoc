...
summary: Sustituye el hardware del módulo controlador en un sistema FAS9000. Este procedimiento incluye quitar el nodo con fallos, mover los componentes FRU al módulo controlador de reemplazo, instalar el módulo controlador de reemplazo en el chasis y arrancar el sistema en modo de mantenimiento. 
---
= Sustituye el controlador en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el hardware del módulo controlador en un sistema FAS9000. Este procedimiento incluye quitar el nodo con fallos, mover los componentes FRU al módulo controlador de reemplazo, instalar el módulo controlador de reemplazo en el chasis y arrancar el sistema en modo de mantenimiento.
