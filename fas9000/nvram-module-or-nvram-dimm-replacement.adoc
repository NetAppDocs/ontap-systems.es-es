...
summary: Sustituye un módulo NVRAM defectuoso o los DIMM dentro del módulo NVRAM en un sistema FAS9000. Como el ID del sistema se deriva del módulo NVRAM, al sustituir el módulo se reasignan los discos que pertenecen al sistema al nuevo ID del sistema. 
---
= Sustituye el módulo NVRAM o los DIMM de NVRAM en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo NVRAM defectuoso o los DIMM dentro del módulo NVRAM en un sistema FAS9000. Como el ID del sistema se deriva del módulo NVRAM, al sustituir el módulo se reasignan los discos que pertenecen al sistema al nuevo ID del sistema.
