...
summary: Apaga o toma el control del controlador defectuoso en un sistema FAS9000, siguiendo el procedimiento adecuado para tu configuración, de modo que el nodo en buen estado siga proporcionando datos desde el almacenamiento del nodo defectuoso. 
---
= Apaga el controlador defectuoso de un sistema FAS9000 antes de sustituirlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga o toma el control del controlador averiado en un sistema FAS9000 usando el procedimiento adecuado para tu configuración.
