...
summary: 'Completa la sustitución del chasis en un sistema FAS9000 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA incluidas con el kit.' 
---
= Completa la sustitución del chasis de un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis en un sistema FAS9000 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA incluidas con el kit.
