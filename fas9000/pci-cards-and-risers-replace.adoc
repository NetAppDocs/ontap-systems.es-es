...
summary: Sustituye un módulo de E/S en un sistema FAS9000 siguiendo una secuencia específica de tareas compatible con todas las versiones de ONTAP que ejecute tu sistema. 
---
= Sustituir un módulo de E/S en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de E/S en un sistema FAS9000 siguiendo una secuencia específica de tareas compatible con todas las versiones de ONTAP que ejecute tu sistema.
...
. Si el sistema está configurado para admitir la interconexión de clúster de 10 GbE y conexiones de datos en NIC de 40 GbE o puertos integrados, convierta estos puertos a conexiones de 10 GbE mediante el `nicadmin convert` Comando del modo de mantenimiento.
+
...
NOTE: Si su sistema está en una configuración MetroCluster de dos nodos, debe volver a los agregados como se describe en el siguiente paso.
