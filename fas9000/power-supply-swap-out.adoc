...
summary: Intercambia en caliente una fuente de alimentación en un sistema FAS9000 sin interrumpir el servicio. Este procedimiento incluye apagar, desconectar y retirar la fuente de alimentación antigua, luego instalar, conectar y encender la fuente de alimentación de recambio. 
---
= Intercambia en caliente una fuente de alimentación en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Intercambia en caliente una fuente de alimentación en un sistema FAS9000 sin interrumpir el servicio. Este procedimiento incluye apagar, desconectar y retirar la fuente de alimentación antigua, luego instalar, conectar y encender la fuente de alimentación de recambio.
