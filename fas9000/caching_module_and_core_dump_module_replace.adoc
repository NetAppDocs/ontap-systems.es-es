...
---
= Sustituya el módulo de almacenamiento en caché o añada/sustituya un módulo de volcado principal: AFF A700 y FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Paso 1: Apagar el controlador dañado
...
| image:../media/legend_icon_01.png[""] | Botón de liberación naranja. 
