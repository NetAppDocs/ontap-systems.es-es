...
summary: Para completar el procedimiento de sustitución y restablecer el funcionamiento completo del sistema, debes volver a cablear el almacenamiento, restaurar la configuración de NetApp Storage Encryption si es necesario e instalar licencias para el nuevo controlador. 
---
= Completa la sustitución del controlador de un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del controlador de tu sistema FAS9000, vuelve a cablear el almacenamiento, restaura la configuración de NetApp Storage Encryption si es necesario e instala las licencias para el nuevo controlador.
...
== Paso 3 (solo para MetroCluster): Cambia de nuevo los agregados en una configuración de MetroCluster de dos nodos
