...
summary: Realiza el intercambio en caliente del módulo del ventilador en un sistema FAS9000 sin interrumpir el servicio. Debes reemplazar el módulo del ventilador en un plazo de dos minutos después de retirarlo para evitar interrumpir el flujo de aire del sistema. 
---
= Intercambia en caliente un módulo de ventilador en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza el intercambio en caliente del módulo del ventilador en un sistema FAS9000 sin interrumpir el servicio. Debes reemplazar el módulo del ventilador en un plazo de dos minutos después de retirarlo para evitar interrumpir el flujo de aire del sistema.
