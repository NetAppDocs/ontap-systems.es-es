...
summary: Para acceder a los componentes dentro del controlador, primero debe quitar el módulo del controlador del sistema y luego quitar la cubierta del módulo del controlador. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Sustituye el soporte de arranque de tu sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para reemplazar el medio de arranque, debe quitar el módulo del controlador dañado, instalar el medio de arranque de reemplazo y transferir la imagen de arranque a una unidad flash USB. El sistema FAS9000 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
