...
summary: Sustituye el soporte de arranque en un sistema FAS9000 quitando el módulo de controlador con fallos, instalando el soporte de arranque de repuesto y transfiriendo la imagen de arranque a una memoria USB. 
---
= Sustituye el soporte de arranque en un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el soporte de arranque en un sistema FAS9000 retirando el módulo controlador defectuoso, instalando el soporte de arranque de repuesto y transfiriendo la imagen de arranque a una memoria USB. El sistema FAS9000 solo admite la recuperación manual del soporte de arranque; la recuperación automática del soporte de arranque no está soportada.
