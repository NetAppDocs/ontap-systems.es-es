...
summary: 'Puede reemplazar un módulo de estante NVMe (NSM) dañado de manera no disruptiva en un estante de unidad NX224 que esté encendido y mientras la E/S esté en progreso.' 
---
= Reemplaza un NSM en una bandeja NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Antes de cerrar la cubierta del NSM dañado, asegúrate de que las lengüetas eyectoras de todas las ranuras DIMM vacías vuelven completamente a la posición de bloqueo.
