...
---
= LED de los estantes de la unidad de monitor - Estantes NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puede supervisar el estado de su estante comprendiendo la ubicación y las condiciones de estado de los LED en los componentes del estante de su unidad.

* Los LED de ubicación (azules), en el panel de visualización del operador (ODP) de un estante y en ambos módulos de estante NVMe (NSM), se pueden activar para ayudar a localizar físicamente el estante que necesita mantenimiento: `storage shelf location-led modify -shelf-name _shelf_name_ -led-status on`
+
...
image::../media/drw_tp_nsmb_leds_ieops-2206.svg[LED del módulo NX224 NSM140]
...
Los LED de una fuente de alimentación de CA (PSU) indican si la PSU está funcionando normalmente o hay problemas de hardware.

La siguiente ilustración y tablas describen el LED de una fuente de alimentación.

image::../media/drw_generic_psu_ac_terra_cotta_ieops-2370.svg[LED de actividad de alimentación de la fuente de alimentación]
...
| Estado | Potencia/actividad (verde) | Atención (rojo) 
 ...
 a| 
No hay alimentación de CA en el gabinete
 a| 
Apagado
 a| 
Apagado
 ...
 a| 
No hay alimentación de CA a la fuente de alimentación
 a| 
Apagado
 a| 
Encendido
 ...
 a| 
La alimentación de CA está activada, pero la fuente de alimentación no está en el gabinete
 a| 
Parpadeo
 a| 
Apagado
