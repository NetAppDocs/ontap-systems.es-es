...
summary: Empieza a reemplazar el boot media en tu sistema de almacenamiento AFF C250 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el boot media, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema AFF C250 usando el proceso manual de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a reemplazar el boot media en tu sistema de almacenamiento AFF C250 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el boot media, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema.
