...
summary: Después de instalar el nuevo dispositivo de medios de arranque en tu sistema AFF C250, puedes iniciar el proceso automatizado de recuperación de medios de arranque para restaurar la configuración desde el nodo asociado. 
---
= Restaura la imagen de arranque en tu sistema de almacenamiento AFF C250 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
