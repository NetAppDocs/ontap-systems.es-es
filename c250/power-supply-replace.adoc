...
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente una fuente de alimentación averiada en un sistema AFF C250 sin apagar el controlador.
