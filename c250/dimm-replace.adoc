...
---
= Sustituye un módulo DIMM en un sistema AFF C250 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en un sistema AFF C250 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles, para evitar una situación de pánico del sistema.
