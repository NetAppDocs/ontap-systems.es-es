...
---
= Restaurar y verificar la configuración del controlador en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Una vez completada la sustitución del hardware y tras iniciar el sistema AFF C250 en modo de mantenimiento, necesitas verificar la configuración de bajo nivel del controlador de recambio y volver a configurar los ajustes del sistema según sea necesario.
