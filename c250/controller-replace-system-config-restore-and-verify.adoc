...
---
= Restaura y comprueba la configuración del controlador en tu sistema de almacenamiento AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la sustitución del hardware y arrancar tu sistema AFF C250 en modo de mantenimiento, necesitas verificar la configuración de bajo nivel del sistema del controlador de reemplazo y reconfigurar los ajustes del sistema según sea necesario.
...
.El futuro
Después de que hayas restaurado y verificado la configuración del sistema, necesitas link:controller-replace-recable-reassign-disks.html["recablea el sistema y reasigna discos"].
