...
---
= Sustituye el chasis de tu sistema de almacenamiento AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza el chasis de tu sistema AFF C250 cuando lo requiera una falla de hardware. El proceso de reemplazo implica quitar los controladores y las fuentes de alimentación (PSU), quitar las unidades, instalar el chasis de reemplazo y volver a instalar los componentes del chasis.
...
.El futuro
Una vez que hayas sustituido el chasis AFF C250 dañado y reinstalado los componentes, necesitas link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"]
