...
---
= Instala un sistema de almacenamiento AFF C250 siguiendo estos pasos detallados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala un sistema de almacenamiento AFF C250 usando instrucciones detalladas paso a paso que cubren el montaje en bastidor, el cableado y la puesta en marcha inicial del sistema.
...
.Pasos
. Conecta los puertos de interconexión de clúster e0c a e0c y e0d a e0d con los cables de interconexión de clúster de 25 GbE.
+
...
--
.Opción 2: Cable a una red de datos o host de 25 GbE
--
