...
summary: Antes de sustituir el chasis en tu sistema AFF C250, asegúrate de cumplir con los requisitos necesarios para una sustitución exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, asegurarte de que tienes credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias. 
---
= Revisa los requisitos antes de sustituir el chasis en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis en tu sistema AFF C250, asegúrate de cumplir con los requisitos necesarios para una sustitución exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, asegurarte de que tienes credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias.
