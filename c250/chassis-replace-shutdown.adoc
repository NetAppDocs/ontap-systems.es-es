...
---
= Apaga los controladores AFF C250 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema de almacenamiento AFF C250 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el chasis.
