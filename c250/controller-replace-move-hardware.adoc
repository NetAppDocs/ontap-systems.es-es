...
---
= Sustituye el controlador de tu sistema de almacenamiento AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza el controlador de tu sistema AFF C250 cuando lo requiera una falla de hardware. El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
.El futuro
Después de reemplazar el controlador AFF C250 dañado, tienes que link:controller-replace-system-config-restore-and-verify.html["restaurar y verificar la configuración del sistema"].
