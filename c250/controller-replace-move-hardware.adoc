...
---
= Sustituya el hardware del módulo del controlador - AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Hay un dispositivo para medios de arranque en el AFF C250 bajo el conducto de aire del módulo del controlador. Debe moverlo del módulo del controlador defectuoso al módulo del controlador de repuesto.
