...
---
= Sustituye la batería del RTC en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería del RTC en un sistema AFF C250 para que los servicios y las aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
