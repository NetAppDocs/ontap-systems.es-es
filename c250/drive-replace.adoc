...
---
= Sustituir una unidad SSD en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad SSD con error en un sistema AFF C250 sin interrumpir el servicio mientras se están realizando operaciones de E/S.
