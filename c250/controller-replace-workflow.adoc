...
summary: Empieza a reemplazar el controlador en tu sistema de almacenamiento AFF C250 apagando el controlador dañado, quitando y reemplazando el controlador, reconfigurando la configuración del sistema y verificando las operaciones del sistema. 
---
= Flujo de trabajo de reemplazo de controladores - AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza el controlador en tu sistema de almacenamiento AFF C250 apagando el controlador dañado, quitando y reemplazando el controlador, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de reemplazo.
