...
summary: Para completar la sustitución del controlador de tu sistema AFF C250 para que vuelva a funcionar completamente, debes restaurar la configuración de NetApp Storage Encryption, instalar licencias para el nuevo controlador y devolver la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del controlador de tu sistema AFF C250 a pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption (si es necesario), instalar licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA enviadas con el kit.
