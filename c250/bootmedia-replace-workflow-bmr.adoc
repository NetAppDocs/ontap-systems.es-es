...
summary: Comienza a reemplazar el medio de arranque en tu sistema de almacenamiento AFF C250 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el medio de arranque, restaurando la imagen en el medio de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema AFF C250 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La recuperación automatizada de la imagen de arranque implica que el sistema identifica y selecciona automáticamente la opción de menú de arranque adecuada. Utiliza la imagen de arranque en el nodo partner para reinstalar ONTAP en el medio de arranque de sustitución en tu sistema de almacenamiento AFF C250.
