...
---
= Recablea un sistema AFF C250 y reasigna los discos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar los pasos de restauración y verificación de la configuración del sistema AFF C250, necesitas volver a cablear el sistema y reasignar los discos.
