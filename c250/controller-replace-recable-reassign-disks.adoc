...
---
= Vuelve a cablear tu sistema de almacenamiento AFF C250 y reasigna los discos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la restauración y verificar la configuración del sistema AFF C250, necesitas volver a cablear el sistema y reasignar los discos.
