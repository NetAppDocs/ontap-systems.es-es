...
---
= Sustituye la batería del NVMEM en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una batería NVMEM defectuosa en un sistema AFF C250 quitando el módulo controlador, cambiando la batería y volviendo a instalar el módulo controlador.
