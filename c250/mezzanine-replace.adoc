...
---
= Sustituir o instalar una tarjeta de entrepiso en un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta de entreplanta defectuosa o instala una nueva en un sistema AFF C250 quitando los cables y cualquier módulo SFP o QSFP, cambiando la tarjeta y volviendo a conectar los cables.
