...
summary: Reemplace un módulo de ventilador defectuoso o averiado en su sistema AFX 1K para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema.  Los ventiladores son intercambiables en caliente y se pueden reemplazar sin apagar el sistema. 
---
= Realiza el intercambio en caliente de un ventilador en tu sistema de almacenamiento AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de ventilador defectuoso o averiado en su sistema AFX 1K para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema.  Los ventiladores son intercambiables en caliente y se pueden reemplazar sin apagar el sistema.  Este procedimiento incluye identificar el ventilador defectuoso mediante mensajes de error de la consola e indicadores LED, quitar el bisel, cambiar el módulo del ventilador y devolver la pieza defectuosa a NetApp.
