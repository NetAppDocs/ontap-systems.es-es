...
summary: Sustituye la batería del reloj en tiempo real de tu sistema de almacenamiento AFX 1K para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Cambia la batería del reloj en tiempo real de tu sistema de almacenamiento AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
