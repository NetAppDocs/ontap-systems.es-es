...
summary: Sustituye el chasis de tu sistema de almacenamiento AFX 1K cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar el controlador de la parte frontal del chasis, retirar las fuentes de alimentación, NVRAM12, los módulos y espacios en blanco de E/S, y el módulo de administración de sistemas, y luego instalar el chasis de reemplazo y volver a instalar los componentes del chasis. 
---
= Sustituye el chasis de tu sistema de almacenamiento AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de reemplazar el chasis AFX 1K deteriorado y reinstalar sus componentes, completa el link:chassis-replace-complete-system-restore-rma.html["reemplazo del chasis"].
