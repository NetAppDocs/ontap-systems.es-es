...
summary: Apaga el controlador de tu sistema de almacenamiento AFX 1K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque. 
---
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFX 1K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque.
