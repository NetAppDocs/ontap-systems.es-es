...
summary: Agregue un módulo de E/S a su sistema de almacenamiento AFX 1K para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos. 
---
= Agrega un módulo I/O a un sistema AFX 1K para mejorar la conectividad de red
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agregue un módulo de E/S a su sistema de almacenamiento AFX 1K para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Puede agregar un módulo de E/S a su sistema de almacenamiento AFX 1K cuando haya ranuras vacías disponibles o cuando todas las ranuras estén completamente ocupadas.
...
.Antes de empezar
* Consulta la  https://hwu.netapp.com["Hardware Universe de NetApp"^] para asegurarte de que el nuevo módulo de E/S es compatible con tu sistema de almacenamiento y la versión de ONTAP.
