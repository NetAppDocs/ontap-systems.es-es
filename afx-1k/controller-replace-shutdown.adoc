...
summary: Apague el controlador en su sistema de almacenamiento AFX 1K cuando esté dañado.  Antes de realizar mantenimiento o reemplazar componentes, es fundamental apagar el controlador de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
= Apaga el controlador defectuoso de tu sistema de almacenamiento AFX 1K antes de sustituirlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFX 1K para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el controlador.

Apague el módulo del controlador mediante una de las siguientes opciones.
...
.El futuro
Después de apagar el controlador,link:controller-replace-move-hardware.html["sustituya el controlador"] .
