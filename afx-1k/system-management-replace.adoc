...
---
= Sustituye el módulo de administración de sistemas en un sistema AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
El módulo de administración de sistemas, situado en la parte trasera del controlador, a la izquierda de la ranura 8, contiene componentes integrados para la administración de sistemas, así como puertos para la administración externa. El controlador de destino debe estar apagado y desconectado de la alimentación para reemplazar un módulo de administración de sistemas defectuoso o reemplazar el soporte de arranque.
...
** Si AutoSupport no está activado, ponte en contacto con https://mysupport.netapp.com["Soporte de NetApp"^] para registrar el número de serie.
