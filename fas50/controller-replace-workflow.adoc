...
---
= Flujo de trabajo para el reemplazo del controlador FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Para sustituir el controlador hay que retirar el controlador averiado, trasladar los componentes de la FRU al controlador de recambio, instalar este último, ajustar la hora y la fecha y volver a conectarlo.
