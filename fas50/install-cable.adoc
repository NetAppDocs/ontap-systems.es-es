...
---
= Conecta el hardware del FAS50 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_isi_fas50_4p_25gbe_optional_cabling_ieops-1934.svg[cable fas50 a switches de red ethernet host de 10/25 GbE]
...
+
El cableado para otros estantes SAS compatibles es similar. Consulta link:../sas3/install-new-system.html["Instale y conecte los estantes de cables para una nueva instalación del sistema"^]. También puedes consultar link:../sas3/overview-cabling-rules-examples.html["Resumen de las normas, hojas de trabajo y ejemplos sobre el cableado SAS"^].
