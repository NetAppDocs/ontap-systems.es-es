...
summary: Después de encender el sistema de almacenamiento FAS50, estará listo para detectar su red de clúster y configurar un clúster de ONTAP. 
---
= Configuración y configuración completas del sistema de almacenamiento: FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de encender el sistema de almacenamiento FAS50, estará listo para detectar su red de clúster y configurar un clúster de ONTAP.
