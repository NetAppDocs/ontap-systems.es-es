...
summary: Antes de reemplazar el chasis de su sistema de almacenamiento FAS50, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso.  Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, verificar que tenga el chasis de reemplazo correcto y las herramientas necesarias. 
---
...
[role="lead"]
Antes de reemplazar el chasis de su sistema de almacenamiento FAS50, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso.  Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, verificar que tenga el chasis de reemplazo correcto y las herramientas necesarias.
