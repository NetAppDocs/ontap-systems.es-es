...
summary: Antes de sustituir el chasis de tu sistema de almacenamiento FAS50, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente y que tienes el chasis de repuesto correcto y las herramientas necesarias. 
---
= Revisa los requisitos antes de sustituir el chasis en un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis de tu sistema de almacenamiento FAS50, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente y que tienes el chasis de repuesto correcto y las herramientas necesarias.
