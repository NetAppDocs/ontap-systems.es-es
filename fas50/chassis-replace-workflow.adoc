...
---
= Flujo de trabajo para la sustitución del chasis FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
La sustitución del chasis implica trasladar los soportes para unidades, los módulos de caché, los controladores (junto con las fuentes de alimentación) y el frontal del chasis averiado al nuevo chasis. Luego, cambias el chasis averiado por uno nuevo del mismo modelo.
