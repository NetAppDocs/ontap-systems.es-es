...
summary: Los medios de arranque del sistema FAS50 almacenan datos esenciales de configuración y firmware. El proceso de sustitución implica la extracción del módulo del controlador, la extracción del soporte de arranque dañado, la instalación del soporte de arranque de reemplazo y, a continuación, la transferencia de la imagen ONTAP al soporte de arranque de reemplazo. 
---
= Sustituya el soporte de arranque - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Los medios de arranque del sistema FAS50 almacenan datos esenciales de configuración y firmware. El proceso de sustitución implica la extracción del módulo del controlador, la extracción del soporte de arranque dañado, la instalación del soporte de arranque de reemplazo y, a continuación, la transferencia de la imagen ONTAP al soporte de arranque de reemplazo.
