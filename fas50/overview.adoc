...
---
= Especificaciones clave de un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas especificaciones del FAS50 corresponden a un único par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para consultar la lista completa de especificaciones del FAS50.
