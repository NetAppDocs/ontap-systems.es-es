...
sidebar: sidebar 
summary: Especificaciones clave para el grupo de plataformas FAS50 
---
...
[role="lead"]
Las siguientes son especificaciones seleccionadas para el sistema de almacenamiento FAS50 en un solo par de alta disponibilidad.  Visite NetApp Hardware Universe (HWU) para conocer las especificaciones completas de este sistema de almacenamiento.
...
* Tipo: NAS; Pares HA: 4; Capacidad bruta: 42,2 PB / 37,5 PiB; Memoria máxima: 512 GB
* Tipo: SAN; Pares HA: 4; Capacidad bruta: 42,2 PB / 37,5 PiB; Memoria máxima: 512 GB
* Tipo: Par HA; Capacidad bruta: 10,6 PB / 9,4 PiB; Memoria máxima: 128,0000
