...
summary: Añada un módulo de I/O a su sistema de almacenamiento FAS50 para mejorar la conectividad de red y ampliar la capacidad de su sistema para gestionar el tráfico de datos. 
---
= Agrega un módulo de I/O a un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
