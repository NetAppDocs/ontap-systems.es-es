...
[role="lead"]
Agregue un módulo de E/S a su sistema FAS50 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Puede añadir un módulo de I/O a los sistemas de almacenamiento FAS50 cuando haya ranuras disponibles o cuando todas estén completamente ocupadas.
