...
summary: 'Reemplace el chasis de su sistema FAS50 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar las controladoras y las unidades de suministro de alimentación (PSU), extraer los módulos de caché, instalar el chasis de reemplazo y reinstalar los componentes del chasis.' 
---
= Sustituya el chasis - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el chasis de su sistema FAS50 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar las controladoras y las unidades de suministro de alimentación (PSU), extraer los módulos de caché, instalar el chasis de reemplazo y reinstalar los componentes del chasis.
...
.El futuro
Después de reemplazar el chasis dañado FAS50 y reinstalar los componentes en él, debe link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"].
