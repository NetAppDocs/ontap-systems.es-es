...
summary: Reemplace el chasis del sistema de almacenamiento FAS50 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar las controladoras, quitar todos los módulos de almacenamiento en caché y espacios vacíos de unidades, instalar el chasis de reemplazo y reinstalar los componentes del chasis. 
---
= Sustituye el chasis en un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
