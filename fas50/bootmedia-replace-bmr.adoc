...
summary: El medio de arranque de su sistema de almacenamiento FAS50 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo controlador, retirar el medio de arranque dañado, instalar el nuevo medio de arranque y, finalmente, reinstalar el módulo controlador. 
---
= Sustituye el soporte de arranque de tu sistema FAS50 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El medio de arranque de su sistema de almacenamiento FAS50 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo controlador, retirar el medio de arranque dañado, instalar el nuevo medio de arranque y, finalmente, reinstalar el módulo controlador.
