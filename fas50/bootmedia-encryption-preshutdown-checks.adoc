...
summary: 'Para garantizar la seguridad de los datos en su sistema de almacenamiento FAS50, debe verificar la compatibilidad y el estado de la clave de cifrado en el soporte de arranque. Compruebe si la versión de ONTAP es compatible con el cifrado de volúmenes de NetApp (NVE) y antes de apagar la controladora compruebe si el gestor de claves está activo.' 
---
= Comprueba la compatibilidad con cifrado en el soporte de arranque de un sistema FAS50 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
