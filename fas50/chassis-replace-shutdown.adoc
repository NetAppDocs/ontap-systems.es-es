...
summary: Apague las controladoras en su sistema de almacenamiento FAS50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el chasis. 
---
= Apaga los controladores del FAS50 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras en su sistema de almacenamiento FAS50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el chasis.
