...
summary: Apague la controladora deteriorada en su sistema de almacenamiento FAS50 para evitar pérdida de datos y garantizar la estabilidad del sistema al sustituir la controladora. 
---
= Apaga el controlador defectuoso de un sistema FAS50 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague la controladora deteriorada en su sistema de almacenamiento FAS50 para evitar pérdida de datos y garantizar la estabilidad del sistema al sustituir la controladora.
