...
summary: Sustituye el DIMM de tu sistema de almacenamiento FAS50 si se detectan errores de memoria corregibles o incorregibles en exceso. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución implica apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo DIMM en un sistema FAS50 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM de tu sistema de almacenamiento FAS50 si se detectan errores de memoria corregibles o incorregibles en exceso. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución implica apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp.
