...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento FAS50 si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Intercambia en caliente un módulo de E/S en tu sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
