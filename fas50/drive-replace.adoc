...
summary: Realiza un intercambio en caliente de una unidad en tu sistema de almacenamiento FAS50 cuando una unidad falle o necesite una actualización. El proceso de sustitución consiste en identificar la unidad defectuosa, retirarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad en un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad en tu sistema de almacenamiento FAS50 cuando una unidad falle o necesite una actualización. El proceso de sustitución consiste en identificar la unidad defectuosa, retirarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
