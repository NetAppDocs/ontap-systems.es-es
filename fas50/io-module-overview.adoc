...
summary: Los sistemas FAS50 ofrecen flexibilidad para ampliar o reemplazar módulos de E/S y mejorar la conectividad y el rendimiento de la red. Añadir, intercambiar en caliente o reemplazar un módulo de E/S es esencial para mejorar las capacidades de la red o reparar un módulo averiado. 
---
= Descripción general de cómo agregar, intercambiar en caliente y reemplazar un módulo de E/S - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Los sistemas FAS50 ofrecen flexibilidad para ampliar o reemplazar módulos de E/S y mejorar la conectividad y el rendimiento de la red. Añadir, intercambiar en caliente o reemplazar un módulo de E/S es esencial para mejorar las capacidades de la red o reparar un módulo averiado.
