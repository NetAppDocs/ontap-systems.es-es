...
summary: Antes de sustituir el controlador de tu sistema de almacenamiento FAS50, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente, verificar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto. 
---
= Revisa los requisitos antes de sustituir el controlador en un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema de almacenamiento FAS50, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente, verificar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto.
