...
---
= Flujo de trabajo de instalación y configuración de FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Para preparar la instalación, prepara el emplazamiento, comprueba los requisitos ambientales y eléctricos, y verifica que haya suficiente espacio en rack. Luego, desembala el equipo, compara el contenido con el albarán de entrega y registra el hardware para acceder a los beneficios de soporte.
