...
summary: Reemplace un módulo de ventilador en su sistema FAS50 cuando un ventilador falla o no está funcionando eficientemente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp. 
---
= Sustituye un ventilador en tu sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de ventilador en su sistema FAS50 cuando un ventilador falla o no está funcionando eficientemente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
