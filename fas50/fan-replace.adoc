...
summary: Sustituye el módulo del ventilador de tu sistema FAS50 cuando un ventilador falle o no funcione de forma eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general. El proceso de sustitución consiste en apagar el controlador, extraer el controlador, sustituir el ventilador, volver a instalar el controlador y devolver la pieza defectuosa a NetApp. 
---
= Sustituye el módulo del ventilador en un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo del ventilador de tu sistema FAS50 cuando un ventilador falle o no funcione de forma eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general. El proceso de sustitución consiste en apagar el controlador, extraer el controlador, sustituir el ventilador, volver a instalar el controlador y devolver la pieza defectuosa a NetApp.
