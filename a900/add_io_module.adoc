...
---
= Agrega un módulo de I/O a un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puede añadir un módulo de I/O al sistema de almacenamiento AFF A900 cuando haya ranuras vacías disponibles o cuando todas estén completamente ocupadas.
...
+
image:../media/drw_a900_remove_PCIe_module.svg["Extracción de un módulo PCIe"]
