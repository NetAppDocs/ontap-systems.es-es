...
---
= Sustituye el módulo LED USB de tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo LED USB de tu sistema AFF A900 para restablecer la conectividad a los puertos de consola y el estado del sistema. El reemplazo no requiere herramientas y no interrumpe el servicio.
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[Retire un módulo USB LED]
