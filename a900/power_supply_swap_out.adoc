...
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una fuente de alimentación de tu sistema AFF A900 cuando falle o presente algún fallo. Las fuentes de alimentación son redundantes e intercambiables en caliente, así que no tienes que apagar el controlador para hacer este reemplazo.
