...
[role="lead"]
Sustituye la fuente de alimentación de tu sistema AFF A900 cuando falle o presente algún fallo. Las fuentes de alimentación son redundantes y intercambiables en caliente, así que no tienes que apagar el controlador para hacer este reemplazo.
