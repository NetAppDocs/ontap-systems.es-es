...
summary: El módulo NVRAM está formado por la NVRAM11, los DIMM y hasta dos módulos Flash Cache SSD NVMe por módulo NVRAM. 
---
= Sustituye el módulo NVRAM o los módulos DIMM de NVRAM de tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo NVRAM o los DIMM de NVRAM de tu sistema AFF A900 cuando el módulo falle o un DIMM presente un fallo. El proceso de sustitución consiste en quitar el módulo NVRAM del chasis, reemplazar el componente defectuoso y volver a instalar el módulo.
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[Quite el módulo de NVRAM]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Quite el contenido del módulo NVRAM]
