...
. Si el cifrado de almacenamiento está activado, debe ********
...
[role="lead"]
Utilice el procedimiento adecuado si tiene activado el cifrado de almacenamiento.
...
. Introduzca la frase de contraseña integrada del gestor de claves para el clúster en el indicador: Aquí se necesita el ejemplo******
. Introduzca los datos de la clave de backup
+

NOTE: El nodo vuelve al menú de arranque después de completar la información de la contraseña.
...
. Introduzca la información del certificado de administración en los mensajes: Se necesita el ejemplo aquí*****
+

NOTE: El nodo vuelve al menú de arranque después de completar la información del certificado de gestión.
...
--
====
. Restablezca el MSID de los discos:
+
.. Si utiliza la encriptación de almacenamiento integrada, siga el procedimiento descrito en https://docs.netapp.com/us-en/ontap/encryption-at-rest/assign-authentication-keys-seds-onboard-task.html["Asignar una clave de autenticación de datos a una unidad FIPS o SED (gestión de claves incorporada)"^]
.. I usted está usando keyManager externo, siga el procedimiento en https://docs.netapp.com/us-en/ontap/encryption-at-rest/assign-authentication-keys-seds-external-task.html["Asignar una clave de autenticación de datos a una unidad FIPS o SED (gestión de claves externa)"^]
