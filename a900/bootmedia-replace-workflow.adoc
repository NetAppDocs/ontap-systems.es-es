...
summary: Empieza a sustituir el soporte de arranque de tu sistema de almacenamiento AFF A900. El proceso incluye revisar los requisitos de sustitución, comprobar el estado del cifrado, apagar el controlador, sustituir el soporte de arranque, arrancar la imagen de recuperación, restaurar el cifrado y verificar el funcionamiento del sistema. 
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema AFF A900 usando el proceso manual de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
