...
---
= Completa la sustitución del chasis de un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comprueba el estado de alta disponibilidad (HA) del chasis y devuelve la pieza defectuosa a NetApp para completar el reemplazo del chasis de tu sistema AFF A900.
