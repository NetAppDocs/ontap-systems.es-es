...
---
= Flujo de reemplazo del controlador AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a sustituir el controlador de tu sistema AFF A900 revisando los requisitos previos, apagando el controlador averiado, transfiriendo el hardware al controlador de sustitución y restaurando la configuración del sistema.
