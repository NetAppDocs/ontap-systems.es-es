...
---
= Intercambia en caliente un módulo de ventilador en un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de un módulo de ventilador de tu sistema AFF A900 para mantener una refrigeración adecuada. Los módulos de ventilador deben reemplazarse sin interrumpir el servicio, siguiendo una secuencia específica de tareas.
...
+
image::../media/drw_a900_remove_install_fan.svg[Extracción o instalación del ventilador]
