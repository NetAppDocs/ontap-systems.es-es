...
summary: Antes de reemplazar el medio de arranque en su sistema AFF A900, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. 
---
...
[role="lead"]
Antes de reemplazar el medio de arranque en su AFF A900, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso.  Esto incluye verificar que tiene el medio de arranque de reemplazo correcto, confirmar que el puerto e0S (llave e0M) en el controlador dañado no esté defectuoso y determinar si el Administrador de claves integrado (OKM) o el Administrador de claves externo (EKM) está habilitado.
