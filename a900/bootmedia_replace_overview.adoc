...
sidebar: sidebar 
keywords: AFF A900 
summary: El medio de arranque almacena un conjunto primario y secundario de archivos de sistema que el sistema utiliza cuando arranca. Dependiendo de la configuración de tu red, puedes realizar una sustitución no disruptiva o disruptiva. 
---
= Revisa los requisitos para sustituir el soporte de arranque en un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
