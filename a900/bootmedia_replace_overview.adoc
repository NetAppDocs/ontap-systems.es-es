...
[role="lead"]
Antes de sustituir el soporte de arranque en tu sistema AFF A900, asegúrate de cumplir los requisitos necesarios para que la sustitución sea exitosa. Esto incluye tener una memoria USB formateada en FAT32 con suficiente espacio de almacenamiento para la imagen de recuperación de ONTAP y saber si vas a realizar una sustitución sin interrupciones o con interrupciones.
