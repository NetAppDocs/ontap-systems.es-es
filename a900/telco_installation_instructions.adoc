...
image::../media/drw_telco_mid_mount_1.gif[Instalación de montaje hasta la mitad en rack Telco]



== Instale el kit de raíl de montaje empotrado de dos postes

image::../media/drw_telco_front_mount_1.gif[Instalación en rack de Telco]
