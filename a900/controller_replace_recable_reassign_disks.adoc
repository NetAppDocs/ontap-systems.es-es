...
summary: Continúa el procedimiento de sustitución recableando las configuraciones de almacenamiento y red. 
---
= Vuelve a cablear el sistema y reasigna los discos en tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vuelve a cablear las configuraciones de almacenamiento y red, y restaura NetApp Storage Encryption para que tu sistema AFF A900 vuelva a funcionar plenamente.
