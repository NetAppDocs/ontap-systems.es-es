...
---
= Especificaciones clave para un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Los sistemas de almacenamiento AFF A900, configurados en un único par de alta disponibilidad, ofrecen estas especificaciones clave. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] para consultar las especificaciones completas de este sistema de almacenamiento.
...
* Versión mínima de ONTAP : ONTAP 9.10.1RC2
...
* Controlador de gestión de placa base (BMC) basado en Ethernet e interfaz de gestión ONTAP
