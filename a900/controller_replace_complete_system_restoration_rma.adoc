...
---
= Restauración completa del sistema - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar el procedimiento de sustitución y restaurar el funcionamiento completo del sistema, restaure la configuración de cifrado del almacenamiento de NetApp (si es necesario) e instale licencias para la controladora nueva.
