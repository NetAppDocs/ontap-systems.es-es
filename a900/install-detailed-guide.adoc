...
---
= Instala un sistema AFF A900 siguiendo las instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A900 siguiendo estas instrucciones detalladas paso a paso, desde la preparación del sitio hasta la puesta en marcha del clúster ONTAP.
...
+
Las bandejas NS224 vienen preconfiguradas con los ID de bandeja 00 y 01. Si quieres cambiar los ID de las bandejas, debes crear una herramienta para insertarla en el orificio donde está el botón. Consulta link:../ns224/change-shelf-id.html["Cambiar un ID de bandeja - bandejas NS224"] para ver instrucciones detalladas.
...
.. Selecciona *Network* en el panel de la izquierda y haz clic con el botón derecho, luego selecciona *refresh*.
