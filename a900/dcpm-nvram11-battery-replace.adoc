...
sidebar: sidebar 
keywords: AFF A900 
summary: Para intercambiar en caliente un módulo de alimentación del controlador de etapas, que contiene la batería NVRAM11, localiza el módulo DCPM averiado, extráelo del chasis e instala el módulo DCPM de repuesto. 
---
= Sustituye el módulo DCPM que contiene la batería NVRAM11 en un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente del módulo de alimentación del controlador de destage (DCPM) en tu sistema AFF A900 cuando falle. El DCPM contiene la batería NVRAM11 y debe reemplazarse en un plazo de cinco minutos tras su extracción para evitar la pérdida de la protección de datos.
...
+
image::../media/drw_a900_remove_NV_battery.svg[Extraiga la batería NV]
