...
X66240A-5 (112-00600), 5 m
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[SFP de cobre GbE]
 a| 
Cable de red
...
X66100-5 (112-00544), 5 m
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[SFP de cobre GbE]
 a| 
...
X66033A (112-00438), 3 m.
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[Conector de fibra LC]
 a| 
Red óptica FC
...
X6562-R6 (112-00196), 5 m
 a| 
image::../media/oie_cable_rj45.svg[Conector de cable RJ-45]
 a| 
...
No aplicable
 a| 
image::../media/oie_cable_micro_usb.svg[Conector micro USB]
 a| 
...
No aplicable
 a| 
image::../media/oie_cable_power.svg[Conector del cable de alimentación]
 a| 
...
| Paso | Ejecute cada controladora 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[Icono de anotación uno]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Conector de 100 GB]



 a| 
image::../media/oie_legend_icon_2_lp.svg[Icono de anotación dos]
 a| 
...
image::../media/oie_cable_rj45.svg[Conector de cable RJ-45]
 ...
 a| 
image::../media/oie_legend_icon_3_o.svg[Icono de anotación tres]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Conector de cable de 100 GbE]



 a| 
image:../media/oie_legend_icon_4_dr.svg["Icono de anotación cuatro"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.svg["SFP de cobre GbE"]
 ...
 a| 
image::../media/oie_legend_icon_5_lp.png[Icono de anotación cinco]
 a| 
...
image:../media/oie_cable_power.svg["Cable de alimentación"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["Cable de 100 GbE"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["Icono de anotación dos"]
 a| 
Conecte los cables de los puertos de gestión de las controladoras (llave inglesa).
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[drw a900fas9500 icono de encendido IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[dirección de la lengüeta de tracción del cable]
...
| Paso | Ejecute cada controladora 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Llamada número uno]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Conector QSFP de 100 GbE]
...
Cable de 100 GbE
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[Llamada número dos]
 a| 
...
| Paso | Ejecute cada controladora 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Icono de anotación uno]
 a| 
...
Tapa final de estante
 ...
 a| 
image::../media/legend_icon_02.png[Icono de anotación dos]
 a| 
Placa frontal de la bandeja
 ...
 a| 
image::../media/legend_icon_03.png[Icono de anotación tres]
 a| 
LED de ID de la bandeja
 ...
 a| 
image::../media/legend_icon_04.png[Icono de anotación cuatro]
 a| 
