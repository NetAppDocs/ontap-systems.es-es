...
---
= Sustituye un módulo de E/S en tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de E/S en tu sistema AFF A900 cuando falle o necesite una actualización. El proceso de sustitución requiere una secuencia específica de tareas para evitar la interrupción del servicio.
