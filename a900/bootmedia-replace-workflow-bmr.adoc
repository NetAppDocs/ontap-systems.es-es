...
summary: Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF A900 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el medio de arranque, restaurando la imagen en el medio de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema AFF A900 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
