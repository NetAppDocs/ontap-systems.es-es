...
summary: Empieza a sustituir el chasis de tu sistema AFF A900. El procedimiento requiere retirar y volver a instalar las fuentes de alimentación, los ventiladores, los módulos controladores, los módulos de E/S, los módulos DCPM y el módulo LED USB. El resto de componentes del sistema deben funcionar correctamente. 
---
= Sustituye el chasis de tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A900 cuando un fallo de hardware lo requiera. El proceso de sustitución consiste en quitar las fuentes de alimentación, los ventiladores, los módulos de controlador y los módulos de E/S del chasis averiado e instalarlos en el chasis de reemplazo.
