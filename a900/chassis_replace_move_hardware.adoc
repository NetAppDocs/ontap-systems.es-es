...
== Paso 7: Instale el módulo led USB en el chasis de reemplazo

Una vez instalado el chasis de repuesto en el rack o armario, instale el módulo LED USB desde la parte delantera del chasis dañado al chasis de repuesto.
...
|===
. Localice el módulo LED USB en la parte frontal del chasis deteriorado, directamente debajo de los módulos DCPM.
. Pulse el botón de bloqueo negro situado en el lado derecho del módulo para liberar el módulo del chasis y, a continuación, deslícelo fuera del chasis dañado.
. Alinee los bordes del módulo con el compartimento LED USB situado en la parte inferior frontal del chasis de repuesto y empuje suavemente el módulo hasta que encaje en su sitio.
...
Después de instalar el módulo del controlador y cualquier otro componente en el chasis de reemplazo, ejecútelo en un estado donde pueda ejecutar la prueba de diagnóstico de interconexión.
