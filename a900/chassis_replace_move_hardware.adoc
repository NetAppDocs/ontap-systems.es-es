...
[role="lead"]
Para sustituir el chasis, debe quitar los componentes del chasis antiguo e instalarlos en el chasis de reemplazo.
...
[role="lead"]
Para quitar las fuentes de alimentación cuando se reemplaza un chasis, se debe apagar, desconectar y luego quitar las cuatro fuentes de alimentación de la parte posterior del chasis antiguo.
...
+
image::../media/drw_a900_remove_install_PSU_module.png[drw a900 retire la instalación del módulo de la fuente de alimentación]
...
[role="lead"]
Para eliminar módulos de I/o del chasis antiguo, incluidos los módulos de NVRAM, siga la secuencia específica de pasos. No tiene que quitar el módulo Flash Cache, si está presente, del módulo NVRAM al moverlo a un nuevo chasis.
...
[role="lead"]
Quite los dos módulos de alimentación de la controladora de etapa de la parte frontal del chasis antiguo.
...
+
image::../media/drw_a900_remove_NV_battery.png[drw a900 retire la batería NV]
...
[role="lead"]
Una vez instalado el nuevo chasis en el rack o armario, mueva el módulo LED USB desde la parte frontal del chasis antiguo hasta el nuevo chasis.
...
|===
. Localice el módulo LED USB en la parte frontal del chasis antiguo, directamente bajo los módulos DCPM.
...
+
.. A medida que cada controlador inicia el arranque, pulse `Ctrl-C` Para interrumpir el proceso de arranque cuando aparezca el mensaje Pulse Ctrl-C para Boot Menu (Menú de inicio).
+
...
+
Responda `y` Cuando ve el símbolo del sistema de para arrancar en modo de mantenimiento
