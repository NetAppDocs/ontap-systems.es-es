...
---
= Apaga el controlador defectuoso de tu sistema AFF A900 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento AFF A900 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el controlador.
