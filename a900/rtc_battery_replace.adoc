...
---
= Cambia la batería del reloj en tiempo real de tu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A900 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
...
+
image::../media/drw_a900_remove_RTC_battery.svg[Retire e instale la batería del RTC]
