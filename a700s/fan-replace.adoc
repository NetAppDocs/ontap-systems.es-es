...
---
= Sustituye un ventilador en tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un ventilador del sistema AFF A700s retirando el módulo del ventilador con error e instalando el de repuesto.
