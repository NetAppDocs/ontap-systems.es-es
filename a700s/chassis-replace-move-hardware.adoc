...
---
= Sustituye el chasis de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza el chasis de tu sistema AFF A700s moviendo las fuentes de alimentación, las unidades de disco duro y los módulos de controlador del chasis con problemas al chasis de reemplazo.
...
Después de instalar el módulo del controlador en el nuevo chasis, arranque.
