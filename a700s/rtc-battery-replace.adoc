...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador AFF A700s para garantizar que los servicios y aplicaciones que dependen de una sincronización del tiempo precisa sigan funcionando. 
---
= Sustituir la batería del reloj en tiempo real en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A700s para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
