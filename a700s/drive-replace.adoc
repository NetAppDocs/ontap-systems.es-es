...
---
= Intercambia en caliente una unidad en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad con error en tu sistema AFF A700s sin interrumpir las operaciones de E/S.
