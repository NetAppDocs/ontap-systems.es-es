...
---
= Vuelve a cablear el sistema y reasigna los discos en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa el reemplazo de la controladora de tu sistema AFF A700s volviendo a cablear el almacenamiento, restaurando la configuración de NetApp Storage Encryption (si es necesario) e instalando las licencias para la nueva controladora.
