...
summary: Cambia una fuente de alimentación en tu sistema AFF A700s desconectando la PSU objetivo de la fuente de energía, desenchufando el cable de alimentación, quitando la PSU antigua, instalando la PSU de reemplazo y luego volviéndola a conectar a la fuente de energía. 
---
= Intercambia en caliente una fuente de alimentación en tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente una fuente de alimentación en tu sistema AFF A700s desconectando, retirando y reemplazando la unidad con error, y luego vuelve a conectarla a la fuente de alimentación.
