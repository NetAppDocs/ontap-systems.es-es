...
---
= Sustituye el módulo NVRAM y los módulos DIMM de NVRAM de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo NVRAM y los módulos DIMM de NVRAM de tu sistema AFF A700s quitando el riser de NVRAM, reemplazando la tarjeta con error y volviendo a instalar el riser.
