...
---
= Sustituir una tarjeta PCIe en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta PCIe en tu sistema AFF A700s desconectando los cables, retirando el riser, cambiando la tarjeta y volviendo a conectar los cables.
