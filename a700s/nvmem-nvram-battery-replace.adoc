...
---
= Sustituir la batería de la NVRAM en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza la batería de la NVRAM en tu sistema AFF A700s quitando el módulo del controlador, cambiando la batería y volviendo a instalar el módulo del controlador.
