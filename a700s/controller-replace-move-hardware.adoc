...
---
= Sustituye el controlador de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A700s retirando el controlador con error, moviendo los componentes FRU al módulo de reemplazo, instalándolo en el chasis e iniciando en modo de mantenimiento.
