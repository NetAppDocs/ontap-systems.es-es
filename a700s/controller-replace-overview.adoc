...
---
= Revisa los requisitos antes de sustituir el controlador de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF A700s, revisa los requisitos previos para el procedimiento de sustitución y selecciona el correcto para tu versión de ONTAP.
