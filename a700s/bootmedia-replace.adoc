...
summary: Reemplace el medio de arranque fallido en un módulo controlador AFF A700s . El sistema AFF A700s solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Sustituye el soporte de arranque de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el medio de arranque fallido en un módulo controlador AFF A700s . Este procedimiento incluye quitar el módulo del controlador del chasis, localizar el medio de arranque defectuoso usando el indicador LED encendido, reemplazar físicamente el componente del medio de arranque y restaurar el sistema a su funcionamiento normal.
