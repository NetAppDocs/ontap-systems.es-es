...
[role="lead"]
Transfiera la imagen de arranque al medio de arranque de reemplazo en un sistema AFF A700s utilizando el medio de arranque secundario o una unidad flash USB. Este procedimiento incluye la restauración desde la imagen en el medio de arranque secundario como método principal o el uso de una unidad flash USB si la restauración del medio de arranque secundario falla o falta el archivo image.tgz.
...
== Opción 1: Transferir archivos mediante la recuperación de respaldo desde el segundo medio de arranque
