...
---
= Completa la sustitución del chasis de un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de tu sistema AFF A700s comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente con error a NetApp.
