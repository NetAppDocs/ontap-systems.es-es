...
summary: Arranque la imagen de recuperación de ONTAP desde la unidad USB en un sistema AFF A700s para restaurar el medio de arranque. El sistema AFF A700s solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Arranca la imagen de recuperación en tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
