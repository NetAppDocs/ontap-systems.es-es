...
summary: Sustituye un módulo DIMM en tu módulo controlador AFF A700s cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituir un módulo DIMM en un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema AFF A700s cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC no corregible, que normalmente es causado por una falla en un solo DIMM.
