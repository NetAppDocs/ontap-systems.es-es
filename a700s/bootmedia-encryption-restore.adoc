...
summary: Restaurar la configuración de cifrado en el medio de arranque de reemplazo para un sistema AFF A700s . El sistema AFF A700s solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurar la configuración de cifrado en el medio de arranque de reemplazo para un sistema AFF A700s . Este procedimiento incluye completar los pasos posteriores al reemplazo para sistemas con Onboard Key Manager (OKM), NetApp Storage Encryption (NSE) o NetApp Volume Encryption (NVE) habilitados para garantizar el acceso seguro a los datos y el funcionamiento adecuado del sistema.
