...
---
= Apaga el controlador defectuoso de tu sistema AFF A700s antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A700s antes de sustituirlo, tomándolo y deteniéndolo en el prompt LOADER.
