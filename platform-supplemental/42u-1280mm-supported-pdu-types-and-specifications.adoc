...
summary: El armario del sistema admite distintos tipos de unidades de distribución de alimentación. Las PDU cumplen las normas NEMA o IEC. 
---
= Tipos de PDU compatibles y especificaciones para un armario de sistemas de hardware ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
