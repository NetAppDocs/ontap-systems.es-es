...
---
= Características del armario del sistema de hardware ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El armario del sistema de hardware ONTAP está compuesto por paneles laterales, puertas delantera y trasera, un kit opcional de fijación con pernos, un kit opcional de interconexión, PDU para tu equipo y un sistema integrado de gestión de cables.
