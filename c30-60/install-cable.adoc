...
summary: Después de instalar el hardware del sistema de almacenamiento AFF C30 o AFF C60, conecte los cables de las controladoras a la red y las bandejas. 
---
= Conecta tu hardware AFF C30 y AFF C60 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[diagrama de cableado de clúster sin switches c30 y c60 utilizando dos módulos io 100gbe]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[diagrama de cableado del clúster sin switches c30 y c60 usando un módulo io 100gbe]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[diagrama de cableado del clúster conmutado c30 y c60 usando dos módulos io 100gbe]
