...
summary: 'Reemplace la batería de reloj en tiempo real (RTC), comúnmente conocida como una batería de pila de moneda, en su sistema AFF C30 o AFF C60 para garantizar que los servicios y aplicaciones que dependen de la sincronización de tiempo precisa permanezcan operativos.' 
---
...
[role="lead"]
Reemplace la batería de reloj en tiempo real (RTC), comúnmente conocida como una batería de pila de moneda, en su sistema AFF C30 o AFF C60 para garantizar que los servicios y aplicaciones que dependen de la sincronización de tiempo precisa permanezcan operativos.
