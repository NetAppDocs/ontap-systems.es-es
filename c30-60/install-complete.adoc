...
summary: Después de activar el sistema de almacenamiento AFF C30 o AFF C60, estará listo para detectar su red de clúster y configurar un clúster de ONTAP. 
---
= Instalación y configuración completas del sistema de almacenamiento: AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de activar el sistema de almacenamiento AFF C30 o AFF C60, estará listo para detectar su red de clúster y configurar un clúster de ONTAP.
