...
summary: Reemplace el chasis del sistema AFF C30 o AFF C60 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar la controladora y las unidades de fuente de alimentación, quitar las unidades del chasis dañado, instalar el chasis de reemplazo y reinstalar los componentes del chasis. 
---
...
[role="lead"]
Reemplace el chasis del sistema AFF C30 o AFF C60 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar la controladora y las unidades de fuente de alimentación (PSU), retirar las unidades del chasis dañado, instalar el chasis de reemplazo y reinstalar los componentes del chasis.

Mueva las unidades, los espacios vacíos de unidades, las controladoras y el bisel del chasis dañado al chasis de reemplazo (del mismo modelo) y, a continuación, sustituya el chasis deficiente dentro del rack de equipo o armario del sistema.
...
.El futuro
Después de reemplazar el chasis AFF C30 o AFF C60 dañado y volver a instalar los componentes en él, debe link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"].
