...
summary: Antes de sustituir el chasis de tu sistema de almacenamiento AFF C30 o AFF C60, asegúrate de cumplir con los requisitos necesarios para que el reemplazo sea exitoso. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente y que tengas el chasis de reemplazo adecuado y las herramientas necesarias. 
---
= Revisa los requisitos antes de sustituir el chasis en un sistema AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis de tu sistema de almacenamiento AFF C30 o AFF C60, asegúrate de cumplir con los requisitos necesarios para que el reemplazo sea exitoso. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente y que tengas el chasis de reemplazo adecuado y las herramientas necesarias.
