...
---
= Mantener el hardware de AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para los sistemas de almacenamiento AFF C30 o AFF C60, se pueden realizar procedimientos de mantenimiento en los siguientes componentes.
