...
summary: Agregue un módulo de E/S a su sistema AFF C30 o AFF C60 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos. 
---
...
[role="lead"]
Agregue un módulo de E/S a su sistema AFF C30 o AFF C60 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.
