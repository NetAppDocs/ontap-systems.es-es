...
summary: Después de conectar las controladoras a la red y las bandejas del sistema de almacenamiento AFF C30 o AFF C60, encienda las bandejas y las controladoras. 
---
= Enciende tu sistema de almacenamiento AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
