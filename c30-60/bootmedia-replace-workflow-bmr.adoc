...
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema AFF C30 o AFF C60 mediante el proceso de recuperación de arranque automatizado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Retira el soporte de arranque defectuoso del módulo controlador e instala el soporte de arranque de repuesto.
