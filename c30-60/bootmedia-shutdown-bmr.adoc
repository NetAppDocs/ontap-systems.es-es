...
summary: Apaga el controlador de tu sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del soporte de arranque. 
---
= Apaga el controlador de tu sistema de almacenamiento AFF C30 o AFF C60 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del soporte de arranque.
