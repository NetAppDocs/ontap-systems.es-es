...
summary: Apague el controlador dañado en su sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación automática del medio de arranque. 
---
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación automática del medio de arranque.
