...
[role="lead"]
Para restaurar el sistema de almacenamiento a un funcionamiento completo, debe verificar los LIF, comprobar el estado del clúster y devolver la parte con error a NetApp.
