...
---
= Especificaciones clave para un sistema AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones del sistema de almacenamiento AFF C60 en una configuración de un solo par de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para consultar las especificaciones completas de este sistema de almacenamiento.
