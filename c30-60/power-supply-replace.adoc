...
summary: Reemplace una fuente de alimentación de CA o CC en su sistema AFF C30 o AFF C60 cuando falla o falla, asegurándose de que su sistema continúa recibiendo la alimentación necesaria para un funcionamiento estable. 
---
