...
summary: Reemplace un módulo de ventilador en su sistema de almacenamiento AFF C30 o AFF C60 cuando un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.  El proceso de reemplazo implica apagar el controlador, quitarlo, reemplazar el ventilador, reinstalar el controlador y devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo de ventilador en tu sistema de almacenamiento AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de ventilador en su sistema de almacenamiento AFF C30 o AFF C60 cuando un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.  El proceso de reemplazo implica apagar el controlador, quitarlo, reemplazar el ventilador, reinstalar el controlador y devolver la pieza defectuosa a NetApp.
