...
[role="lead"]
Para instalar y configurar el sistema de almacenamiento AFF C30 o AFF C60, debe revisar los requisitos y consideraciones de instalación, preparar el sitio, instalar y cablear los componentes de hardware, encender el sistema de almacenamiento y configurar el clúster ONTAP.
