...
[role="quick-margin-para"]
Al sustituir la controladora, se incluye retirar la controladora deteriorada, mover los componentes FRU a la controladora de reemplazo y luego instalar la controladora de reemplazo en el compartimento.
