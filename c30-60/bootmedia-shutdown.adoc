...
summary: Apague el controlador dañado en su sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación del medio de arranque manual. 
---
= Apaga el controlador en tu sistema de almacenamiento AFF C30 o AFF C60 durante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación del medio de arranque manual.
