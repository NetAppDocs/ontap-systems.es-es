...
---
= Apague el controlador defectuoso: AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague la controladora deteriorada en su sistema de almacenamiento AFF C30 o AFF C60 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir los medios de arranque.
