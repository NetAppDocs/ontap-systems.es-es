...
summary: Reemplace un módulo de E/S en su sistema de almacenamiento AFF C30 o AFF C60 cuando el módulo falla o requiere una actualización para soportar un mayor rendimiento o funciones adicionales. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de E/S defectuoso, reiniciar la controladora y devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo de E/S en tu sistema de almacenamiento AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de E/S en su sistema de almacenamiento AFF C30 o AFF C60 cuando el módulo falla o requiere una actualización para soportar un mayor rendimiento o funciones adicionales. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de E/S defectuoso, reiniciar la controladora y devolver la pieza defectuosa a NetApp.
...
== Paso 1: Apaga el controlador con el módulo de E/S averiado

Apaga o toma el control del controlador con el módulo de E/S defectuoso usando una de las siguientes opciones.
