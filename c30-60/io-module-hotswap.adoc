...
---
= Sustituye en caliente un módulo de E/S en tu sistema de almacenamiento AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** El _controlador con el módulo de E/S defectuoso_ es el controlador en el que estás realizando el intercambio en caliente del módulo de E/S.
** El «controlador en buen estado» es el socio de alta disponibilidad (HA) del controlador cuyo módulo de E/S presenta un fallo.
...
== Paso 1: Comprueba que el sistema de almacenamiento cumple los requisitos del procedimiento
