...
summary: Para garantizar la seguridad de los datos en su sistema de almacenamiento AFF C30 o AFF C60, debe verificar la compatibilidad y el estado de la clave de cifrado en su medio de arranque. Compruebe si su versión de ONTAP es compatible con NetApp Volume Encryption y, antes de apagar la controladora, compruebe si el administrador de claves está activo. 
---
= Comprueba la compatibilidad con cifrado en el soporte de arranque de tu sistema de almacenamiento AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en tu sistema de almacenamiento AFF C30 o AFF C60, necesitas verificar la compatibilidad y el estado de la clave de cifrado en tu medio de arranque. Verifica si tu versión de ONTAP es compatible con NetApp Volume Encryption (NVE). Antes de apagar el controlador, revisa si el gestor de claves está activo.
...
Antes de apagar el controlador con el soporte de arranque dañado, verifica la configuración del gestor de claves y haz una copia de seguridad de la información necesaria.
