...
summary: Antes de sustituir el controlador en tu sistema de almacenamiento AFF C30 o AFF C60, confirma que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionan correctamente, comprobar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto. 
---
= Revisa los requisitos antes de reemplazar el controlador en tu sistema de almacenamiento AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador en tu sistema de almacenamiento AFF C30 o AFF C60, confirma que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionan correctamente, comprobar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto.
