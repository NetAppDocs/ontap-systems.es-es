...
summary: Revisa los requisitos para instalar tu sistema de almacenamiento AFF C30 o AFF C60, incluyendo el equipo necesario, las precauciones de elevación y las especificaciones del emplazamiento, para que tu instalación se desarrolle sin problemas. 
---
= Revisa los requisitos para instalar tu sistema de almacenamiento AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Revisa los requisitos para instalar tu sistema de almacenamiento AFF C30 o AFF C60, incluyendo el equipo necesario, las precauciones de elevación y las especificaciones del emplazamiento, para que tu instalación se desarrolle sin problemas.
