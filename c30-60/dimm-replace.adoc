...
summary: Reemplace un DIMM en su sistema de almacenamiento AFF C30 o AFF C60 si se detectan errores de memoria excesivos corregibles o incorregibles.  Estos errores pueden impedir que el sistema de almacenamiento inicie ONTAP.  El proceso de reemplazo implica apagar el controlador dañado, quitarlo, reemplazar el DIMM, reinstalar el controlador y luego devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo DIMM en tu sistema de almacenamiento AFF C30 o AFF C60 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un DIMM en su sistema de almacenamiento AFF C30 o AFF C60 si se detectan errores de memoria excesivos corregibles o incorregibles.  Estos errores pueden impedir que el sistema de almacenamiento inicie ONTAP.  El proceso de reemplazo implica apagar el controlador dañado, quitarlo, reemplazar el DIMM, reinstalar el controlador y luego devolver la pieza defectuosa a NetApp.

.Antes de empezar
* El resto de componentes del sistema de almacenamiento deben funcionar correctamente. Si no es así, ponte en contacto con https://mysupport.netapp.com/site/global/dashboard["Soporte de NetApp"] antes de continuar.
...
Para sustituir un módulo DIMM, localiza el módulo DIMM defectuoso dentro del controlador.
