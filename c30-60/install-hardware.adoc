...
summary: Después de preparar la instalación del sistema de almacenamiento AFF C30 o AFF C60, instale el hardware del sistema de almacenamiento. En primer lugar, instale los kits de guías. A continuación, instale y proteja su sistema de almacenamiento en un armario o rack de telecomunicaciones. 
---
= Instala tu hardware AFF C30 y AFF C60 en un armario o rack
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
