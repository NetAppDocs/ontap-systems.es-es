...
summary: 'Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema de almacenamiento AFF C30 o AFF C60 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema (sin cifrado, cifrado OKM del Administrador de claves integrado o cifrado EKM del Administrador de claves externo).' 
---
= Devuelve el controlador en tu sistema de almacenamiento AFF C30 o AFF C60 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema de almacenamiento AFF C30 o AFF C60 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado, cifrado mediante el Administrador de claves integrado (OKM) o cifrado mediante el Administrador de claves externo (EKM).
