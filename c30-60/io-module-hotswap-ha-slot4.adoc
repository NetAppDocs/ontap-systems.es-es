...
summary: 'El módulo de E/S de clúster y alta disponibilidad (HA) admite interconexiones para agrupamiento en clústeres y alta disponibilidad. Puede intercambiar el módulo en caliente en su sistema de almacenamiento AFF C30 o AFF C60 cuando falle y si su sistema de almacenamiento cumple con los requisitos específicos.' 
---
= Intercambio en caliente del módulo de E/S utilizado para el tráfico de clúster y HA: AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El módulo de E/S de clúster y alta disponibilidad (HA) admite interconexiones para agrupamiento en clústeres y alta disponibilidad. Puede intercambiar el módulo en caliente en su sistema de almacenamiento AFF C30 o AFF C60 cuando falle y si su sistema de almacenamiento cumple con los requisitos específicos.
