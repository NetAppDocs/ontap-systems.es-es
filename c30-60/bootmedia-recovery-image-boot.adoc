...
summary: Después de instalar el nuevo dispositivo multimedia de arranque en el sistema AFF C80, puede iniciar la imagen de recuperación desde una unidad USB y restaurar la configuración desde el nodo asociado. 
---
...
[role="lead"]
Después de instalar el nuevo dispositivo multimedia de arranque en el sistema AFF C80, puede iniciar la imagen de recuperación desde una unidad USB y restaurar la configuración desde el nodo asociado.
