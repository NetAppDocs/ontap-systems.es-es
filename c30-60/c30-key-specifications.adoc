...
---
= Especificaciones clave para un sistema AFF C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones del sistema de almacenamiento AFF C30 en un único par de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para consultar las especificaciones completas de este sistema de almacenamiento.
