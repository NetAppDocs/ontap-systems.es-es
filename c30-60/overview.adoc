...
summary: Especificaciones clave de los sistemas de almacenamiento AFF C30 y AFF C60 en un único par de alta disponibilidad 
---
= Especificaciones clave de AFF C30 y AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones de los sistemas de almacenamiento AFF C30 y AFF C60 en un único par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] para consultar las especificaciones completas de estos sistemas de almacenamiento.
