...
summary: La recuperación manual de la imagen de arranque implica el uso de una unidad USB para reinstalar ONTAP en el medio de arranque de reemplazo del sistema de almacenamiento AFF C30 o AFF C60. Debe descargar la imagen de recuperación de ONTAP correspondiente del sitio web de soporte de NetApp y copiarla a una unidad USB. Esta unidad USB preparada se utiliza para realizar la recuperación y restaurar el sistema a su estado operativo. 
---
= Flujo de trabajo de sustitución de medios de arranque para un sistema AFF C30 o AFF C60 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Retira el soporte de arranque defectuoso del controlador e instala el soporte de arranque de repuesto y luego transfiere una imagen de ONTAP usando una memoria USB.
