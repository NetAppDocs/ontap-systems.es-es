...
summary: Después de instalar el nuevo dispositivo de medio de arranque en su sistema de almacenamiento AFF C30 y AFF C80, puede iniciar el proceso de recuperación automática del medio de arranque para restaurar la configuración desde el nodo asociado. 
---
= Recuperación automatizada de medios de arranque desde el nodo asociado: AFF C30 y AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
