...
summary: Devuelva el control de los recursos de almacenamiento a la controladora de reemplazo para que su sistema FAS70 o FAS90 pueda reanudar el funcionamiento normal. 
---
= Devuelve el controlador en un sistema FAS70 o FAS90 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelva el control de los recursos de almacenamiento a la controladora de reemplazo para que su sistema FAS70 o FAS90 pueda reanudar el funcionamiento normal. El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado o cifrado mediante Onboard Key Manager (OKM).
...
. Muestra la información de la copia de seguridad de la gestión de claves del clúster.
+
.. Ejecuta el siguiente comando para mostrar la información de la copia de seguridad de la gestión de claves del clúster:
+
`security key-manager onboard show-backup`

.. Ejecuta el siguiente comando para comprobar la copia de seguridad del gestor de claves integrado:
+
`security key-manager onboard verify-backup`



. Introduce la frase de contraseña de OKM y confirma la verificación exitosa.
+
