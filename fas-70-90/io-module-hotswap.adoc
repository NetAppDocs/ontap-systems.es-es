...
summary: Puedes realizar un intercambio en caliente de un módulo de E/S Ethernet en tu sistema de almacenamiento FAS70 o FAS90 si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Realiza un intercambio en caliente de un módulo de E/S en tu sistema FAS70 o FAS90 sin necesidad de apagarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes realizar un intercambio en caliente de un módulo de E/S Ethernet en tu sistema de almacenamiento FAS70 o FAS90 si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
...
* Asegúrate de aplicar los comandos al controlador y a la ranura de E/S correctos durante el intercambio en caliente:
+
...
== Paso 3: reemplaza el módulo de E/S averiado

Realiza un intercambio en caliente del módulo de E/S averiado por un módulo de E/S equivalente.
