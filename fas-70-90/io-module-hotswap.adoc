...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento FAS 70 o FAS 90 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Intercambia en caliente un módulo de E/S - FAS 70 y FAS 90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento FAS 70 o FAS 90 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
