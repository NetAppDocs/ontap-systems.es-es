...
---
= Revisa los requisitos para instalar un sistema de almacenamiento FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Una estantería DS460C puede pesar hasta 260,4 libras (118,1 kg). Para levantar la estantería, podrías necesitar hasta cinco personas o un elevador hidráulico. Mantén todos los componentes en la estantería (tanto en la parte delantera como en la trasera) para evitar que el peso de la estantería quede desequilibrado.
