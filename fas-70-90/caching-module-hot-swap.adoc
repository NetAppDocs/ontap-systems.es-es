...
---
= Sustituye el soporte del módulo de Flash Cache o el módulo de caché en un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Antes de empezar
* Comprueba que tu sistema de almacenamiento tenga el sistema operativo adecuado para el soporte del módulo Flash Cache de recambio.
* Comprueba que el resto de componentes funcionen correctamente. Si no es así, ponte en contacto con soporte técnico.
...
.Antes de empezar
* Comprueba que el módulo de almacenamiento en caché de recambio tenga la misma capacidad que el que ha fallado, ya sea del mismo fabricante o de otro fabricante compatible.
* Comprueba que el resto de componentes funcionen correctamente. Si no es así, ponte en contacto con soporte técnico.
...
.. Extrae el módulo de caché de la carcasa introduciendo el dedo en la abertura de la palanca de leva y tirando del módulo para sacarlo del soporte del módulo Flash Cache.
+
...
+
Asegúrate de que el resultado del comando muestre el estado como  `powered-on` y que esté listo para funcionar.
