...
---
= Flujo de trabajo de instalación y configuración de FAS70 y FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Revisa el equipo y las herramientas necesarias para instalar tu sistema de almacenamiento y las estanterías de almacenamiento. Revisa también las precauciones de seguridad y de elevación.
...
[role="quick-margin-para"]
Para preparar la instalación de tu sistema, debes acondicionar el emplazamiento, comprobar los requisitos ambientales y eléctricos, y verificar que haya suficiente espacio en rack. Luego, desembala el equipo, compara su contenido con el albarán de entrega y registra el hardware para acceder a los beneficios de soporte.
...
[role="quick-margin-para"]
Antes de encender los controladores, enciende cada shelf NS224 y asígnale un ID de shelf único para que cada shelf quede identificado de forma exclusiva. Luego, conecta el laptop o la consola al controlador y conecta los controladores a las fuentes de alimentación.
