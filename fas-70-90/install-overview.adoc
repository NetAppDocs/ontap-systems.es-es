...
[role="quick-margin-para"]
Antes de encender las controladoras, encienda cada bandeja y asigne un ID de bandeja único para comprobar que cada bandeja se identifique de forma única dentro de la configuración.
