...
summary: Sustituya un módulo de ventilador en el sistema FAS70 o FAS90 si un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp. 
---
= Sustituir un módulo de ventilador en un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya un módulo de ventilador en el sistema FAS70 o FAS90 si un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
