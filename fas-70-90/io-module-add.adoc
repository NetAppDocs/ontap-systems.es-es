...
summary: Agregue un módulo de E/S al sistema yourFAS70 y FAS90 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos. 
---
