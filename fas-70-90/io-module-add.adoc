...
summary: Agrega un módulo de I/O a tu sistema FAS70 o FAS90 para mejorar la conectividad de red y ampliar la capacidad de tu sistema para manejar el tráfico de datos. 
---
= Agrega un módulo de I/O a un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agrega un módulo de I/O a tu sistema FAS70 o FAS90 para mejorar la conectividad de red y ampliar la capacidad de tu sistema para manejar el tráfico de datos.

Puedes añadir un módulo de E/S a tu sistema de almacenamiento FAS70 o FAS90 cuando hay ranuras libres disponibles o cuando todas las ranuras están completamente ocupadas.
