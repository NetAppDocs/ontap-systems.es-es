...
summary: Agrega un módulo IO a tu sistema FAS70 y FAS90 para mejorar la conectividad de red y ampliar la capacidad de tu sistema para manejar el tráfico de datos. 
---
= Agregue un módulo de E/S: FAS70 y FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agregue un módulo de E/S al sistema yourFAS70 y FAS90 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Puede añadir un módulo de I/O al sistema de almacenamiento FAS70 y FAS90 cuando haya ranuras vacías disponibles o cuando todas estén completamente ocupadas.
