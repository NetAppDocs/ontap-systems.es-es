...
summary: Sustituye una fuente de alimentación de CA o CC PSU en tu sistema FAS70 o FAS90 cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. El proceso de sustitución implica desconectar la PSU averiada de la fuente de alimentación, desenchufar el cable de alimentación, reemplazar la PSU averiada y luego volver a conectarla a la fuente de alimentación. 
---
= Intercambia en caliente una fuente de alimentación en tu sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Este procedimiento está escrito para reemplazar una PSU a la vez. Usa el procedimiento apropiado para tu tipo de PSU: CA o CC.
