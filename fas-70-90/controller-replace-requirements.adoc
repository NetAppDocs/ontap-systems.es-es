...
summary: Antes de sustituir el controlador en tu sistema FAS70 o FAS90, confirma que cumples los requisitos necesarios para una sustitución exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionan correctamente, comprobar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto. 
---
= Revisa los requisitos antes de sustituir el controlador en un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador en tu sistema FAS70 o FAS90, confirma que cumples los requisitos necesarios para una sustitución exitosa. Esto incluye verificar que todos los demás componentes del sistema funcionan correctamente, comprobar que tienes el controlador de reemplazo correcto y guardar la salida de la consola del controlador en un archivo de registro de texto.
...
.El futuro
Después de haber revisado los requisitos para reemplazar su controlador FAS70 o FAS90, es necesario link:controller-replace-shutdown.html["apague el controlador defectuoso"].
