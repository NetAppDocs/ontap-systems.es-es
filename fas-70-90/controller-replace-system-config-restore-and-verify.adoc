...
. Arranque en modo de mantenimiento en el módulo de controladora de reemplazo y verifique que todos los componentes muestran el mismo `HA` estado: `ha-config show`
+
