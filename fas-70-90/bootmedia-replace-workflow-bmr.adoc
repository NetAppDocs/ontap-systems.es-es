...
summary: La recuperación automática de la imagen de arranque consiste en que el sistema identifique y seleccione automáticamente la opción adecuada del menú de arranque. Utiliza la imagen de arranque del nodo asociado para reinstalar ONTAP en el soporte de arranque de sustitución en tu sistema de almacenamiento FAS70 o FAS90. 
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema FAS70 o FAS90 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
