...
summary: Reemplace un DIMM en su sistema FAS70 o FAS90 si se detectan errores de memoria que no se pueden corregir o corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp. 
---
= Sustituye un módulo DIMM en tu sistema FAS70 o FAS90 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un DIMM en su sistema FAS70 o FAS90 si se detectan errores de memoria que no se pueden corregir o corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp.
...
+
Las ubicaciones de los DIMM dependen del modelo del sistema:
...
| FAS70 | Ranuras 3, 10, 19, 26 


| FAS90 | Ranuras 3, 7, 10, 14, 19, 23, 26, 30 
|===
