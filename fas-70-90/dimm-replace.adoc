...
summary: Sustituye el DIMM de tu sistema FAS70 o FAS90 si se detectan errores de memoria excesivos, ya sean corregibles o incorregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución consiste en apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo DIMM en un sistema FAS70 o FAS90 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM de tu sistema FAS70 o FAS90 si se detectan errores de memoria excesivos, ya sean corregibles o incorregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución consiste en apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp.
