...
summary: Apaga el controlador de tu sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el soporte de arranque. 
---
= Apaga el controlador en un sistema FAS70 o FAS90 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automatizado de recuperación del medio de arranque.
