...
summary: Apague la controladora deteriorada en su sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el soporte de arranque. 
---
= Apaga el controlador defectuoso de tu sistema FAS70 o FAS90 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del medio de arranque.
