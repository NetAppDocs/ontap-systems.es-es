...
Para sustituir el módulo de gestión del sistema o el soporte de arranque, debe apagar la controladora dañada.
...
. Vuelva a conectar los cables de alimentación en la PSU.
+
