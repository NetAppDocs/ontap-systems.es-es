...
summary: Debe sustituir el módulo de gestión del sistema. 
---
...
Para sustituir el módulo de gestión del sistema o el soporte de arranque, debe apagar el controlador defectuoso.
