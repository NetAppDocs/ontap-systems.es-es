...
summary: Reemplace el módulo de gestión del sistema en su sistema FAS70 o FAS90 cuando se produzca un defecto o su firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp. 
---
= Sustituye el módulo de administración de sistemas en un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el módulo de gestión del sistema en su sistema FAS70 o FAS90 cuando se produzca un defecto o su firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp.
