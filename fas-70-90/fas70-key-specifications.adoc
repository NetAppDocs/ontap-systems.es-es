...
---
= Especificaciones clave para un sistema FAS70
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones seleccionadas del sistema de almacenamiento FAS70 en una configuración de un único par de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para consultar las especificaciones completas de este sistema de almacenamiento.
