...
---
= Conecta el hardware FAS70 o FAS90 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Acerca de esta tarea
Los sistemas de almacenamiento FAS70 y FAS90 son compatibles con los estantes DS212C, DS224C, DS460C y NS224, tanto con el módulo NSM100 como con el NSM100B.
