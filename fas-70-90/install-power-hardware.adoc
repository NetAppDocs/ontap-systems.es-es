...
---
= Encender un sistema de almacenamiento FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el hardware de montaje en rack de tu sistema de almacenamiento FAS70 o FAS90 y de instalar los cables de los controladores y los estantes de almacenamiento, debes encender tus estantes de almacenamiento y los controladores.
...
+
image::../media/drw_a1k_70-90_power_source_icon_ieops-1700.svg[Diagrama de conexión de alimentación de AFF A1K AFF A70 o AFF A90 o FAS70 o FAS90]
...
.El futuro
Después de haber encendido su sistema de almacenamiento FAS70 o FAS90, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura tu cluster"] .
