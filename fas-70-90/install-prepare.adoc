...
---
= Prepárate para instalar un sistema de almacenamiento FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de que hayas preparado todo para instalar tu hardware FAS70 o FAS90, link:install-hardware.html["Instale el hardware del sistema de almacenamiento FAS70 o FAS90"].
