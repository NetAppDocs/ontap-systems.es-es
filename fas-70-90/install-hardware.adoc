...
+
.El futuro
Después de haber instalado el hardware para su sistema de almacenamiento FAS70 o FAS90, usted link:install-cable.html["Conecte el hardware del sistema de almacenamiento FAS70 o FAS90."].
