...
summary: Apaga el controlador de tu sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque. 
---
= Apaga el controlador de tu sistema FAS70 o FAS90 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS70 o FAS90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque.
