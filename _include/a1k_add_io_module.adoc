...
. Desconecte los cables de las fuentes de alimentación (PSU) del controlador.
+

NOTE: Si el sistema de almacenamiento tiene PSU de CC, desconecte el bloque de cables de alimentación de la PSU.
...
. Si instaló un módulo de I/O de almacenamiento, instale las bandejas NS224 y conecte los cables de las mismas, tal como se describe en https://docs.netapp.com/us-en/ontap-systems/ns224/hot-add-shelf.html["Añada una bandeja en caliente"^].
...
. Si usted no está ya conectado a tierra, correctamente tierra usted mismo.
. Desconecte los cables PSU de las PSU de la controladora.
+
