...
https://hwu.netapp.com/adapter/index["X91122A"]
 a| 
RoCE QSFP28 de 25 GbE de 2 puertos
 a| 
* Redes
* HA/MetroCluster
...
https://hwu.netapp.com/Switch/Index["Conmutador Broadcom BES-53248 (X190005 y X190005R)"]
 a| 
Compatibilidad del conmutador de interconexión de clúster Broadcom BES-53248 para controladoras AFF/FAS con puertos 10/25 GbE.
 a| 
ONTAP 9.5P8
