...
---
= Sustituya la batería del reloj en tiempo real - FAS8300 y FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Paso 4: Vuelva a instalar el módulo del controlador y ajuste la fecha y hora después de sustituir la batería RTC
