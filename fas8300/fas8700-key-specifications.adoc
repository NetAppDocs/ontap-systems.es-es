...
---
= Especificaciones clave de un sistema FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta algunas especificaciones del sistema de almacenamiento FAS8700 en una configuración de par único de alta disponibilidad (HA) y visita NetApp Hardware Universe (HWU) para ver las especificaciones completas de este sistema.
