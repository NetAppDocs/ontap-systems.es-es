...
---
= Sustituye el soporte de arranque en un sistema FAS8300 o FAS8700 mediante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Antes de empezar
Aunque el contenido del soporte de arranque está cifrado, se recomienda borrar dicho contenido antes de sustituirlo. Para obtener más información, consulta la  https://mysupport.netapp.com/info/web/ECMP1132988.html["Declaración de volatilidad"] para tu sistema en el sitio de soporte de NetApp.


NOTE: Debe iniciar sesión en el sitio de soporte de NetApp para mostrar el _Statement of volatile_ de su sistema.

Puede utilizar la animación, ilustraciones o los pasos escritos siguientes para reemplazar el soporte de arranque.
