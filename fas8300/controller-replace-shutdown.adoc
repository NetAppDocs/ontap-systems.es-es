...
summary: Apaga el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el controlador. 
---
= Apaga el controlador defectuoso de tu sistema FAS8300 o FAS8700 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el controlador.
...
====
.El futuro
Después de apagar el controlador FAS8300 y FAS8700, necesitas link:controller-replace-move-hardware.html["sustituya el controlador"].
