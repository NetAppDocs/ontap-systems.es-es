...
summary: Después de instalar el nuevo dispositivo de arranque en tu sistema FAS8300 o FAS8700, puedes iniciar el proceso automático de recuperación del dispositivo de arranque para restaurar la configuración desde el nodo asociado. 
---
= Inicia la imagen de recuperación en un sistema FAS8300 o FAS8700 mediante el proceso de recuperación de arranque automático
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
