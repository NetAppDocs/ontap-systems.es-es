...
summary: Comienza a sustituir el soporte de arranque de tu sistema de almacenamiento FAS8300 o FAS8700 revisando los requisitos de sustitución, comprobando el estado del cifrado, apagando el controlador, sustituyendo el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando el funcionamiento del sistema. 
---
= Flujo de trabajo de sustitución de medios de arranque para un sistema FAS8300 o FAS8700 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
