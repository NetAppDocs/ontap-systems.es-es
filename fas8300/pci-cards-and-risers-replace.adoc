...
---
= Sustituye una tarjeta PCIe o mezzanine en tu sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Levanta el tubo de elevación en línea recta y colócalo a un lado sobre una superficie estable y plana.
...
. Instala la tarjeta PCIe de recambio en el riser alineando la tarjeta con el zócalo, presionando la tarjeta en el zócalo y luego cerrando el panel lateral del riser, si está presente.
+
...
== Paso 7: Restaure el módulo del controlador a la operación
