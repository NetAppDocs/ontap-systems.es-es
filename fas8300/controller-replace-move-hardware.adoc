...
summary: Sustituye el controlador de tu sistema FAS8300 o FAS8700 cuando un fallo de hardware lo requiera. Retira el controlador averiado, mueve sus componentes al controlador de reemplazo, instala el nuevo controlador y reinícialo. 
---
= Sustituye el controlador de tu sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema FAS8300 o FAS8700 cuando un fallo de hardware lo requiera. Retira el controlador averiado, mueve sus componentes al controlador de reemplazo, instala el nuevo controlador y reinícialo.


NOTE: El módulo controlador Ver2 solo cuenta con una ranura para módulos de caché (ranura 6) en el FAS8300. FAS8700 no tiene un módulo controlador Ver2. La funcionalidad del módulo de caché no se ve afectada por la eliminación de la ranura.
...
Mueve los elevadores PCIe y la tarjeta mezzanine al módulo controlador de sustitución.
...
== Paso 6: Mueve el módulo de caché

Mueve el módulo de caché al módulo controlador de reemplazo.
...
.El futuro
Una vez que hayas sustituido el controlador FAS8300 o FAS8700 dañado, necesitas link:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"].
