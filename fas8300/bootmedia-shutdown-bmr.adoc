...
summary: Apaga el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el boot media. 
---
= Apaga el controlador de tu sistema FAS8300 o FAS8700 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el boot media.
