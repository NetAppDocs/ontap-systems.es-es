...
---
= Apaga el controlador defectuoso de tu sistema FAS8300 o FAS8700 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar las tareas de NVE o NSE, apaga o toma el control del controlador afectado usando el procedimiento adecuado para tu configuración.
...
Una vez completadas las tareas de NVE o NSE, apaga el controlador averiado.
