...
---
= Sustituye el chasis en tu sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Si usted no está ya conectado a tierra, correctamente tierra usted mismo.
. Entre dos personas, instala el chasis de recambio en el bastidor de equipos o en el armario del sistema guiando el chasis sobre los rieles del bastidor dentro del armario del sistema o del bastidor de equipos.
...
En el caso de los pares de alta disponibilidad (HA) con dos módulos controladores en el mismo chasis, instala los módulos controladores en el orden correcto. Cada controlador intenta reiniciarse tan pronto como queda completamente encajado en el chasis.
