...
---
= Intercambia en caliente un módulo de ventilador en un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes realizar un intercambio en caliente de un módulo de ventilador en tu sistema FAS8300 o FAS8700 sin interrumpir el servicio. Para evitar el sobrecalentamiento, debes reemplazar el módulo de ventilador en un plazo de dos minutos después de haberlo extraído del chasis.
...
+
Usa el mensaje del BMC o el LED Attention para identificar el módulo de ventiladores que debes reemplazar. BMC asigna los módulos de ventiladores como Fan#_#, donde el primer número es la ranura y el segundo es la fila (1=superior, 2=inferior); por ejemplo, ranura 1, segunda fila = Fan1_2.
...
+
El LED de atención se apaga después de que el ventilador se asienta y gira hasta alcanzar la velocidad de funcionamiento.
