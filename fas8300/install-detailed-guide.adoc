...
---
= Instala un sistema FAS8300 o FAS8700 usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas instrucciones detalladas, paso a paso, te guían a lo largo del proceso de instalación de tu sistema FAS8300 o FAS8700, desde el montaje en rack y el cableado hasta la configuración inicial. Sigue estos pasos si quieres una guía de instalación más detallada que la que ofrecen los pasos rápidos.
...
image:../media/oie_cable_fiber_lc_connector.png["Conector de fibra LC"]
 a| 
Cables FC de 16 Gb o 25 GbE para tarjetas mezzanine (depende del pedido)
...
NOTE: Si las etiquetas de los puertos de la tarjeta no son visibles, comprueba la orientación de instalación de la tarjeta (el zócalo del conector PCIe se encuentra en el lado izquierdo de la ranura de la tarjeta en los modelos A400 y FAS8300/8700), y luego busca la tarjeta por número de pieza en el https://hwu.netapp.com["Hardware Universe de NetApp"^] para ver un gráfico del frontal que muestra las etiquetas de los puertos. El número de pieza de la tarjeta se puede encontrar usando el comando  `sysconfig -a` o en la lista de embalaje del sistema.
...
.. Selecciona *Red* en el panel izquierdo, haz clic con el botón derecho del ratón en *Red* y luego selecciona *Actualizar*.
.. Haga doble clic en el icono de ONTAP y acepte los certificados que aparecen en la pantalla.
+

NOTE: En este ejemplo, XXXXX representa el número de serie del sistema del nodo de destino.
