...
summary: 'Completa la sustitución del controlador para tu sistema FAS8300 y FAS8700. Instala las licencias para el controlador de sustitución, confirma que las interfaces lógicas (LIF) están reportando a sus puertos de origen y realiza una comprobación del estado del clúster. Por último, devuelve la pieza averiada a NetApp.' 
---
= Sustitución completa del controlador - FAS8300 y FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
