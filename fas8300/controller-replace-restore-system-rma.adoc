...
summary: 'Completa la sustitución del controlador de tu sistema FAS8300 o FAS8700. Instala las licencias para el controlador de sustitución, confirma que las interfaces lógicas (LIF) están reportando a sus puertos de origen y realiza una comprobación del estado del clúster. Por último, devuelve la pieza defectuosa a NetApp.' 
---
= Completa la sustitución del controlador en un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
