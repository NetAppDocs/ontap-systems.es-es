...
summary: Sustituye el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 apagando el controlador dañado, retirando y sustituyendo el controlador, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de sustitución. 
---
= Flujo de trabajo para la sustitución de los controladores FAS8300 y FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema de almacenamiento FAS8300 o FAS8700 apagando el controlador dañado, retirando y sustituyendo el controlador, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de sustitución.
