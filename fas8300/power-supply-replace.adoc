...
---
= Intercambia en caliente una fuente de alimentación en un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
La fuente de alimentación se acopla al conector interno y se bloquea en su sitio en una sola posición.
