...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS8300 o FAS8700 pueda reanudar su funcionamiento normal. 
---
= Vuelve a conectar el controlador en tu sistema FAS8300 o FAS8700 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS8300 o FAS8700 pueda reanudar su funcionamiento normal.
