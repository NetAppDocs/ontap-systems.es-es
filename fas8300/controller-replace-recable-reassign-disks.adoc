...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS8300 y FAS8700 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador - FAS8300 y FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS8300 y FAS8700 pueda reanudar su funcionamiento normal.
