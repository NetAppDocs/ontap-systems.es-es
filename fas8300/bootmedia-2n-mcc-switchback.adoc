...
summary: Después de haber completado el reemplazo de FRU en una configuración de dos nodos MetroCluster, puedes realizar la operación de conmutación MetroCluster. Esto devuelve la configuración a su estado operativo normal, con las máquinas virtuales de almacenamiento de fuente de sincronización en el sitio anteriormente dañado ahora activas y sirviendo datos de los grupos de discos locales. 
---
= Cambia los agregados en una configuración de clúster de dos nodos MetroCluster en un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
