...
summary: Debes sustituir el DIMM del controlador cuando tu sistema de almacenamiento detecta errores como un número excesivo de errores de memoria ECC corregibles o errores ECC no corregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en un sistema FAS8300 o FAS8700 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes sustituir el módulo DIMM del controlador cuando tu sistema de almacenamiento detecte errores como un número excesivo de errores de memoria ECC corregibles según las alertas del Health Monitor, o errores ECC no corregibles. Estos errores suelen deberse a un fallo en un único módulo DIMM que impide que el sistema de almacenamiento arranque ONTAP.
