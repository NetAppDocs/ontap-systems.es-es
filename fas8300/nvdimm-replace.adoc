...
---
= Sustituya un NVDIMM - FAS8300 y FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para sustituir el NVDIMM, debe localizarlo en el módulo de controlador mediante el mapa de FRU situado en la parte superior del conducto de aire Mapa de FRU en la parte superior del elevador de ranura 1.
