...
summary: Debes sustituir el módulo de almacenamiento en caché del módulo controlador cuando tu sistema registre un único mensaje AutoSupport que indique que el módulo se ha desconectado. 
---
= Sustituye el módulo de almacenamiento en caché de tu sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: El módulo controlador VER2 solo cuenta con un zócalo para módulos de caché en el FAS8300. FAS8700 no tiene un módulo controlador VER2. La funcionalidad del módulo de caché no se ve afectada por la eliminación del zócalo.
...
NOTE: La ranura 6 solo está disponible en el controlador FAS8300 VER2.
...
* Aunque el contenido del módulo de almacenamiento en caché está cifrado, se recomienda borrar dicho contenido antes de sustituirlo. Para obtener más información, consulta la  https://mysupport.netapp.com/info/web/ECMP1132988.html["Declaración de volatilidad"] para tu sistema en el sitio de soporte de NetApp.
+

NOTE: Debe iniciar sesión en el sitio de soporte de NetApp para mostrar el _Statement of volatile_ de su sistema.

* El resto de componentes del sistema de almacenamiento deben funcionar correctamente. Si no es así, ponte en contacto con soporte técnico.
...
. Localiza el módulo de almacenamiento en caché defectuoso usando el mapa de FRU en el módulo controlador y retíralo:
+
Dependiendo de tu configuración, puede haber cero, uno o dos módulos de almacenamiento en caché en el módulo controlador. Utiliza el mapa FRU dentro del módulo controlador para ayudarte a localizar el módulo de almacenamiento en caché.
...
== Paso 7: finaliza el proceso de sustitución
