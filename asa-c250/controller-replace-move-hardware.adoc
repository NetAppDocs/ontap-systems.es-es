...
---
= Sustituye el controlador de tu sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema ASA C250 cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar el controlador dañado, mover los componentes al controlador de sustitución, instalar el controlador de sustitución y reiniciarlo.
...
.El futuro
Después de que hayas sustituido el controlador ASA C250 deteriorado, necesitas link:controller-replace-system-config-restore-and-verify.html["restaurar y verificar la configuración del sistema"].
