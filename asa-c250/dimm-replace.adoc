...
summary: Sustituye un módulo DIMM en un sistema ASA C250 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico del sistema. 
---
= Sustituye un módulo DIMM en un sistema ASA C250 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en un sistema ASA C250 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico del sistema.
