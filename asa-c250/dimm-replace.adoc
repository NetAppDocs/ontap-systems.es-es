...
summary: Sustituye un DIMM en tu módulo controlador ASA C250 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituye un módulo DIMM en tu sistema ASA C250 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
