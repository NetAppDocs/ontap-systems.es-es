...
summary: Empieza a sustituir el soporte de arranque de tu sistema de almacenamiento ASA C250 revisando los requisitos de sustitución, comprobando el estado de cifrado, apagando el controlador, sustituyendo el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema ASA C250 mediante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
