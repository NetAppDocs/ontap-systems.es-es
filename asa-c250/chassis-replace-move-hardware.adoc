...
summary: Sustituye el chasis de tu sistema ASA C250 cuando un fallo de hardware lo requiera. El proceso de sustitución implica quitar los controladores y las fuentes de alimentación, quitar las unidades, instalar el chasis de reemplazo y volver a instalar los componentes del chasis. 
---
= Sustituye el chasis de tu sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema ASA C250 cuando lo requiera un fallo de hardware. El proceso de sustitución implica quitar los controladores y las fuentes de alimentación (PSUs), quitar las unidades, instalar el chasis de reemplazo y volver a instalar los componentes del chasis.
...
.El futuro
Una vez que hayas sustituido el chasis ASA C250 deteriorado y reinstalado los componentes, necesitas link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"]
