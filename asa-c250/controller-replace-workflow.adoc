...
summary: Empieza a reemplazar el controlador en tu sistema de almacenamiento ASA C250 apagando el controlador dañado, quitando y reemplazando el controlador, reconfigurando la configuración del sistema y verificando las operaciones del sistema. 
---
= Flujo de trabajo de reemplazo de controladores - ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema de almacenamiento ASA C250 apagando el controlador dañado, extrayendo y sustituyendo el controlador, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de sustitución.
