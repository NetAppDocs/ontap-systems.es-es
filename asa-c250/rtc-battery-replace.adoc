...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador ASA C250 para asegurarte de que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema ASA C250 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
