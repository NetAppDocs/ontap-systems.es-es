...
summary: Instala un sistema de almacenamiento ASA C250 usando instrucciones detalladas paso a paso que cubren el montaje en bastidor, el cableado y la puesta en marcha inicial del sistema. 
---
= Instala un sistema de almacenamiento ASA C250 siguiendo estos pasos detallados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala un sistema de almacenamiento ASA C250 usando instrucciones detalladas paso a paso que cubren el montaje en bastidor, el cableado y la puesta en marcha inicial del sistema.
