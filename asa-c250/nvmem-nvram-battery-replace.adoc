...
summary: Para sustituir una batería NVMEM en un sistema ASA C250, debes extraer el módulo controlador del sistema, abrirlo, reemplazar la batería, y cerrar y volver a colocar el módulo controlador. 
---
= Sustituye la batería del NVMEM en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para sustituir una batería NVMEM en un sistema ASA C250, debes extraer el módulo controlador del sistema, abrirlo, reemplazar la batería, y cerrar y volver a colocar el módulo controlador.
