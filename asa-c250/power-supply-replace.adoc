...
summary: Sustituye una fuente de alimentación en tu sistema ASA C250 desconectando la fuente de alimentación objetivo de la fuente de energía, desenchufando el cable de alimentación, retirando la unidad antigua, instalando la unidad de reemplazo y luego volviéndola a conectar a la fuente de energía. 
---
= Intercambia en caliente una fuente de alimentación en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
