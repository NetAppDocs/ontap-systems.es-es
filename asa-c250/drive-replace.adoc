...
summary: Sustituye una unidad de tu sistema ASA C250 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Además, se iluminan tanto el LED de fallo del panel de visualización del operador como el LED de fallo de la unidad con error. 
---
= Sustituir una unidad en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad en tu sistema ASA C250 cuando una unidad tenga un error. El proceso de sustitución consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema.
