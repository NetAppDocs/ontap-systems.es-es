...
summary: Realiza un intercambio en caliente de una unidad en tu sistema ASA C250 cuando la plataforma registre un mensaje de advertencia en la consola del sistema indicando que una unidad con error. Además, tanto el LED de fallo en el panel de visualización del operador como el LED de fallo en la unidad con error estarán encendidos. 
---
= Intercambia en caliente una unidad en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad en tu sistema ASA C250 cuando una unidad tenga un error. El proceso de sustitución consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema.
