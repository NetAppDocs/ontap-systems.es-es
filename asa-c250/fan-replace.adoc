...
summary: Sustituye un ventilador en un sistema ASA C250 quitando el módulo de ventilador averiado y reemplazándolo por uno nuevo. 
---
= Sustituir un ventilador en un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un ventilador en un sistema ASA C250 quitando el módulo de ventilador averiado y reemplazándolo por uno nuevo.
