...
---
= Vuelve a cablear el sistema y reasigna los discos en tu sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la restauración y verificar la configuración del sistema ASA C250, necesitas volver a cablear el sistema y reasignar los discos.
