...
summary: Si falla un módulo de ventilador en un shelf de unidades DS460C, debes reemplazarlo lo antes posible para asegurarte de que el shelf tenga una refrigeración adecuada. 
---
= Sustituye un módulo de ventilador del DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
