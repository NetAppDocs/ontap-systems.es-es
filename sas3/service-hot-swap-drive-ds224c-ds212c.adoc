...
---
= Realiza un intercambio en caliente de una unidad de disco en un shelf DS212C o DS224C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente una unidad con error en un bastidor de discos DS224C o DS212C con módulos IOM12, IOM12B o IOM12C.
