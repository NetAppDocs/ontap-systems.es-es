...
summary: Puedes quitar en caliente una bandeja de discos cuando necesites retirarla o reemplazarla de un sistema que está encendido y con operaciones de E/S en curso. 
---
= Quitar en caliente un shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes quitar en caliente una bandeja de discos cuando necesites retirarla o reemplazarla de un sistema que está encendido y con operaciones de E/S en curso. Puedes quitar en caliente una o más bandejas de discos desde cualquier lugar dentro de una pila de bandejas de discos, o quitar una pila completa de bandejas de discos.
...
.. Continúe hasta volver a habilitar la asignación automática si es necesario (varios pasos a continuación).
...
+
** Los módulos IOM12, IOM12B o IOM12C están dispuestos uno al lado del otro, como en una bahía de discos DS224C o DS212C; si tienes un DS460C, los módulos IOM12, IOM12B o IOM12C están dispuestos uno encima del otro.
...
Si trasladas un shelf DS460C a otra parte del centro de datos o transportas el shelf a otra ubicación, debes retirar las unidades de los cajones para evitar posibles daños tanto en los cajones como en las unidades.
