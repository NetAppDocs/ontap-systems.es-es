...
+
Este procedimiento no aborda la mezcla de una pila: Añadir en caliente una bandeja con módulos IOM12/IOM12B a una pila de bandejas con módulos IOM6.

* Un sistema puede tener pilas multivía y de cuatro rutas de bandejas de discos con módulos IOM12/IOM12B.
+
Si tiene una pareja de alta disponibilidad, ONTAP muestra la configuración del sistema como `multipath HA`. Si tiene una configuración de controladora única, ONTAP muestra la configuración del sistema como `multipath`.
...
Conecte los cables de las conexiones SAS, de bandeja a bandeja y de controladora a pila, según corresponda para las bandejas de discos con adición de activo, de modo que tengan conectividad con el sistema.
...
| Si... | Realice lo siguiente... 
 ...
 a| 
Está cablear una pila con alta disponibilidad multivía, alta disponibilidad multivía, ruta única o conectividad de ruta única a las controladoras
 a| 
...
. Si va a añadir en caliente una o varias bandejas de discos a un extremo, la primera o la última bandeja de discos lógica, complete los subpasos aplicables a su configuración; de lo contrario, vaya al paso siguiente.
+
...
| Si está... | Realice lo siguiente... 
 ...
 a| 
Añadir en caliente una bandeja de discos al final de una pila con alta disponibilidad multivía, multivía, alta disponibilidad de cuatro rutas o conectividad de cuatro rutas a las controladoras
 a| 
...
+
La pila debe cumplir los requisitos indicados en la <<Requisitos para añadir en caliente bandejas de discos con módulos IOM12>> sección de este procedimiento.
