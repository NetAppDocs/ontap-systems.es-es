...
summary: Puedes utilizar una hoja de trabajo de cableado para definir los pares de puertos SAS de los controladores que puedes utilizar para conectar los controladores a pilas de estantes de discos y lograr así una conectividad multivía. 
---
= Hoja de trabajo de cableado para conectividad multivía de los modelos DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes utilizar una hoja de trabajo de cableado para definir los pares de puertos SAS de los controladores que puedes usar para conectar los controladores a las pilas de estantes de discos y así lograr una conectividad multivía en una configuración de par de alta disponibilidad (HA) o de controlador único. También puedes usar la hoja de trabajo completada para guiarte al cablear las conexiones multivía de tu configuración.
