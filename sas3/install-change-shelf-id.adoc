...
summary: Cambia el ID de un shelf en un sistema cuando ONTAP aún no se está ejecutando, al añadir un shelf en caliente antes de conectarlo al sistema, o cuando ONTAP está en funcionamiento y todas las unidades del shelf no tienen propietario, son repuestos o forman parte de agregados fuera de línea. 
---
= Cambiar el ID de un shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes cambiar el ID de un shelf en un DS212C, DS224C o DS460C cuando ONTAP aún no está en funcionamiento o al añadir un shelf en caliente antes de conectarlo al sistema. También puedes cambiar el ID de un shelf cuando ONTAP está en funcionamiento (los módulos controladores están disponibles para servir datos) y todas las unidades del shelf no tienen propietario, son repuestos o forman parte de agregados fuera de línea.
...
. Repita los pasos anteriores para cada estante de disco adicional.
