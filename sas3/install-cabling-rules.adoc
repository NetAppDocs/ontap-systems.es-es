...
image::../media/drw_shelf_to_shelf_double_wide.gif[conectividad de bandeja a bandeja en doble anchura]
...
image::../media/drw_fas2800_concept_tpha_IEOPS-950.svg[Conectividad de alta disponibilidad trirruta]
...
image::../media/drw-sas3-ports-on-fas2800.svg[puertos drw sas3 en fas2800]
