...
summary: 'Las estanterías de discos con módulos IOM12, IOM12B o IOM12C pueden cablearse en configuraciones de par de alta disponibilidad (HA) y de controlador único (para las plataformas compatibles).' 
---
= Normas y conceptos de cableado SAS para los shelves DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Los racks DS212C, DS224C y DS460C con módulos IOM12, IOM12B o IOM12C pueden cablearse en configuraciones de par de alta disponibilidad (HA) y de controlador único (para las plataformas compatibles) aplicando las reglas de cableado SAS: reglas de configuración, reglas de numeración de ranuras de controlador, reglas de conexión entre racks, reglas de conexión entre el controlador y la pila y, si aplica, reglas de cables ópticos SAS mini-SAS HD.


NOTE: Las normas de cableado SAS relativas a la numeración de las ranuras de los controladores, las reglas de conexión entre estantes y las reglas de conexión entre controladores y pilas descritas en esta guía son las mismas que se aplican a todos los estantes de discos SAS, ya sea que tengan módulos IOM12, IOM12B o IOM12C. Sin embargo, la información de esta guía es específica de las características únicas de los estantes de discos con módulos IOM12, IOM12B o IOM12C y su uso en configuraciones compatibles.

Las normas de cableado SAS relativas a las reglas de configuración y a los cables ópticos mini-SAS HD SAS que se describen en esta guía son específicas para los bastidores de discos con módulos IOM12, IOM12B o IOM12C.
...
Las estanterías de discos con módulos IOM12, IOM12B o IOM12C son compatibles con determinados tipos de configuraciones de pares de alta disponibilidad y de controlador único.
