...
summary: Si tu nuevo sistema no venía instalado en un gabinete, debes instalar y cablear las bandejas de discos en un rack. 
---
= Instala y conecta una bandeja DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Los bastidores de discos con módulos IOM12, IOM12B o IOM12C se suministran con los identificadores de bastidor preconfigurados en 00.
+
...
* Si no configuras el sistema para que use la asignación automática de propiedad de discos durante la instalación y configuración del sistema, tendrás que asignar manualmente la propiedad de los discos.
