...
summary: 'Al sustituir un cajón de unidades en una estantería, puedes detener todo el sistema de almacenamiento (HA pair) o mantener el HA pair en funcionamiento.' 
---
= Sustituir un cajón de unidades del DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Este procedimiento se aplica a los shelves que tienen cajones de unidad DCM y/o cajones de unidad DCM2 o DCM3. (Los shelves también tendrán dos módulos IOM12, dos módulos IOM12B o dos módulos IOM12C.)
+
...
[NOTE]
====
Cuando sustituyas una unidad con error por una bandeja DCM2 o DCM3 más reciente, asegúrate de que el software ONTAP y el firmware del módulo IOM12, IOM12B o IOM12C estén ejecutando las versiones mínimas requeridas para ser compatibles con las bandejas DCM2 o DCM3.

La actualización del firmware de los modelos IOM12, IOM12B o IOM12C puede realizarse antes o después de sustituir una bandeja de unidades. Este procedimiento te guía para actualizar el firmware como parte de los preparativos para el procedimiento de sustitución de la bandeja.
...
. Si tu rack va a incluir una combinación de módulos IOM12, IOM12B o IOM12C junto con cualquier número de cajones de unidades DCM3, tu sistema debe ejecutar las siguientes versiones mínimas de ONTAP:
+
** ONTAP 9.17.1RC1
** ONTAP 9.16.1P3
** ONTAP 9.15.1P11
