...
---
= Hoja de trabajo de cableado para una configuración HA de multivía (cuatro rutas) en un DS212C, DS224C o DS460C con dos HBA SAS de cuatro puertos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes usar la hoja de trabajo de cableado del controlador a la pila ya completada y el ejemplo de cableado para conectar una configuración HA de cuatro rutas que tiene dos HBA SAS de cuatro puertos. Esto aplica a los estantes con módulos IOM12, IOM12B o IOM12C.
