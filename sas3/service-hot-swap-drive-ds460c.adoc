...
---
= Intercambia en caliente una unidad de disco en un shelf DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente una unidad con error en un bastidor de discos DS460C con módulos IOM12, IOM12B o IOM12C.
