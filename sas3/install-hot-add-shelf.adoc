...
summary: Puedes agregar en caliente uno o varios bastidores de discos a una pila existente de bastidores de discos, o agregar en caliente una pila de uno o varios bastidores de discos directamente a un HBA SAS o a un puerto SAS integrado en el controlador. 
---
= Agregar en caliente una bandeja DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes agregar en caliente uno o varios bastidores de discos a una pila existente de bastidores de discos, o agregar en caliente una pila de uno o varios bastidores de discos directamente a un HBA SAS o a un puerto SAS integrado en el controlador.
...
* Asegúrate de que tu sistema cumple ciertos requisitos antes de añadir estantes de discos en caliente con módulos IOM12, IOM12B o IOM12C:
+
...
+
** Si vas a añadir en caliente un bastidor de discos con módulos IOM12, IOM12B o IOM12C a una pila ya existente (de bastidores de discos con módulos IOM12, IOM12B o IOM12C), puedes añadir en caliente el bastidor de discos en cualquiera de los extremos, ya sea el primer o el último bastidor de discos lógico, de la pila.
+
...
** Las estanterías de discos con módulos IOM12, IOM12B o IOM12C deben estar en su propia pila exclusiva.
...
CAUTION: *Posible pérdida de acceso a los datos:* Si en el futuro trasladas el shelf a otra parte del data center o transportas el shelf a otra ubicación, debes retirar las unidades de los drive drawers para evitar posibles daños en los drive drawers y en las unidades.
...
Si en el futuro trasladas los bastidores DS460C a otra zona del centro de datos o los transportas a otra ubicación, debes retirar las unidades de los cajones para evitar posibles daños tanto en los cajones como en las unidades.
