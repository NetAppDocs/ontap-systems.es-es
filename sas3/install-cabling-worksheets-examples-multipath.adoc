...
summary: 'Puedes utilizar las hojas de trabajo y los ejemplos de cableado entre el controlador y la pila para cablear tu par de alta disponibilidad (HA) como una configuración multivía HA.' 
---
= Hojas de trabajo de cableado para configuraciones HA multivía de DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Esto se aplica a los shelves con módulos IOM12, IOM12B o IOM12C.
