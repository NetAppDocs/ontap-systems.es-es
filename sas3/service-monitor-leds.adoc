...
---
= Supervisa los LED de los módulos DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ámbar fijo
 a| 
Se ha producido un error en el funcionamiento de una o varias FRU: el bastidor de discos, las unidades de disco, los módulos IOM12, IOM12B o IOM12C, o las fuentes de alimentación.
...
El LED de ubicación en el panel de visualización del operador y en ambos módulos IOM12, IOM12B o IOM12C se iluminan cuando se activa esta función del LED. Los LED de ubicación se apagan automáticamente después de 30 minutos.
...
== LED de los módulos IOM12, IOM12B o IOM12C

Los LED del módulo IOM12, IOM12B o IOM12C indican si el módulo funciona con normalidad, si está listo para el tráfico de E/S y si hay algún problema con el hardware.

La siguiente tabla describe los LED de los módulos IOM12, IOM12B o IOM12C asociados con la función del módulo y la función de cada puerto SAS en el módulo.

El módulo IOM12, IOM12B o IOM12C se usa en los estantes de discos DS460C, DS224C y DS212C.
...
Ámbar fijo
 a| 
Función del módulo IOM12, IOM12B o IOM12C: ocurrió un error con la función del módulo IOM12, IOM12B o IOM12C.
...
Azul fijo
 a| 
El administrador del sistema activó esta función del LED para ayudar a localizar físicamente la bandeja de discos con el módulo IOM12, IOM12B o IOM12C con error.
