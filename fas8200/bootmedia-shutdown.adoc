...
summary: Apague el controlador dañado en un sistema FAS8200 después de completar las comprobaciones de cifrado. El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Apaga el controlador defectuoso de tu sistema FAS8200 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
