...
summary: Restaurar la configuración de cifrado en el medio de arranque de reemplazo para un sistema FAS8200 . El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
