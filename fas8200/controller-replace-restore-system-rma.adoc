...
summary: 'Para restaurar tu sistema FAS8200 a su pleno funcionamiento, restaura la configuración de NetApp Storage Encryption (si es necesario), instala las licencias para la nueva controladora y devuelve la pieza defectuosa a NetApp tal como se describe en las instrucciones de RMA enviadas con el kit.' 
---
= Completa la sustitución del controlador de un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para restaurar tu sistema FAS8200 a su pleno funcionamiento, restaura la configuración de NetApp Storage Encryption (si es necesario), instala las licencias para la nueva controladora y devuelve la pieza defectuosa a NetApp tal como se describe en las instrucciones de RMA enviadas con el kit.
