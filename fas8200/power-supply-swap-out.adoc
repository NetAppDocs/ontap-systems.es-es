...
summary: Cambiar una fuente de alimentación implica apagar, desconectar y retirar la fuente de alimentación antigua, e instalar, conectar y encender la fuente de alimentación de reemplazo. 
---
= Intercambia en caliente una fuente de alimentación en un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambiar una fuente de alimentación implica apagar, desconectar y retirar la fuente de alimentación antigua, e instalar, conectar y encender la fuente de alimentación de reemplazo.
