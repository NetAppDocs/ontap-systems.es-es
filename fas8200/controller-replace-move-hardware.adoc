...
---
= Sustituir el controlador en un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
El módulo DIMM encaja perfectamente en la ranura, pero debería introducirse con facilidad. Si no es así, alinea de nuevo el módulo DIMM con la ranura y vuelve a insertarlo.
...
+
image::../media/drw_rxl_fcache.png[Retire y sustituya el módulo de almacenamiento en caché]
...
.. Con la palanca de leva en posición abierta, empuja con firmeza el módulo controlador hasta que encaje en el plano central y quede completamente asentado, y luego cierra la palanca de leva hasta la posición de bloqueo. Aprieta el tornillo de mariposa de la palanca de leva en la parte trasera del módulo controlador.
+
