...
summary: Reemplace el medio de arranque fallido en un módulo controlador FAS8200 . El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Sustituir el soporte de arranque en un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: El archivo tar.gz debe colocarse en una partición con formato FAT32 que tenga un tamaño mínimo de 4 GB. Aunque las particiones FAT32 pueden alcanzar un tamaño de hasta 2 TB, las herramientas integradas de Windows (por ejemplo, DiskPart) no pueden formatear particiones FAT32 de más de 32 GB.
...
+
El sistema aplica los cambios al arrancar.
