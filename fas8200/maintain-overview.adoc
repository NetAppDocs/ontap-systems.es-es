...
summary: Puedes realizar procedimientos de mantenimiento en los componentes del sistema de almacenamiento FAS8200, incluidos el soporte de arranque, el chasis, el controlador, los DIMM y la fuente de alimentación. 
---
= Infórmate sobre el mantenimiento de un sistema de almacenamiento FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes realizar procedimientos de mantenimiento en los componentes del sistema de almacenamiento FAS8200, incluidos el soporte de arranque, el chasis, el controlador, los DIMM y la fuente de alimentación.
