...
summary: Realice la operación de retroceso de MetroCluster en un sistema FAS8200 después de completar el reemplazo del medio de arranque en una configuración de MetroCluster de dos nodos. El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Recupera los agregados en una configuración de dos nodos de MetroCluster para un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
