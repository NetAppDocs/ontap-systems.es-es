...
summary: Obtenga información sobre el reemplazo de medios de arranque en un sistema FAS8200 y comprenda los diferentes métodos de reemplazo. El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Infórmate sobre cómo sustituir el soporte de arranque en tu sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
