...
summary: 'Debes sustituir un DIMM en el módulo controlador cuando tu sistema de almacenamiento informe de un número excesivo de errores corregibles de código de corrección de errores (CECC) identificados por alertas de Health Monitor, o errores ECC no corregibles provocados por el fallo de un solo DIMM que impida que el sistema de almacenamiento arranque ONTAP.' 
---
= Sustituye un módulo DIMM en tu sistema FAS8200 para solucionar los errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes sustituir un DIMM en el módulo controlador cuando tu sistema de almacenamiento informe de un número excesivo de errores corregibles de código de corrección de errores (CECC) identificados por alertas de Health Monitor, o errores ECC no corregibles provocados por el fallo de un solo DIMM que impida que el sistema de almacenamiento arranque ONTAP.
