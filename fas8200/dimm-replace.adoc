...
summary: Sustituye el DIMM en un sistema FAS8200 cuando el sistema informa de errores de memoria ECC corregibles excesivos a través de alertas de Health Monitor, o de errores ECC no corregibles. Un DIMM defectuoso puede impedir que el sistema de almacenamiento arranque ONTAP, así que al reemplazarlo se restaura el funcionamiento estable. 
---
= Sustituye un módulo DIMM en un sistema FAS8200 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM en un sistema FAS8200 cuando el sistema informa de errores de memoria ECC corregibles excesivos a través de alertas de Health Monitor, o de errores ECC no corregibles. Un DIMM defectuoso puede impedir que el sistema de almacenamiento arranque ONTAP, así que al reemplazarlo se restaura el funcionamiento estable.
...
== Paso 5 (solo MetroCluster de dos nodos): Vuelva a cambiar los agregados
