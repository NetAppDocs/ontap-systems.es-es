...
summary: Verifique el estado y la compatibilidad de la clave de cifrado antes de apagar el controlador dañado en un sistema FAS8200 . El sistema FAS8200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
