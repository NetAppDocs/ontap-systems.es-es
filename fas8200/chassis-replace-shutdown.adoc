...
summary: Antes de poder sustituir el chasis, debes apagar el controlador averiado de tu sistema FAS8200. 
---
= Apaga los controladores del FAS8200 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de poder sustituir el chasis, debes apagar el controlador averiado de tu sistema FAS8200.
