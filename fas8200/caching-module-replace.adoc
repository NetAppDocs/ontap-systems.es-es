...
summary: Debes sustituir el módulo de almacenamiento en caché del módulo controlador cuando tu sistema registre un único mensaje AutoSupport que indique que el módulo se ha desconectado. Si no lo haces, se produce una degradación del rendimiento. 
---
= Sustituye el módulo de almacenamiento en caché en un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
