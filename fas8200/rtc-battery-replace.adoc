...
summary: Debes cambiar la batería del reloj en tiempo real del módulo controlador para que tus servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real de tu sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_rtc_battery.png[Retire y sustituya la batería del RTC]
...
== Paso 4: Vuelve a instalar el módulo controlador y restablece la hora y la fecha tras cambiar la batería del RTC
