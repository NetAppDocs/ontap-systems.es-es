...
summary: Después de sustituir el controlador, vuelve a conectar el sistema y comprueba que se ha reasignado la propiedad de los discos para que tu sistema FAS8200 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema FAS8200 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de sustituir el controlador, vuelve a conectar el sistema y comprueba que se ha reasignado la propiedad de los discos para que tu sistema FAS8200 pueda reanudar su funcionamiento normal.
