...
summary: Para sustituir una tarjeta PCIe, debes retirar el módulo controlador del sistema, abrir el panel lateral, extraer la tarjeta averiada, instalar la tarjeta de repuesto y luego volver a instalar el módulo controlador. 
---
= Sustituir una tarjeta PCIe en un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para sustituir una tarjeta PCIe, debes retirar el módulo controlador del sistema, abrir el panel lateral, extraer la tarjeta averiada, instalar la tarjeta de repuesto y luego volver a instalar el módulo controlador.
