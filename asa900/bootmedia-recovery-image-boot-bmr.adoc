...
summary: Tras instalar el nuevo dispositivo de arranque en su sistema ASA A900 , puede iniciar el proceso de recuperación automática del dispositivo de arranque para restaurar la configuración desde el nodo asociado. 
---
= Recuperación automatizada de medios de arranque desde el nodo asociado - ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Tras instalar el nuevo dispositivo de arranque en su sistema ASA A900 , puede iniciar el proceso de recuperación automática del dispositivo de arranque para restaurar la configuración desde el nodo asociado.
