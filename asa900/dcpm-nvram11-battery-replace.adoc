...
sidebar: sidebar 
keywords: ASA A900 
summary: Para intercambiar en caliente un módulo de alimentación de controlador de etapa DCPM, que contiene la batería NVRAM11, tienes que localizar el módulo DCPM averiado, extraerlo del chasis e instalar el módulo DCPM de sustitución. 
---
= Sustituye el DCPM que contiene la batería NVRAM11 en un sistema ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
