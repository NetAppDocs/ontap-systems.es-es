...
summary: Apaga el controlador de tu sistema de almacenamiento ASA A900 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque. 
---
= Apaga el controlador en un sistema ASA A900 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento ASA A900 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque.
