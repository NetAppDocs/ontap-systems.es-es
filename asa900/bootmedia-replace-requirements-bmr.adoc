...
summary: Antes de reemplazar el medio de arranque en su sistema ASA A900, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. 
---
= Revisa los requisitos para la recuperación automática del soporte de arranque en tu sistema ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de reemplazar el medio de arranque en su ASA A900, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso.  Esto incluye verificar que tiene el medio de arranque de reemplazo correcto, confirmar que el puerto e0S (llave e0M) en el controlador dañado no esté defectuoso y determinar si el Administrador de claves integrado (OKM) o el Administrador de claves externo (EKM) está habilitado.
