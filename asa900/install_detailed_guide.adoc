...
No aplicable
 a| 
image:../media/oie_cable_micro_usb.svg["Cable micro USB"]
 a| 
...
No aplicable
 a| 
image:../media/oie_cable_power.svg["anchura = 85px"]
 a| 
...
| Paso | Ejecute cada controladora 
 ...
 a| 
image:../media/oie_legend_icon_1_lg.svg["Icono de llamada 1"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["Cable de 100 GB"]
 ...
 a| 
image:../media/oie_legend_icon_2_lp.svg["Icono de llamada 2"]
 a| 
...
image:../media/oie_cable_rj45.svg["Cables RJ-45"]
 ...
 a| 
image:../media/oie_legend_icon_3_o.svg["Icono de llamada 3"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["Cable de 100 GB"]
 ...
 a| 
image:../media/oie_legend_icon_4_dr.svg["Icono de llamada 4"]
 a| 
...
| Paso | Ejecute cada controladora 
 ...
 a| 
imagen:../media/ie_legend_icon_1_lg.svg[
 a| 
...
image:../media/oie_cable_pull_tab_down.svg["anchura = 200px"]
...
| Paso | Ejecute cada controladora 
 ...
 a| 
image:../media/oie_legend_icon_1_mb.svg["Icono de llamada 1"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["anchura = 50px"]
...
Cable de 100 GbE
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["Icono de llamada 1"]
 a| 
...
Cable de 100 GbE
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["anchura = 30px"]
 a| 
...
LED de ID de la bandeja
 ...
 a| 
image:../media/legend_icon_04.svg["anchura=20"]
 a| 
...
+
image:../media/drw_autodiscovery_controler_select.svg["anchura=500 px"]
...
+
Imagen: [Icono de llamada uno] drw_A900_power-on_IEOPS-941.svg[width=500px]
