...
summary: Vuelve a cablear las configuraciones de almacenamiento y red, confirma la reasignación de discos y devuelve el control de los recursos de almacenamiento al controlador de reemplazo para que tu sistema ASA A900 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema ASA A900 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
