...
summary: Sustituya el módulo de gestión del sistema en el sistema AFF A1K cuando esté defectuoso o su firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp. 
---
= Sustituye el módulo de administración de sistemas en tu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya el módulo de gestión del sistema en el sistema AFF A1K cuando esté defectuoso o su firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp.
