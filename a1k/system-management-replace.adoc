...
summary: Sustituye el módulo de administración de sistemas de tu sistema AFF A1K cuando presente un fallo o su firmware esté dañado. El proceso de sustitución consiste en apagar el controlador, sustituir el módulo de administración de sistemas defectuoso, reiniciar el controlador, actualizar las claves de licencia y devolver la pieza defectuosa a NetApp. 
---
= Sustituir el módulo de administración de sistemas en un sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
