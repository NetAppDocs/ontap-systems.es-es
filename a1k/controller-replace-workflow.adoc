...
---
= Inicio rápido para el reemplazo del controlador - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comience a sustituir la controladora en su sistema de almacenamiento de AFF A1K. Para ello, apague la controladora dañada, quite y sustituya la controladora, restaure la configuración del sistema y verifique las operaciones del sistema.
