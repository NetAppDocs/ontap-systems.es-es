...
summary: Sustituya un módulo de ventilador en su sistema AFF A1K cuando falle un ventilador o no esté funcionando de forma eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp. 
---
...
[role="lead"]
Sustituya un módulo de ventilador en su sistema AFF A1K cuando falle un ventilador o no esté funcionando de forma eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
