...
---
= Especificaciones clave del sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones del sistema de almacenamiento AFF A1K en una configuración de un solo par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] para consultar las especificaciones completas de este sistema de almacenamiento.
...
* Formato: chasis de 2U con 1 controlador de alta disponibilidad
