...
summary: Añada un módulo I/O a su sistema AFF A1K para mejorar la conectividad de red y ampliar la capacidad del sistema para gestionar el tráfico de datos. 
---
= Agrega un módulo de I/O en un sistema AFF A1K para mejorar la conectividad de red
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Añada un módulo I/O a su sistema AFF A1K para mejorar la conectividad de red y ampliar la capacidad del sistema para gestionar el tráfico de datos.

Puede añadir un módulo de I/O al sistema de almacenamiento AFF A1K cuando haya ranuras vacías disponibles o cuando todas estén completamente ocupadas.
