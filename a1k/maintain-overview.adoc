...
[role="lead"]
Es posible que deba realizar procedimientos de mantenimiento en el hardware. En esta sección se incluyen los procedimientos específicos para el mantenimiento de los componentes del sistema AFF A1K.

En los procedimientos de esta sección se asume que el sistema AFF A1K ya se ha puesto en marcha como nodo de almacenamiento en el entorno ONTAP.
