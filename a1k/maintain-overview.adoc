...
link:chassis-replace-workflow.html["Chasis"]
 a| 
El chasis alberga los ventiladores, el controlador, las fuentes de alimentación, NVRAM, el módulo de administración de sistemas, las tarjetas de E/S y los módulos de supresión.
