...
summary: Complete la instalación y la configuración mediante la detección de clúster con solo una conexión al switch y el portátil, o bien conectando directamente a una controladora en el sistema de almacenamiento y luego conectando al switch de gestión. 
---
...
[role="lead"]
Después de activar el sistema de almacenamiento de AFF A1K, estará listo para detectar su red de clúster y configurar un clúster de ONTAP.
