...
summary: La recuperación automática de la imagen de arranque consiste en que el sistema identifique y seleccione automáticamente la opción adecuada del menú de arranque. Utiliza la imagen de arranque del nodo asociado para reinstalar ONTAP en el soporte de arranque de sustitución de tu sistema AFF A1K. 
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema AFF A1K mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
