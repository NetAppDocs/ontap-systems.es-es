...
---
= Enciende tu sistema de almacenamiento AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de haber encendido su sistema de almacenamiento AFF A1K , https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura tu cluster"] .
