...
---
= Encender un sistema de almacenamiento AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el hardware del bastidor y los cables de tu sistema de almacenamiento AFF A1K, enciende las unidades de almacenamiento y los controladores.
