...
summary: Reemplace el controlador de su sistema AFF A1K cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo. 
---
= Sustituye el controlador de tu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A1K cuando un fallo de hardware lo requiera. El proceso de sustitución implica quitar el controlador averiado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
. Establezca la hora actual en GMT con el `set time hh:mm:ss` dominio.  Puede obtener la hora GMT actual del nodo asociado con el comando `date -u`.
