...
summary: 'Reemplace el controlador en su sistema AFF A1K cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar el controlador del frente del chasis, quitar las unidades de suministro de energía (PSU), NVRAM12, los módulos de E/S y los espacios en blanco, y el módulo de administración del sistema, y ​​luego instalar el chasis de reemplazo y reinstalar los componentes del chasis.' 
---
...
[role="lead"]
Reemplace el controlador de su sistema AFF A1K cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
