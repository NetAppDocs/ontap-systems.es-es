...
summary: Apague la controladora en su sistema de almacenamiento de AFF A1K para evitar la pérdida de datos y garantizar la estabilidad del sistema cuando sustituya la controladora. 
---
= Apaga el controlador defectuoso de un sistema AFF A1K antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague la controladora en su sistema de almacenamiento de AFF A1K para evitar la pérdida de datos y garantizar la estabilidad del sistema cuando sustituya la controladora.
