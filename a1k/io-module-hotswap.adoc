...
---
= Realiza un intercambio en caliente de un módulo de E/S en tu sistema AFF A1K sin necesidad de apagarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para realizar un intercambio en caliente de un módulo de E/S, comprueba que tu sistema de almacenamiento ejecute ONTAP 9.18.1 GA o una versión posterior. Luego, prepara el sistema de almacenamiento y el módulo de E/S, realiza el intercambio en caliente del módulo averiado, pon en línea el módulo de sustitución, restablece el funcionamiento normal y devuelve el módulo averiado a NetApp.
