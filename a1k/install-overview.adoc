...
---
= Flujo de trabajo de instalación y configuración de AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Antes de encender los controladores, enciende cada shelf NS224 y asígnale un ID de shelf único para que cada shelf quede identificado de forma exclusiva dentro de la configuración. Luego conecta el laptop o la consola al controlador y conecta los controladores a las fuentes de alimentación.
