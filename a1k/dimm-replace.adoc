...
summary: Reemplace un módulo DIMM en su sistema AFF A1K si se detectan errores de memoria corregibles o no corregibles excesivos. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp. 
---
= Sustituye un módulo DIMM en un sistema AFF A1K para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo DIMM en su sistema AFF A1K si se detectan errores de memoria corregibles o no corregibles excesivos. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp.
