...
summary: Para completar la sustitución del controlador de tu sistema AFF A1K, restaura la configuración de cifrado de almacenamiento de NetApp, confirma que las interfaces lógicas están reportando a sus puertos de origen, realiza una comprobación del estado del clúster y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de tu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
