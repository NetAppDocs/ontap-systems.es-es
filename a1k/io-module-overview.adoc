...
---
= Infórmate sobre cómo añadir y sustituir módulos de E/S en tu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Las ranuras de I/O de la controladora AFF A1K están numeradas de 1 a 11, como se muestra en la ilustración siguiente.
