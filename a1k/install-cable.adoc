...
+ image:../media/drw_A1K_tnsc_cluster_cabling_ieops-1648.svg[Diagrama de cableado de cluster sin switch de dos nodos,width=500px]

+ . Conecte los puertos del módulo Ethernet a la red host.

+ Los siguientes son algunos ejemplos típicos de cableado de red host. Consulte link:https://hwu.netapp.com["Hardware Universe de NetApp"^] para obtener información sobre la configuración específica del sistema.
...
Estos procedimientos muestran cómo conectar los cables de las controladoras a una bandeja y a dos bandejas. Puede conectar directamente hasta cuatro bandejas a las controladoras.
