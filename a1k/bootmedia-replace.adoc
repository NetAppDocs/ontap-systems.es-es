...
summary: Los medios de arranque de su sistema AFF A1K almacenan datos esenciales del firmware y de configuración. Si el soporte de arranque falla, debe desconectar el módulo del controlador, extraer el módulo de gestión del sistema, retirar el soporte de arranque dañado e instalar el soporte de arranque de repuesto en el módulo de gestión del sistema. 
---
...
[role="lead"]
Los medios de arranque de su sistema AFF A1K almacenan datos esenciales del firmware y de configuración. Si el soporte de arranque falla, debe desconectar el módulo del controlador, extraer el módulo de gestión del sistema, retirar el soporte de arranque dañado e instalar el soporte de arranque de repuesto en el módulo de gestión del sistema.
