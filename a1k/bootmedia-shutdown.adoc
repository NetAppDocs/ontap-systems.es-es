...
summary: Apaga el controlador defectuoso de tu sistema de almacenamiento AFF A1K para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación mediante arranque manual. 
---
= Apaga el controlador de tu sistema AFF A1K durante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento AFF A1K para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación mediante arranque manual.
