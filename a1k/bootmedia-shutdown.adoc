...
summary: Apaga el controlador de tu sistema de almacenamiento AFF A1K para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque. 
---
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF A1K para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque.
