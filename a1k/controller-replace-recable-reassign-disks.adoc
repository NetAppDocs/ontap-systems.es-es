...
---
= Devuelve el controlador en tu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema AFF A1K pueda reanudar su funcionamiento normal. El procedimiento de devolución varía en función del tipo de cifrado que utilice tu sistema: sin cifrado o cifrado con Onboard Key Manager (OKM).
