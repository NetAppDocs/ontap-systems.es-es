...
[role="lead"]
Devolver el control de los recursos de almacenamiento a la controladora de reemplazo para que su sistema AFF A1K pueda reanudar el funcionamiento normal. El procedimiento de devolución varía según el tipo de cifrado utilizado por el sistema: Sin cifrado, cifrado del gestor de claves integrado (OKM) o cifrado del gestor de claves externo (EKM).
