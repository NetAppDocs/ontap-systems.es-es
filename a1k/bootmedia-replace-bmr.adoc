...
summary: El soporte de arranque de tu sistema AFF A1K almacena datos esenciales de firmware y configuración. Sustituirlo implica quitar el módulo de administración de sistemas, retirar el soporte de arranque dañado, instalar el soporte de arranque de repuesto y volver a instalar el módulo. 
---
= Sustituye el soporte de arranque en un sistema AFF A1K usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El soporte de arranque de tu sistema AFF A1K almacena datos esenciales de firmware y configuración. Sustituirlo implica quitar el módulo de administración de sistemas, retirar el soporte de arranque dañado, instalar el soporte de arranque de repuesto y volver a instalar el módulo.
