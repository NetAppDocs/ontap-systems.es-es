...
Los puertos de UTA2 GbE, la red de datos Ethernet y los puertos de gestión de los módulos de la controladora están conectados a los switches. Los puertos de interconexión de clúster se cablean en ambos módulos de la controladora.
