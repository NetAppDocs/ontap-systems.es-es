...
---
= Sustituir una unidad en tu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad con error en tu sistema AFF C190 sin interrumpir el I/O. El AFF C190 es compatible tanto con unidades SSD como con HDD, y cada una tiene un procedimiento de sustitución específico.
