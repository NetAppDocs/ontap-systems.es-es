...
---
= Intercambia en caliente una unidad en un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad con error en tu sistema AFF C190 sin interrumpir las operaciones de E/S. El AFF C190 es compatible tanto con unidades SSD como con HDD, y cada tipo cuenta con un procedimiento de sustitución específico.
