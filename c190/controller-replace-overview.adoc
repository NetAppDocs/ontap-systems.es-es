...
---
= Revisa los requisitos antes de sustituir el controlador en un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF C190, revisa los requisitos previos para el procedimiento de sustitución y selecciona el correcto para tu versión del sistema operativo ONTAP.
