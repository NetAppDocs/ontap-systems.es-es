...
---
= Sustituye la batería del NVMEM de tu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVMEM de tu sistema AFF C190 quitando el módulo controlador, abriéndolo, cambiando la batería y volviendo a instalar el módulo controlador.
