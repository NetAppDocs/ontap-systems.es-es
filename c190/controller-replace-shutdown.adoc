...
---
= Apaga el controlador defectuoso de un sistema AFF C190 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso en un sistema AFF C190 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el controlador.
