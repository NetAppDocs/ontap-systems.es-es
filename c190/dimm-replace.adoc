...
summary: Debes sustituir un módulo DIMM en el controlador cuando tu sistema de almacenamiento encuentre errores como errores excesivos de código de corrección de errores corregibles que se basan en alertas de Health Monitor o errores ECC no corregibles, normalmente causados por una falla de un solo módulo DIMM que impide que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en un sistema AFF C190 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
