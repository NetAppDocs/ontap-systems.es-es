...
---
= Sustituye el chasis de tu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Después de instalar el módulo del controlador y cualquier otro componente en el nuevo chasis, debe arrancarlo.
