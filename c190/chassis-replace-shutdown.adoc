...
---
= Apaga los controladores AFF C190 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de un sistema AFF C190 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el chasis.
