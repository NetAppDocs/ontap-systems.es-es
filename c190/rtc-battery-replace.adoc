...
summary: Sustituyes la batería del reloj en tiempo real RTC del módulo controlador para que los servicios y aplicaciones de tu sistema que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
