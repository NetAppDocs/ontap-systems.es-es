...
+
image::../media/drw_2600_nvmem_battery_unplug.png[desenchufar la batería de nvmem drw 2600]

.. Confirme que el LED de NVMEM ya no está encendido.
.. Volver a conectar el conector de la batería.


. Volver a. link:dimm_replace.md#replace-the-dimms["Paso 3: Sustituya los módulos DIMM"] De este procedimiento para volver a comprobar el LED de NVMEM.
...
+
image::../media/drw_2600_dimm_repl_animated_gif.png[gif animado drw 2600 dimm repl]
...
Un par de alta disponibilidad
 a| 
Realice un aporte atrás: `storage failover giveback -ofnode _replacement_node_name_` *Nota:* Si ha desactivado la devolución automática, vuelva a habilitarla con el comando Storage Failover modify.
