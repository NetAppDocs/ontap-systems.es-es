...
summary: Para restablecer el funcionamiento completo del sistema, debes restaurar la configuración de NetApp Storage Encryption, instalar licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA incluidas con el kit. 
---
= Completa la sustitución del controlador de un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF C190 restableciendo la configuración de cifrado de almacenamiento de NetApp (si es necesario), instalando licencias para el nuevo controlador y devolviendo la unidad con error a NetApp.
