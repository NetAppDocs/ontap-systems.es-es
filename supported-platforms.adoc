...
[role="lead"]
Los sistemas de almacenamiento de ONTAP son compatibles con varias versiones del software ONTAP. Obtenga más información sobre las versiones de ONTAP que admiten los sistemas de almacenamiento y las bandejas de unidades.
...
Los sistemas AFF A-Series y la serie AFF C son compatibles con las siguientes versiones de ONTAP.
...
Los sistemas R2 de ASA son compatibles con las siguientes versiones de ONTAP.
...
Los sistemas ASA son compatibles con las siguientes versiones de ONTAP.
...
Los sistemas FAS son compatibles con las siguientes versiones de ONTAP.
...
--
Las bandejas de unidades están diseñadas específicamente para los sistemas NetApp AFF, ASA y FAS, y ayudan a ofrecer el rendimiento, la resiliencia y la flexibilidad que necesita su transformación digital.
