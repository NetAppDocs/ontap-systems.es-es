...
---
= Infórmate sobre el mantenimiento de tu sistema de almacenamiento ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mantenga el hardware de su sistema de almacenamiento ASA C800 para garantizar confiabilidad a largo plazo y un rendimiento óptimo. Realice tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, para evitar tiempos de inactividad y la pérdida de datos.

Los procedimientos de mantenimiento asumen que el sistema de almacenamiento ASA C800 ya se ha implementado como un nodo de almacenamiento en el entorno ONTAP .
