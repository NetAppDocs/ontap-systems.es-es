...
summary: Sustituye una fuente de alimentación de CA o CC en tu sistema ASA C800 cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. 
---
= Intercambia en caliente una fuente de alimentación en un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_a800_replace_psu.svg[Retire o vuelva a aplicar la placa de alimentación]
