...
---
= Apaga el controlador defectuoso de un sistema ASA C800 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador en su sistema de almacenamiento ASA C800 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el controlador.
