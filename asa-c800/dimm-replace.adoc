...
summary: Sustituye un DIMM en tu sistema ASA C800 si se detectan errores de memoria excesivos corregibles o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en un sistema ASA C800 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
