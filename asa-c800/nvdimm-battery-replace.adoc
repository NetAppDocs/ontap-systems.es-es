...
---
= Sustituye la batería del NVDIMM en un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVDIMM de tu sistema ASA C800 cuando la batería comience a perder carga o falle, ya que es la encargada de conservar los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en apagar el controlador averiado, extraer el módulo del controlador, sustituir la batería NVDIMM, volver a instalar el módulo del controlador y devolver la pieza averiada a NetApp.
