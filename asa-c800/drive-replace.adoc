...
summary: Realiza un intercambio en caliente de una unidad en tu sistema ASA C800 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Además, se iluminan tanto el LED de fallo del panel de visualización del operador como el LED de fallo de la unidad con error. 
---
= Intercambia en caliente una unidad en un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema ASA C800 cuando una unidad tenga error o requiera una actualización. El proceso de sustitución consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
