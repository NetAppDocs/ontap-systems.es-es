...
summary: Sustituye una unidad de tu sistema ASA C800 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Además, se encienden tanto el LED de fallo del panel de visualización del operador como el LED de fallo de la unidad con error. 
---
= Sustituir una unidad en un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace una unidad en su sistema ASA C800 cuando una unidad falla o requiere una actualización. El proceso de reemplazo implica identificar la unidad defectuosa, quitarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
