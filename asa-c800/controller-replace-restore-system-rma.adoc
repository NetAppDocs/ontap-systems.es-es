...
summary: Para restablecer el funcionamiento completo de tu sistema ASA C800, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
