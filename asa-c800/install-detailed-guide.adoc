...
+
image::../media/drw_asac800_weight_caution.png[drw asac800 peso precaución]

. Conecte los dispositivos de administración de cables (como se muestra).
+
image::../media/drw_asac800_install_cable_mgmt.png[drw asac800 instale la gestión del cable]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Conecte los puertos de gestión a los switches de red de gestión    image:../media/drw_asac800_mgmt_cabling.png["Ilustración que muestra la ubicación de los puertos de gestión en la parte posterior del sistema"]
...
1
 a| 
Conecte los puertos 2a a 2d a los switches host FC.image:../media/drw_asac800_fc_host_cabling.png[""]
...
1
 a| 
Los puertos de cable e4a a e4d a los conmutadores de red host 10GbE.image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Conecte la controladora A a la bandeja:    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Conecte la controladora B a la bandeja:    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Conecte la controladora A a las bandejas:    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Conecte la controladora B a las bandejas:    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[conexión de la consola drw asac800]

.. Conecte el portátil o la consola al conmutador de la subred de administración.
+
image::../media/drw_client_mgmt_subnet_asac800.png[subred asac800 de gestión del cliente drw]
