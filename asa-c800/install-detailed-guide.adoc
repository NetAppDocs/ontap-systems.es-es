...
summary: Sigue las instrucciones detalladas, paso a paso, para preparar la instalación, instalar el hardware, cablear el sistema y completar la configuración inicial de un sistema ASA C800. 
---
= Instala y configura un sistema ASA C800 usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sigue las instrucciones detalladas, paso a paso, para preparar la instalación, instalar el hardware, cablear el sistema y completar la configuración inicial de un sistema ASA C800.
