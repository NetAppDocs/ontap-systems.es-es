...
summary: Después de instalar el nuevo dispositivo de arranque en tu sistema ASA C800, puedes iniciar el proceso automatizado de recuperación del medio de arranque para restaurar la configuración desde el nodo asociado. 
---
= Restaura la imagen de arranque en tu sistema ASA C800 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
