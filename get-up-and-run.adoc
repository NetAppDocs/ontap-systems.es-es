...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/afx/index.html["Interruptores AFX"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["Conmutadores de clúster"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["Conmutadores de almacenamiento"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9336c-fx2-shared/install-9336c-shared.html["Conmutadores compartidos"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["Sistemas A-Series de AFF"]
* link:aff-cseries/index.html["Sistemas C-Series de AFF"]
* link:allsan-landing/index.html["Sistemas ASA"]
* link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["Sistemas AFX"]
* https://docs.netapp.com/us-en/asa-r2/install-setup/install-setup-workflow.html["Sistemas ASA r2"]
...
* Para implementaciones de ONTAP con MetroCluster , consulte https://docs.netapp.com/us-en/ontap-metrocluster/["Configuración de MetroCluster con ONTAP"^] .
