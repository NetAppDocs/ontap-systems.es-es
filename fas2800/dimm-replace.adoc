...
summary: Debes sustituir un módulo DIMM en el controlador cuando tu sistema de almacenamiento encuentre errores como un exceso de errores ECC corregibles según las alertas de Health Monitor, o errores ECC no corregibles que impidan que el sistema de almacenamiento arranque ONTAP. 
---
