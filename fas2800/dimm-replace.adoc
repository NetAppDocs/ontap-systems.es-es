...
summary: 'Debes sustituir un DIMM del controlador de tu sistema FAS2820 cuando se produzcan errores como un número excesivo de errores CECC (Correctable Error Correction Codes) según las alertas de Health Monitor, o errores ECC incorregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP.' 
---
= Sustituye un módulo DIMM en tu sistema FAS2820 para solucionar los errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes sustituir un DIMM del controlador de tu sistema FAS2820 cuando se produzcan errores como un número excesivo de errores CECC (Correctable Error Correction Codes) según las alertas de Health Monitor, o errores ECC incorregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP.
...
+
El módulo DIMM gira ligeramente hacia arriba.
...
. Vuelve a conectar la batería de la NVRAM:
+
