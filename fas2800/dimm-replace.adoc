...
summary: Debes sustituir el DIMM del controlador de tu sistema FAS2820 cuando se produzcan errores como un número excesivo de errores de memoria ECC corregibles según las alertas de Health Monitor, o errores ECC no corregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en un sistema FAS2820 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes sustituir el DIMM del controlador de tu sistema FAS2820 cuando se produzcan errores como un número excesivo de errores de memoria ECC corregibles según las alertas de Health Monitor, o errores ECC no corregibles, normalmente causados por el fallo de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP.
