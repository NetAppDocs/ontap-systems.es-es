...
summary: Apaga el controlador con fallos de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación mediante arranque manual. 
---
= Apaga el controlador defectuoso de tu sistema FAS2820 durante el proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador con fallos de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación mediante arranque manual.
