...
summary: Empieza a sustituir el soporte de arranque de tu sistema de almacenamiento FAS2820 revisando los requisitos de sustitución, apagando los controladores, sustituyendo el soporte de arranque, restaurando la imagen en el soporte de arranque y comprobando el funcionamiento del sistema. 
---
= Flujo de trabajo para reemplazar el soporte de arranque en un sistema FAS2820 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
