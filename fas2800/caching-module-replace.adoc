...
summary: Debes sustituir el módulo de almacenamiento en caché del módulo controlador de tu sistema FAS2820 cuando este registre un único mensaje AutoSupport que indique que el módulo ha dejado de estar operativo. Si no sustituyes el módulo averiado, tu sistema de almacenamiento sufrirá una disminución del rendimiento. 
---
= Sustituye el módulo de almacenamiento en caché en un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes sustituir el módulo de almacenamiento en caché del módulo controlador de tu sistema FAS2820 cuando registre un único mensaje AutoSupport (ASUP) indicando que el módulo se ha desconectado. Si no sustituyes el módulo con error, tu sistema de almacenamiento experimentará una degradación del rendimiento.
