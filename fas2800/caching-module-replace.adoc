...
summary: Debes sustituir el módulo de almacenamiento en caché del módulo controlador cuando tu sistema registre un único mensaje ASUP AutoSupport que indique que el módulo se ha desconectado. Si no sustituyes el módulo averiado, tu sistema de almacenamiento experimentará una degradación del rendimiento. 
---
