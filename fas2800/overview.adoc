...
summary: Especificaciones clave del grupo de plataformas FAS2820 
---
= Especificaciones clave de un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones del sistema de almacenamiento FAS2820 en una configuración de un único par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] para consultar las especificaciones completas de este sistema de almacenamiento.
...
* Versión mínima de ONTAP : ONTAP 9.13.1RC1
