...
summary: Apaga el controlador con fallo de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema al reemplazar el medio de arranque. 
---
= Apaga el controlador con fallo de tu sistema FAS2820 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador dañado de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automatizado de recuperación de medios de arranque.
