...
summary: Apaga el controlador de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema al reemplazar el boot media. 
---
= Apaga el controlador de tu sistema FAS2820 durante el proceso automático de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento FAS2820 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del soporte de arranque.
