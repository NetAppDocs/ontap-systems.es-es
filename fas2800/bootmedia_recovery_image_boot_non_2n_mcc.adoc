...
+
** Si su sistema tiene configurado el gestor de claves incorporado, NSE o NVE, vaya a. xref:bootmedia_encryption_restore.adoc[Restaure OKM, NSE y NVE según sea necesario]
