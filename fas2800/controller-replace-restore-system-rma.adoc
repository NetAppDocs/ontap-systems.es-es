...
---
= Restauración completa del sistema - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Paso 2: Restaure el almacenamiento y la funcionalidad de cifrado de volúmenes
...
== Paso 3: Verifique las LIF y registre el número de serie
