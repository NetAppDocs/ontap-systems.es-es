...
summary: 'Restaura el funcionamiento completo de tu sistema FAS2820 restaurando las configuraciones de NetApp Storage Encryption o Volume Encryption (si es necesario), instalando las licencias para la controladora de repuesto y devolviendo la pieza defectuosa a NetApp, tal y como se describe en las instrucciones de RMA enviadas con el kit.' 
---
= Completa la sustitución del controlador de un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura el funcionamiento completo de tu sistema FAS2820 restaurando las configuraciones de NetApp Storage Encryption o Volume Encryption (si es necesario), instalando las licencias para la controladora de repuesto y devolviendo la pieza defectuosa a NetApp, tal y como se describe en las instrucciones de RMA enviadas con el kit.
