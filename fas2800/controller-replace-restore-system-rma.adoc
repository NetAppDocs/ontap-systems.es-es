...
summary: Restaura el funcionamiento completo de tu sistema restaurando las configuraciones de NetApp Storage Encryption o Volume Encryption, instalando licencias para el controlador de reemplazo y devolviendo la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA enviadas con el kit. 
---
= Restauración completa del sistema - FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure el funcionamiento completo del sistema. Para ello, restaure las configuraciones de cifrado de almacenamiento de NetApp o cifrado de volúmenes (si es necesario), instale licencias para la controladora de reemplazo y devuelva la pieza con error a NetApp como se describe en las instrucciones de RMA que se suministran con el kit.
