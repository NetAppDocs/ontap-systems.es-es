...
summary: Este procedimiento ofrece instrucciones detalladas y paso a paso para instalar tu sistema de almacenamiento FAS2820. 
---
= Instala tu sistema FAS2820 siguiendo las instrucciones detalladas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Este procedimiento ofrece instrucciones detalladas, paso a paso, para preparar, instalar, cablear y encender tu sistema de almacenamiento FAS2820. Usa estos pasos si prefieres explicaciones completas en vez de la guía rápida abreviada.
...
+
.. Revisa los requisitos y los pasos del procedimiento.
.. Recopila información sobre tu sistema de almacenamiento rellenando la hoja de configuración.
...
NOTE: Si tu sistema no tiene estantes externos, consulta link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves["instrucciones de cableado para FAS2820 en una configuración de HA multivía sin estantes externos"].
...
Completa la configuración e instalación de tu sistema de almacenamiento usando la opción 1: si la detección de red está activada, o la opción 2: si la detección de red no está activada.
...
--
Si la detección de redes está activada en tu portátil, completa la configuración e instalación del sistema de almacenamiento usando la detección automática de clústeres.

.Pasos
. Enciende la alimentación de las estanterías y configura los IDs de las estanterías usando la animación al principio de este paso.
...
. Utiliza el gráfico o los pasos para descubrir el nodo del sistema de almacenamiento que vas a configurar:
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[Sistema de detección automática]

+
.. Abra el Explorador de archivos.
.. Haz clic con el botón derecho en *Network* en el panel izquierdo y selecciona *refresh*.
...
+
.. Selecciona https://mysupport.netapp.com["mysupport.netapp.com"]
.. Selecciona _Crear cuenta_ si necesitas crear una cuenta o iniciar sesión en tu cuenta.
...
.. Configura el sistema de almacenamiento utilizando los datos que has recopilado en <<Paso 1: Preparar la instalación>>.
