...
summary: Empieza a reemplazar el soporte de arranque en tu sistema de almacenamiento FAS2820 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución de medios de arranque para un sistema FAS2820 mediante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a reemplazar el soporte de arranque en tu sistema de almacenamiento FAS2820 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema.
