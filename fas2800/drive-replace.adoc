...
summary: Debes realizar un intercambio en caliente de una unidad en tu sistema FAS2820 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad con error. Se encienden tanto el LED de fallo del panel de control como el LED de fallo de la unidad con error. 
---
= Intercambia en caliente una unidad en un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad con error en tu sistema FAS2820 sin interrumpir el servicio mientras hay operaciones de E/S en curso para restaurar la capacidad de almacenamiento y el rendimiento del sistema.
