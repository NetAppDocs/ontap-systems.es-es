...
summary: Para realizar un intercambio en caliente de la fuente de alimentación en tu sistema FAS2820, tienes que apagar, desconectar y retirar la fuente de alimentación defectuosa, e instalar, conectar y encender la fuente de alimentación de repuesto. 
---
= Intercambia en caliente una fuente de alimentación en un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de la fuente de alimentación de tu sistema FAS2820 si falla o presenta un deterioro, sin interrumpir el funcionamiento del sistema. Este procedimiento consiste en apagar y retirar la fuente de alimentación defectuosa, luego instalar y encender la de repuesto.
