...
summary: Antes de sustituir el chasis de tu sistema FAS2820, debes apagar correctamente los controladores para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
= Apaga los controladores del FAS2820 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis de tu sistema FAS2820, debes apagar correctamente los controladores para evitar la pérdida de datos y garantizar la estabilidad del sistema.
