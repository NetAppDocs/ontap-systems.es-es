...
Retire el bisel intermedio y la tarjeta mezzanine PCIe del módulo del controlador dañado.
...
|===
. Retire el bisel de la tarjeta intermedia deslizándolo hacia fuera del módulo del controlador.
...
. Vuelva a instalar el marco de la tarjeta mezzanine.
