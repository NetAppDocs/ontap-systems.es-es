...
summary: En tu sistema FAS2820, reemplaza el hardware del módulo de controlador con fallo quitando el controlador con fallo, moviendo los componentes FRU al módulo de controlador de reemplazo, instalando el módulo de reemplazo en el chasis y luego arrancando el módulo de controlador de reemplazo. 
---
= Sustituir el controlador en un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
En tu sistema FAS2820, reemplaza el hardware del módulo de controlador con fallo quitando el controlador con fallo, moviendo los componentes FRU al módulo de controlador de reemplazo, instalando el módulo de reemplazo en el chasis y luego arrancando el módulo de controlador de reemplazo.
...
NOTE: No conectes todavía la batería. La conectarás una vez que hayas trasladado el resto de los componentes al módulo controlador de recambio.
...
. Instala el soporte de arranque en el módulo controlador de recambio:
+
...
Retira el módulo de almacenamiento en caché del módulo controlador averiado e instálalo en el módulo controlador de recambio.
...
. Da la vuelta al módulo controlador.
