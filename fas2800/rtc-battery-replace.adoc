...
---
= Sustituya la batería del reloj en tiempo real - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_2850_replace_rtc_battery_IEOPS-701.svg[drw 2850 reemplace la batería rtc IEOPS 701]
