...
summary: Debes cambiar la batería del reloj en tiempo real del módulo controlador de tu sistema FAS2820 para que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debes cambiar la batería del reloj en tiempo real (RTC) del módulo controlador de tu sistema FAS2820 para que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
...
Sustituye la batería del RTC localizándola dentro del controlador y siguiendo la secuencia específica de pasos.
...
Vuelve a instalar el módulo controlador y arranca el sistema hasta llegar al indicador LOADER.
