...
summary: Restaura el cifrado en el soporte de arranque de reemplazo de tu sistema FAS2820. 
---
= Restablece el cifrado en el soporte de arranque de un sistema FAS2820 después del proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de que reemplaces el soporte de arranque en tu sistema FAS2820, restaura el cifrado en el nuevo dispositivo para mantener la seguridad de los datos y devolver el sistema a su configuración original.
