...
summary: Mantener el hardware de FAS2800 
---
= Mantener el hardware de FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para el sistema de almacenamiento FAS2800, puede realizar procedimientos de mantenimiento en los componentes siguientes.
