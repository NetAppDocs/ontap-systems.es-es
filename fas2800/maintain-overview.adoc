...
summary: Mantén el hardware de tu sistema de almacenamiento FAS2820 para asegurar la fiabilidad a largo plazo y un rendimiento óptimo. 
---
= Infórmate sobre el mantenimiento de tu sistema de almacenamiento FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puedes realizar procedimientos de mantenimiento en estos componentes de tu sistema de almacenamiento FAS2820.
...
link:pci-cards-and-risers-replace.html["Tarjeta mezzanine"]
 a| 
Una tarjeta Mezzanine es una tarjeta de expansión que se inserta en una ranura específica de la placa base y aloja las tarjetas de E/S.
