...
---
= Restaurar y verificar la configuración del sistema - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de sustituir el hardware y arrancar la controladora de reemplazo, compruebe la configuración de bajo nivel del sistema de la controladora de reemplazo y vuelva a configurar los ajustes del sistema si es necesario.
