...
summary: Restaure la imagen ONTAP en el medio de arranque de reemplazo en su sistema fas2800.  El proceso implica iniciar el proceso de recuperación de arranque desde el indicador LOADER y supervisar el proceso de recuperación hasta que se complete y el nodo se reinicie. 
---
= Recuperación automatizada de medios de arranque desde el nodo asociado - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
