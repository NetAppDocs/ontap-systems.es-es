...
summary: Apaga el controlador defectuoso de tu sistema FAS2820 antes de sustituirlo. El procedimiento que uses depende de la configuración de hardware de tu sistema de almacenamiento. 
---
= Apaga el controlador defectuoso de un sistema FAS2820 antes de sustituirlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema FAS2820 antes de sustituirlo. El procedimiento que uses depende de la configuración de hardware de tu sistema de almacenamiento.
