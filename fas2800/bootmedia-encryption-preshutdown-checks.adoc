...
summary: Para garantizar la seguridad de los datos en tu sistema de almacenamiento FAS2820, debes verificar la compatibilidad y el estado de las claves de cifrado en tu medio de arranque. Comprueba si tu versión de ONTAP es compatible con NetApp Volume Encryption y, antes de apagar la controladora, comprueba si el gestor de claves está activo. 
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque en un sistema FAS2820 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en tu sistema de almacenamiento FAS2820, verifica la compatibilidad y el estado de la clave de cifrado en tu soporte de arranque. Verifica si tu versión de ONTAP es compatible con NetApp Volume Encryption (NVE). Antes de apagar el controlador, verifica si el gestor de claves está activo.
