...
---
= Intercambia en caliente una unidad en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad con error en tu sistema AFF A220 sin interrumpir las operaciones de E/S. El AFF A220 es compatible tanto con SSD como con HDD, cada uno con su propio procedimiento de sustitución.
