...
---
= Sustituir una unidad en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad con error en tu sistema AFF A220 sin interrumpir el I/O. El AFF A220 es compatible tanto con unidades SSD como con HDD, y cada una tiene un procedimiento de sustitución específico.
