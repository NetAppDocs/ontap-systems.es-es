...
---
= Sustituye el chasis de tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A220 moviendo las fuentes de alimentación, los discos duros y los módulos controladores del chasis averiado al chasis de reemplazo.
