...
summary: Restaura la encriptación en el medio de arranque de repuesto de tu sistema de almacenamiento AFF A220. El AFF A220 solo admite procedimientos de recuperación manual de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
