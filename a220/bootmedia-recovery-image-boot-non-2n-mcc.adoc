...
---
= Arranca la imagen de recuperación en tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arranca la imagen de recuperación de ONTAP desde la unidad USB de tu sistema AFF A220 para restaurar el boot media usando el proceso de recuperación de arranque manual.
