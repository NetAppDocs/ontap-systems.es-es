...
---
= Sustituir el controlador en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A220 quitando el controlador defectuoso, moviendo los componentes FRU al módulo de controlador de reemplazo, instalándolo en el chasis y arrancando en modo de mantenimiento.
