...
---
= Apaga los controladores AFF A220 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores AFF A220 para sustituir el chasis siguiendo el procedimiento adecuado para tu configuración.
