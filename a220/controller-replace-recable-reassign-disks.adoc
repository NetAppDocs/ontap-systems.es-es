...
---
= Vuelve a cablear el sistema y reasigna los discos en tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Finaliza la sustitución del controlador de tu sistema AFF A220 volviendo a cablear el almacenamiento y confirmando la reasignación de los discos.
