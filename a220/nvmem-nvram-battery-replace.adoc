...
---
= Sustituye la batería del NVMEM de tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVMEM de tu sistema AFF A220 quitando el módulo del controlador, cambiando la batería y volviendo a instalar el módulo del controlador.
