...
summary: Sustituye un módulo DIMM en tu módulo controlador AFF A220 cuando tu sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituye un módulo DIMM en tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema AFF A220 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC no corregible, lo que normalmente es causado por una falla en un solo DIMM.
