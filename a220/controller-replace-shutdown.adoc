...
---
= Apaga el controlador defectuoso de tu sistema AFF A220 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A220 antes de sustituirlo, tomándolo y deteniéndolo en el prompt LOADER.
