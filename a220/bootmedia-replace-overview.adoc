...
summary: El medio de arranque almacena un conjunto primario y secundario de archivos de sistema que el sistema utiliza cuando arranca. El sistema AFF A220 solo admite procedimientos manuales de recuperación del medio de arranque. 
---
= Infórmate sobre la sustitución del soporte de arranque en tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
