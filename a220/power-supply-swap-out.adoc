...
---
= Intercambia en caliente una fuente de alimentación en tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza el intercambio en caliente de una fuente de alimentación en tu sistema AFF A220 apagando, desconectando y retirando la unidad averiada, luego instala y vuelve a conectar la de reemplazo.
