...
---
= Revisa los requisitos antes de sustituir el controlador en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF A220, revisa los requisitos previos para el procedimiento de sustitución y selecciona el correcto para tu versión de ONTAP.
