...
summary: Apaga el controlador de tu sistema de almacenamiento AFF A220 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque. 
---
= Apaga el controlador de tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF A220 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del soporte de arranque.
