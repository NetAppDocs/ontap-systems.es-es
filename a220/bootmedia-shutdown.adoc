...
summary: Puede apagar o tomar el control del controlador dañado mediante diferentes procedimientos, dependiendo de la configuración del hardware del sistema de almacenamiento. El sistema AFF A220 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Apaga el controlador defectuoso de tu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague o tome el control del controlador dañado utilizando el procedimiento apropiado para su configuración. El sistema AFF A220 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
