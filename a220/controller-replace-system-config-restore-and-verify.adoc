...
---
= Restaurar y verificar la configuración del controlador en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura y comprueba la configuración del controlador en tu sistema AFF A220 después de completar la sustitución del hardware y arrancar en modo de mantenimiento.
