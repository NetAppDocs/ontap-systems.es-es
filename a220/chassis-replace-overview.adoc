...
---
= Revisa los requisitos para sustituir un chasis en un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis de tu sistema AFF A220, revisa los requisitos necesarios para que la sustitución sea exitosa. El procedimiento de sustitución del chasis mueve todas las fuentes de alimentación, las unidades de disco y los módulos de controlador del chasis averiado al chasis de reemplazo, y es una operación disruptiva.
