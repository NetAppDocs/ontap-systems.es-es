...
summary: 'Para restaurar el funcionamiento completo del sistema, debe restaurar la configuración de cifrado del almacenamiento de NetApp (si es necesario), e instalar licencias para la nueva controladora y devolverla a NetApp.' 
---
