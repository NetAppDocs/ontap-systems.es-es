...
summary: Conecta tu estantería NS224 a tu sistema AFF A30, AFF A50, AFF C30 o AFF C60 para que cada estantería tenga dos conexiones a cada controlador del par HA. 
---
= Conecta un estante NS224 a tu sistema AFF A30, AFF A50, AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema AFF A30, AFF A50, AFF C30 o AFF C60 para que cada estantería tenga dos conexiones a cada controlador del par HA.
