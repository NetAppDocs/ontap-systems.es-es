...
summary: Conecta tu estantería NS224 a tu sistema AFF A800 o AFF C800 para que cada estantería tenga dos conexiones a cada controlador del par HA. 
---
= Cablea una estantería NS224 a tu sistema AFF A800 o AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema AFF A800 o AFF C800 para que cada estantería tenga dos conexiones a cada controlador del par HA.
