...
summary: Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de la estantería para tu sistema de fin de disponibilidad. 
---
= Instala una estantería NS224 en tu sistema de fin de disponibilidad
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de la estantería para tu sistema de fin de disponibilidad.

.Antes de empezar
* Asegúrate de tener un clip con un lado enderezado o un bolígrafo de punta estrecha.
+
...
.El futuro
Después de instalar tu estante, link:hot-add-eoa-cable-overview.html["cablea tu shelf"].
