...
summary: Si desactivaste la asignación automática de unidades, asigna manualmente la propiedad de las unidades y vuelve a activar la asignación automática de unidades para tu sistema ASA. 
---
= Completa la incorporación en caliente de la estantería NS224 para tu sistema ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
