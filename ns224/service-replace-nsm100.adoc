...
summary: 'Puede reemplazar un módulo de bandeja NVMe (NSM) con alteraciones en una bandeja de unidades NS224 encendida y mientras hay I/o en curso.' 
---
= Sustituir un módulo NS224 NSM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
