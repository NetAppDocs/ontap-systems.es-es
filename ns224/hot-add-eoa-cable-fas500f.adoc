...
summary: Conecta tu estantería NS224 a tu sistema FAS500f para que cada estantería tenga dos conexiones a cada controlador del par de HA. 
---
= Conectar una bandeja NS224 a un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema FAS500f para que cada estantería tenga dos conexiones a cada controlador del par de HA.
