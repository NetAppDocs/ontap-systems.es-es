...
summary: Conecta tu shelf NS224 a tu sistema ASA A900 para que cada shelf tenga dos conexiones a cada controlador del par HA. 
---
= Conecta una bandeja NS224 a un sistema ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu shelf NS224 a tu sistema ASA A900 para que cada shelf tenga dos conexiones a cada controlador del par HA.
