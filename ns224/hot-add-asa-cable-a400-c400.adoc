...
summary: Conecta tu shelf NS224 a tu sistema ASA A400 o ASA C400 de modo que cada shelf tenga dos conexiones a cada controlador del par de HA. 
---
= Conectar un shelf NS224 a un sistema ASA A400 o ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu shelf NS224 a tu sistema ASA A400 o ASA C400 de modo que cada shelf tenga dos conexiones a cada controlador del par de HA.
