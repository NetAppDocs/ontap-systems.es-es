...
summary: Conecta tu shelf NS224 a tu sistema AFF A70, AFF A90 o AFF C80 de modo que cada shelf tenga dos conexiones a cada controlador en el par HA. 
---
= Cablea un shelf NS224 a tu sistema AFF A70, AFF A90 o AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu shelf NS224 a tu sistema AFF A70, AFF A90 o AFF C80 de modo que cada shelf tenga dos conexiones a cada controlador en el par HA.
