...
summary: Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de la estantería para tu sistema AFF. 
---
= Instala una bandeja NS224 en tu sistema AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de la estantería para tu sistema AFF.
...
.El futuro
Después de instalar tu estante, link:hot-add-aff-cable-overview.html["cablea tu shelf"].
