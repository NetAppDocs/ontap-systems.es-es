...
summary: Si desactivaste la asignación automática de unidades, asigna manualmente la propiedad de las unidades y vuelve a activar la asignación automática de unidades para tu sistema de fin de disponibilidad. 
---
= Completa la incorporación en caliente de la estantería NS224 para tu sistema al final de su disponibilidad
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
