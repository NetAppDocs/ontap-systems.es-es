...
summary: Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de estantería para tu sistema ASA. 
---
= Instala un estante NS224 en un sistema ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala la estantería NS224 en un armario o rack de telecomunicaciones, conecta los cables de alimentación y configura el ID de estantería para tu sistema ASA.
...
.El futuro
Después de instalar tu estante, link:hot-add-asa-cable-overview.html["cablea tu shelf"].
