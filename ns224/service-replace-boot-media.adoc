...
summary: Es posible sustituir un medio de arranque con fallos en una bandeja NS224. El reemplazo de los medios de arranque puede realizarse de forma no disruptiva, mientras la bandeja de unidades está encendida y las operaciones de I/o están en curso. 
---
= Sustituye el medio de arranque del NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
