...
summary: Conecta tu estantería NS224 a tu sistema AFF A700 para que cada estantería tenga dos conexiones a cada controlador del par HA. 
---
= Conectar una bandeja NS224 a un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema AFF A700 para que cada estantería tenga dos conexiones a cada controlador del par HA.
