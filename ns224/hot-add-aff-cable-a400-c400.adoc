...
summary: Conecta tu estantería NS224 a tu sistema AFF A400 o AFF C400 para que cada estantería tenga dos conexiones a cada controlador del par HA. 
---
= Conecta un shelf NS224 a un sistema AFF A400 o AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema AFF A400 o AFF C400 para que cada estantería tenga dos conexiones a cada controlador del par HA.



[[cable-shelf-to-an-a400-ha-pair]]
== Conecta el estante a un par A400 HA

Para un par A400 HA, puedes añadir en caliente hasta dos estantes y usar los puertos integrados e0c/e0d y los puertos de la ranura 5 según sea necesario.
...
== Conecta el estante a un par C400 HA

Para un par C400 HA, puedes añadir en caliente hasta dos estanterías y usar los puertos de las ranuras 4 y 5 según sea necesario.
