...
summary: Conecta tu estantería NS224 a tu sistema ASA A30 o ASA A50 para que cada estantería tenga dos conexiones a cada controlador del par HA. 
---
= Conecta una bandeja NS224 a un sistema ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu estantería NS224 a tu sistema ASA A30 o ASA A50 para que cada estantería tenga dos conexiones a cada controlador del par HA.

Puedes añadir en caliente hasta dos estanterías NS224 a un par ASA A30 o ASA A50 HA cuando necesites almacenamiento adicional (a la estantería interna).
