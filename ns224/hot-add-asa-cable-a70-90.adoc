...
summary: Conecta tu shelf NS224 a tu sistema ASA A70 o ASA A90 para que cada shelf tenga dos conexiones a cada controlador del par HA. 
---
= Conectar un shelf NS224 a un sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu shelf NS224 a tu sistema ASA A70 o ASA A90 para que cada shelf tenga dos conexiones a cada controlador del par HA.
