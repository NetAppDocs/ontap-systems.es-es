...
summary: Conecta tu shelf NS224 a tu sistema ASA A1K para que cada shelf tenga dos conexiones a cada controlador del par HA. 
---
= Conecta una bandeja NS224 a tu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecta tu shelf NS224 a tu sistema ASA A1K para que cada shelf tenga dos conexiones a cada controlador del par HA.
