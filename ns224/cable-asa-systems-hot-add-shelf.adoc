...
====
.Conecte el cable de la bandeja a ASA A20
[%collapsible]
====
Es posible agregar en caliente un máximo de una bandeja NS224 a un par de alta disponibilidad de ASA A20 cuando se necesite almacenamiento adicional (a la bandeja interna).
...
====
.Conecte el cable de la bandeja a ASA A30 o ASA A50
[%collapsible]
====
Puede agregar en caliente hasta dos bandejas NS224 a un par de alta disponibilidad ASA A30 o A50 cuando se necesite almacenamiento adicional (a la bandeja interna).
...
[%collapsible]
====
Cuando se necesita almacenamiento adicional, puede agregar en caliente un máximo de una bandeja NS224 a un par ASA A250 o ASA C250 de alta disponibilidad.
...
[%collapsible]
====
La forma de conectar la red de una bandeja NS224 por una adición en caliente depende de si tiene un par de alta disponibilidad ASA A400 o ASA C400.
...
[%collapsible]
====
La forma de conectar el cable de una bandeja NS224 en un par de alta disponibilidad ASA A800 o ASA C800 depende del número de bandejas añadidas en caliente y de la cantidad de conjuntos de puertos compatibles con RoCE (uno o dos) que se usan en las controladoras.
...
[%collapsible]
====
Cuando se necesita almacenamiento adicional, puede añadir hasta tres bandejas de unidades NS224 adicionales (con un total de cuatro bandejas) a un par de alta disponibilidad A900 de ASA.
