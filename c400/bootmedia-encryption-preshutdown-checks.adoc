...
---
= Comprueba el soporte de cifrado en el soporte de arranque de tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comprueba el soporte de cifrado en el soporte de arranque de tu sistema de almacenamiento AFF C400 antes de apagar el controlador afectado. Esto incluye verificar la compatibilidad de la versión de ONTAP con NetApp Volume Encryption (NVE) y confirmar la configuración del gestor de claves.
