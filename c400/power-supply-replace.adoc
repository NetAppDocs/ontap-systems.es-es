...
summary: 'Para sustituir una fuente de alimentación, es necesario desconectar la fuente de alimentación (PSU) de destino de la fuente de alimentación, desconectar el cable de alimentación, quitar la fuente de alimentación antigua e instalar la fuente de alimentación de reemplazo y, a continuación, volver a conectarla a la fuente de alimentación.' 
---
= Intercambia en caliente una fuente de alimentación en tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente la fuente de alimentación de tu sistema de almacenamiento AFF C400 para mantener un suministro continuo de energía sin interrumpir el servicio.
