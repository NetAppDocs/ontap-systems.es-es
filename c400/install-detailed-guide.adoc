...
---
= Instala un sistema AFF C400 siguiendo las instrucciones detalladas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y configura tu sistema de almacenamiento AFF C400 usando instrucciones paso a paso, desde el montaje en bastidor y el cableado hasta la puesta en marcha inicial del sistema.
