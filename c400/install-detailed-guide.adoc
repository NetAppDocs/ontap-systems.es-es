...
---
= Instala y configura un sistema AFF C400 usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y configura tu sistema de almacenamiento AFF C400 siguiendo la guía detallada, que ofrece instrucciones paso a paso, desde el montaje en bastidor y el cableado hasta la puesta en marcha inicial del sistema.
