...
summary: 'Debes sustituir un módulo DIMM en el módulo controlador cuando tu sistema registre un número creciente de códigos de corrección de errores (ECC) corregibles, o si no lo haces se produce un pánico en el sistema.' 
---
= Sustituye un módulo DIMM en tu sistema de almacenamiento AFF C400 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM de tu sistema de almacenamiento AFF C400 cuando el sistema detecte un número excesivo de errores ECC corregibles o un error ECC incorregible, lo cual suele deberse a una falla en un solo módulo DIMM.
