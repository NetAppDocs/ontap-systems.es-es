...
summary: Sustituye el controlador de tu sistema AFF C400 cuando un fallo de hardware lo requiera. Retira el controlador averiado, mueve sus componentes al controlador de reemplazo, instala el nuevo controlador y reinícialo. 
---
= Sustituye el controlador de tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF C400 cuando un fallo de hardware lo requiera. Retira el controlador averiado, mueve sus componentes al controlador de reemplazo, instala el nuevo controlador y reinícialo.
...
.El futuro
Después de reemplazar el controlador AFF C400 dañado, tienes que link:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"].
