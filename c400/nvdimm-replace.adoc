...
summary: Debes sustituir el NVDIMM en el módulo controlador cuando tu sistema registre que la vida útil de la memoria flash está a punto de finalizar o que el NVDIMM identificado no está en buen estado en general, o si no lo haces se produce un pánico en el sistema. 
---
= Sustituye un NVDIMM en tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un NVDIMM en tu sistema de almacenamiento AFF C400 cuando el sistema registre un número excesivo de errores ECC corregibles o un error ECC incorregible, lo que normalmente se debe a una falla en un solo NVDIMM.
