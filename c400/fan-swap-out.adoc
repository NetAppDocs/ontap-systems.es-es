...
---
= Cambia en caliente un módulo de ventilador en tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente un módulo de ventilador de tu sistema de almacenamiento AFF C400 sin interrumpir el servicio para mantener un flujo de aire adecuado y la refrigeración del sistema.
