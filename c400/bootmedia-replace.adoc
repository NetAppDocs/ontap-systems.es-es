...
summary: Para sustituir el soporte de arranque, debe retirar el módulo del controlador dañado, instalar el soporte de arranque de repuesto y transferir la imagen de inicio a una unidad flash USB. 
---
= Sustituye el soporte de arranque de tu sistema de almacenamiento AFF C400 usando el proceso manual de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el soporte de arranque de tu sistema de almacenamiento AFF C400 retirando el módulo de controlador con fallo, instalando el soporte de arranque de repuesto y transfiriendo la imagen de arranque usando una memoria USB.
