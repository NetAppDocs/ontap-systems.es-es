...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento AFF C400 una vez finalizadas las comprobaciones de cifrado y antes de sustituir el soporte de arranque.
