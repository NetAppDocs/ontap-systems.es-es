...
---
= Conoce cómo reemplazar el chasis de tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Infórmate sobre cómo sustituir el chasis de tu sistema de almacenamiento AFF C400. El procedimiento de sustitución del chasis consiste en trasladar todos los componentes del chasis averiado al chasis de recambio y es una operación disruptiva.
