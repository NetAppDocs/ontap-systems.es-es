...
summary: Especificaciones clave del sistema de almacenamiento AFF C400 
---
= Especificaciones clave para un sistema AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Las siguientes son especificaciones seleccionadas para el AFF C400.  Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para obtener una lista completa de las especificaciones del AFF C400 .  Esta página es un reflejo de un único par de alta disponibilidad.
...
| Ethernet de 100 Gbps | 24 


| Ethernet de 25 Gbps | 28 
