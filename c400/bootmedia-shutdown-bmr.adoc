...
summary: Apaga el controlador de tu sistema de almacenamiento AFF C400 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el soporte de arranque. 
---
= Apaga el controlador de tu sistema de almacenamiento AFF C400 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF C400 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el soporte de arranque.
