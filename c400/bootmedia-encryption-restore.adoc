...
summary: Restaure el cifrado en el soporte de arranque de reemplazo. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema de almacenamiento AFF C400 tras el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura el cifrado en el soporte de arranque de reemplazo de tu sistema de almacenamiento AFF C400 para asegurar un acceso seguro a los datos y el funcionamiento correcto del sistema.
