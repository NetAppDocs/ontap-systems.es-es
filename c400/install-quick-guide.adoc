...
---
= Instala y configura tu sistema de almacenamiento AFF C400 usando la guía rápida
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y configura tu sistema de almacenamiento AFF C400 usando la guía rápida, que ofrece instrucciones gráficas desde el montaje en bastidor y el cableado hasta la puesta en marcha inicial del sistema.
