...
summary: Tras instalar el nuevo dispositivo de arranque en su sistema AFF C400 , puede iniciar el proceso de recuperación automática del dispositivo de arranque para restaurar la configuración desde el nodo asociado. 
---
= Restaura la imagen de arranque en tu sistema de almacenamiento AFF C400 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
