...
---
= Recupera los agregados en una configuración de dos nodos de MetroCluster en tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la sustitución del soporte de arranque en tu sistema de almacenamiento AFF C400 en una configuración de dos nodos MetroCluster, realiza la operación de switchback de MetroCluster para restaurar la configuración a su estado operativo normal.
