...
summary: Mantenga el hardware de su sistema de almacenamiento AFF C400 para garantizar confiabilidad a largo plazo y un rendimiento óptimo. Realice tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, para evitar tiempos de inactividad y la pérdida de datos. 
---
= Infórmate sobre el mantenimiento de un sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mantenga el hardware de su sistema de almacenamiento AFF C400 para garantizar confiabilidad a largo plazo y un rendimiento óptimo. Realice tareas de mantenimiento periódicas, como la sustitución de componentes defectuosos, para evitar tiempos de inactividad y la pérdida de datos.

Los procedimientos de mantenimiento suponen que el sistema de almacenamiento AFF C400 ya se ha implementado como un nodo de almacenamiento en el entorno ONTAP .
...
Para el sistema de almacenamiento AFF C400, puede realizar procedimientos de mantenimiento en los componentes siguientes.
