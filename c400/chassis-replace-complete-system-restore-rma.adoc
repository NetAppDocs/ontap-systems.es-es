...
---
= Realiza la sustitución del chasis de tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de tu sistema de almacenamiento AFF C400 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente defectuoso a NetApp.
