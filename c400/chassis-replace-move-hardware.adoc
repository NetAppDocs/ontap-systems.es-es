...
---
= Sustituye el hardware del chasis de tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el hardware del chasis de tu sistema de almacenamiento AFF C400 moviendo los ventiladores, las unidades de disco duro y los módulos controladores del chasis averiado al chasis de reemplazo.
