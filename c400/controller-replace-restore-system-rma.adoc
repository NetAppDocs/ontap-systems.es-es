...
summary: 'Completa la sustitución del controlador para tu sistema AFF C400. Instala las licencias para el controlador de sustitución, confirma que las interfaces lógicas (LIF) están reportando a sus puertos de origen y realiza una comprobación del estado del clúster. Por último, devuelve la pieza averiada a NetApp.' 
---
= Completa la sustitución del controlador de un sistema AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador para tu sistema AFF C400. Instala las licencias para el controlador de sustitución, confirma que las interfaces lógicas (LIF) están reportando a sus puertos de origen y realiza una comprobación del estado del clúster. Por último, devuelve la pieza averiada a NetApp.
