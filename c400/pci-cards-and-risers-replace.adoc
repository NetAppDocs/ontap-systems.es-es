...
---
= Sustituye una tarjeta PCIe o mezzanine en tu sistema de almacenamiento AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para sustituir una tarjeta PCIe o mezzanine en tu sistema de almacenamiento AFF C400, desconecta los cables y los módulos SFP/QSFP de las tarjetas, reemplaza la tarjeta averiada y vuelve a realizar el cableado.
...
NOTE: Aprieta completamente los tornillos de mariposa de la tarjeta mezzanine. Si están flojos, puede que no se detecten los puertos e0e a e0h, que el LED parpadee continuamente y que los registros muestren un error de "cable no soportado".
