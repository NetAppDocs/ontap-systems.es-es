...
summary: Sustituye un DIMM en tu sistema AFF C800 si se detectan errores de memoria corregibles o no corregibles en exceso. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en tu sistema AFF C800 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
