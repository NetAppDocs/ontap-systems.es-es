...
---
= Instalar y configurar un sistema de almacenamiento AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y configura un sistema de almacenamiento AFF C800 usando el formato de contenido que mejor se adapte a tus necesidades: pasos rápidos, pasos en vídeo o pasos detallados.
