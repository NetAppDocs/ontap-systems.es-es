...
summary: Para restablecer el funcionamiento completo del sistema, debes restaurar la configuración de NetApp Storage Encryption si es necesario, instalar licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp. 
---
= Completa la sustitución del controlador de un sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
