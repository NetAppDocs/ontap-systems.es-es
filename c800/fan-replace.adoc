...
---
= Sustituir un ventilador en un sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de ventilador en su sistema AFF C800 cuando un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.  El proceso de reemplazo implica apagar el controlador dañado, quitarlo, reemplazar el módulo del ventilador, reinstalar el controlador y luego devolver la pieza defectuosa a NetApp.
...
Retira el módulo controlador del chasis cuando reemplaces el módulo controlador o reemplaces un componente dentro del módulo controlador.
