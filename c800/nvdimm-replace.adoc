...
summary: Sustituye el NVDIMM en tu sistema AFF C800 cuando tu sistema registre que la vida útil de la flash está a punto de terminar o que el NVDIMM identificado no está en buen estado en general. 
---
= Sustituir un módulo NVDIMM en tu sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el NVDIMM en su sistema AFF C800 cuando su sistema registre que la vida útil del flash está casi llegando a su fin o que el NVDIMM identificado no está en buen estado en general; no hacerlo provoca un pánico en el sistema.

.Antes de empezar
* Asegúrese de tener el NVDIMM de reemplazo que recibió de NetApp y que sea compatible con su sistema AFF C800 .
