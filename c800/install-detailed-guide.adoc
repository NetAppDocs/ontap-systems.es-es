...
---
= Instala y configura un sistema AFF C800 usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
link:../platform-supplemental/superrail-install.html["Instrucciones de instalación del kit SuperRail"]
