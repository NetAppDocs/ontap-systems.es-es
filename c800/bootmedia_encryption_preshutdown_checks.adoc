...
---
= Compruebe las claves de cifrado integradas: AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Si <lno-DARE> no se muestra en el resultado del comando y el sistema ejecuta ONTAP 9.5, vaya a. <<Checking NVE or NSE on systems running ONTAP 9.5 and later>>.
** Si <lno-DARE> no se muestra en el resultado del comando y el sistema está ejecutando ONTAP 9.6 o una versión posterior, vaya a. <<Checking NVE or NSE on systems running ONTAP 9.6 and later>>.
