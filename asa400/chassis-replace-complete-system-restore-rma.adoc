...
---
= Completa la sustitución del chasis de un sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de un sistema ASA A400 comprobando el estado de alta disponibilidad (HA), cambiando los agregados de vuelta si el sistema está en una configuración de dos nodos MetroCluster y enviando el chasis averiado de vuelta a NetApp.
