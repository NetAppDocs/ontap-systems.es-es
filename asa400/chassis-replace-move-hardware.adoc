...
---
= Sustituir el chasis en un sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Transfiere los componentes de hardware del chasis averiado al nuevo chasis y vuelve a instalar los módulos controladores en un sistema ASA A400.
