...
summary: Debes reemplazar el NVDIMM en el módulo controlador cuando tu sistema registre que la vida útil de la memoria flash está casi al final o que el NVDIMM identificado no está en buen estado en general para evitar el pánico del sistema. 
---
= Sustituir un módulo NVDIMM en tu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
