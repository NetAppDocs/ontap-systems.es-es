...
summary: Una vez que hayas completado la sustitución de la FRU en una configuración de dos nodos MetroCluster, puedes realizar la operación de conmutación MetroCluster. Esto devuelve la configuración a su estado operativo normal, con las máquinas virtuales de almacenamiento SVM de fuente sincronizada en el sitio que antes estaba afectado ahora activas y sirviendo datos desde los grupos de discos locales. 
---
= Recupera los agregados en una configuración de dos nodos de MetroCluster en tu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
