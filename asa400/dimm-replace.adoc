...
summary: Debes sustituir un módulo DIMM en el módulo controlador cuando tu sistema registre un número creciente de códigos de corrección de errores corregibles ECC para evitar el pánico del sistema. 
---
= Sustituye un módulo DIMM en tu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
