...
---
= Sustituya el hardware del módulo de la controladora - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_a400_empty_riser_remove.png[extracción de la tarjeta vertical vacía drw a400]
