...
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en tu sistema de almacenamiento AFF A400, verifica la compatibilidad y el estado de la clave de cifrado en tu medio de arranque antes de apagar el controlador. Verifica si tu versión de ONTAP es compatible con NetApp Volume Encryption (NVE) y confirma que el gestor de claves está activo.
