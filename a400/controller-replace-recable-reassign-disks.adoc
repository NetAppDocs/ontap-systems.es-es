...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema AFF A400 pueda reanudar su funcionamiento normal. 
---
= Vuelve a cablear el sistema y reasigna los discos en un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema AFF A400 pueda reanudar su funcionamiento normal.
