...
summary: Sustituye un DIMM en tu módulo controlador AFF A400 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituye un módulo DIMM en un sistema AFF A400 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en tu sistema AFF A400 cuando el sistema de almacenamiento detecte un número excesivo de errores de memoria corregibles (CECC) o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP.
