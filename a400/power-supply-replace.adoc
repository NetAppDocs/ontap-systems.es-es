...
summary: Sustituye una fuente de alimentación en tu sistema AFF A400 desconectando la PSU objetivo de la fuente de alimentación, desenchufando el cable de alimentación, retirando la PSU antigua, instalando la PSU de reemplazo y luego volviéndola a conectar a la fuente de alimentación. 
---
= Intercambia en caliente una fuente de alimentación en tu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la fuente de alimentación de tu sistema AFF A400 cuando falle o presente algún fallo. Las fuentes de alimentación son redundantes y se pueden sustituir en caliente, por lo que no es necesario apagar el controlador para realizar esta sustitución.
