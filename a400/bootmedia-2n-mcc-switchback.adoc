...
summary: Tras completar la sustitución de la FRU en una configuración de dos nodos MetroCluster, realiza la operación de conmutación MetroCluster para devolver la configuración a su estado operativo normal, con las máquinas virtuales de almacenamiento de origen sincronizado en el sitio anteriormente dañado ahora activas y sirviendo datos de los grupos de discos locales. 
---
= Recupera los agregados en una configuración de dos nodos de MetroCluster en tu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
