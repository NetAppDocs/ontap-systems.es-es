...
summary: Apaga el controlador de tu sistema de almacenamiento AFF A400 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el boot media. 
---
= Apaga el controlador en un sistema AFF A400 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF A400 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del soporte de arranque.
