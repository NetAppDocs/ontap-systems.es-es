...
---
= Sustituir una tarjeta PCIe o mezzanine en un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta PCIe o mezzanine en tu sistema AFF A400 cuando la tarjeta falle o necesite una actualización. El proceso de sustitución consiste en desconectar los cables y los módulos SFP o QSFP, reemplazar la tarjeta y volver a cablear.
