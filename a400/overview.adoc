...
---
= Especificaciones clave para un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta algunas especificaciones del AFF A400. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para ver una lista completa de las especificaciones del AFF A400. Esta página se refiere a un único par de alta disponibilidad.
