...
Después de sustituir un DIMM del sistema en el sistema, debe ejecutar pruebas de diagnóstico en ese componente.
...
. En el aviso del CARGADOR, acceda a los controladores especiales diseñados específicamente para el diagnóstico para funcionar correctamente: `boot_diags`
...
. Seleccione una opción en el submenú que aparece y ejecute la prueba.
