...
---
= Instala un sistema AFF A400 siguiendo las instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A400 usando estas instrucciones detalladas paso a paso, desde la preparación del sitio hasta la puesta en marcha del clúster ONTAP.
...
NOTE: Si las etiquetas de los puertos de la tarjeta no son visibles, comprueba la orientación de instalación de la tarjeta. El conector PCIe se encuentra en el lado izquierdo de la ranura de la tarjeta en los modelos A400 y FAS8300/8700. Luego busca la tarjeta por número de pieza en el  https://hwu.netapp.com["Hardware Universe de NetApp"^] para ver un gráfico del frontal que muestra las etiquetas de los puertos. Puedes encontrar el número de pieza de la tarjeta usando el comando  `sysconfig -a` o en la lista de embalaje del sistema.
...
Puedes conectar tanto los módulos NS224 como los SAS a tu sistema.
