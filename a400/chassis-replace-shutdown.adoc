...
---
= Apaga tus controladores AFF A400 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema de almacenamiento AFF A400 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el chasis.
