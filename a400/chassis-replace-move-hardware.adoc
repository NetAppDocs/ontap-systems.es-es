...
---
= Sustituye el chasis en un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A400 cuando un fallo de hardware lo requiera. El proceso de sustitución implica mover los ventiladores, las unidades y los módulos controladores del chasis averiado al chasis de reemplazo.
