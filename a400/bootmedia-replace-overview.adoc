...
summary: El medio de arranque almacena un conjunto primario y secundario de archivos de sistema que el sistema utiliza cuando arranca. 
---
= Revisa los requisitos para reemplazar el soporte de arranque en tu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
