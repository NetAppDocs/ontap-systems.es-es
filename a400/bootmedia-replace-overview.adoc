...
[role="lead"]
Antes de sustituir el soporte de arranque en tu sistema AFF A400, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye tener una memoria USB formateada en FAT32 con suficiente almacenamiento para la imagen de recuperación de ONTAP y determinar si tu sustitución será sin interrupciones o con interrupciones.
