...
summary: Sustituye el NVDIMM de tu módulo controlador AFF A400 cuando el sistema registre que la vida útil de la memoria flash está a punto de finalizar o que el NVDIMM identificado no está en buen estado. No reemplazar un NVDIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituye el NVDIMM de tu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el NVDIMM en tu sistema AFF A400 cuando tu sistema registre que la vida útil de la memoria flash está casi al final o que el NVDIMM no está en buen estado. Si no lo reemplazas, puede causar un pánico del sistema.
