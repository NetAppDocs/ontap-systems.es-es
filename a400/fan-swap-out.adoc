...
---
= Intercambia en caliente un módulo de ventilador en un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de un módulo de ventilador de tu sistema AFF A400 para mantener una refrigeración adecuada. El módulo de ventilador debe sustituirse en un plazo de dos minutos tras su extracción para evitar el sobrecalentamiento.
