...
summary: Debes localizar el medio de arranque en el módulo controlador y luego seguir las instrucciones para reemplazarlo. 
---
= Sustituye el soporte de arranque en un sistema AFF A400 durante el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El soporte de arranque de tu sistema AFF A400 almacena datos esenciales de firmware y configuración. El proceso de sustitución consiste en quitar el módulo controlador, quitar el soporte de arranque dañado, instalar el soporte de arranque de repuesto y luego transferir la imagen de ONTAP al soporte de arranque de repuesto usando una memoria USB.
