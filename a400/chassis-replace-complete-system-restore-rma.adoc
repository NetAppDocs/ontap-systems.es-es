...
---
= Completa la sustitución del chasis de un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comprueba el estado de alta disponibilidad (HA) del chasis y devuelve la pieza defectuosa a NetApp para completar la sustitución del chasis de tu sistema AFF A400.
