...
---
= Sustituye la batería del NVDIMM en un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería del NVDIMM de tu sistema AFF A400 cuando empiece a perder carga o falle. El proceso de sustitución consiste en quitar el módulo controlador, cambiar la batería y volver a instalar el módulo controlador.
