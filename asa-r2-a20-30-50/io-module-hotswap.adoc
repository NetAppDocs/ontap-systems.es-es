...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Sustituye en caliente un módulo de E/S en tu sistema ASA A20, ASA A30 o ASA A50 sin necesidad de apagarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
