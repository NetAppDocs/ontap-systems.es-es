...
summary: Reemplace un módulo de ventilador en su sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.  El proceso de reemplazo implica apagar el controlador, quitarlo, reemplazar el ventilador, reinstalar el controlador y devolver la pieza defectuosa a NetApp. 
---
= Intercambia en caliente un módulo de ventilador en tu sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un módulo de ventilador en su sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar la refrigeración del sistema y el rendimiento general.  El proceso de reemplazo implica apagar el controlador, quitarlo, reemplazar el ventilador, reinstalar el controlador y devolver la pieza defectuosa a NetApp.
