...
summary: Sustituya un módulo de ventiladores en su sistema ASA A20, ASA A30 o ASA A50 si un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp. 
---
...
[role="lead"]
Sustituya un módulo de ventiladores en su sistema ASA A20, ASA A30 o ASA A50 si un ventilador falla o no funciona de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
