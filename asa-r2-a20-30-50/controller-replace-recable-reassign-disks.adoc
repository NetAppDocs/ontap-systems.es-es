...
summary: Devuelve el control de los recursos de almacenamiento al controlador de reemplazo para que tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 pueda reanudar su funcionamiento normal. El procedimiento de devolución varía según el tipo de cifrado que use tu sistema. 
---
= Devuelve el controlador en tu sistema ASA A20, ASA A30 o ASA A50 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema de almacenamiento ASA A20, ASA A30 o ASA A50 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado, cifrado mediante el Administrador de claves integrado (OKM) o cifrado mediante el Administrador de claves externo (EKM).
