...
summary: Mueva el bisel, las unidades y los módulos de controladora del chasis dañado al nuevo chasis, e intercambie el chasis dañado del rack de equipos o el armario del sistema con el nuevo chasis del mismo modelo que el chasis dañado. 
---
