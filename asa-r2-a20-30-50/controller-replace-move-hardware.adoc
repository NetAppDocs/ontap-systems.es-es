...
summary: Reemplace el controlador de su sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando una falla de hardware lo requiera.  El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo. 
---
= Sustituye el controlador en tu sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador de su sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando una falla de hardware lo requiera.  El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
CAUTION: Antes de cerrar la cubierta del controlador dañado, asegúrate de que las lengüetas eyectoras de todas las ranuras DIMM vacías vuelven a la posición de bloqueo.
