...
summary: 'Restaure la configuración de cifrado de almacenamiento de NetApp (si es necesario), instale licencias para la controladora de reemplazo, compruebe que las interfaces lógicas (LIF) están informando a su puerto de inicio, realice una comprobación del estado del clúster, registre el número de serie de la controladora de reemplazo y devuelva la pieza fallida a ASA para completar el paso final en el procedimiento de sustitución de la controladora ASA A20, ASA A30 o NetApp A50.' 
---
...
[role="lead"]
Restaure la configuración de cifrado de almacenamiento de NetApp (si es necesario), instale licencias para la controladora de reemplazo, compruebe que las interfaces lógicas (LIF) están informando a su puerto de inicio, realice una comprobación del estado del clúster, registre el número de serie de la controladora de reemplazo y devuelva la pieza fallida a ASA para completar el paso final en el procedimiento de sustitución de la controladora ASA A20, ASA A30 o NetApp A50.
