...
summary: Sustituye una fuente de alimentación de CA o CC en tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. 
---
= Intercambia en caliente una fuente de alimentación en un sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
