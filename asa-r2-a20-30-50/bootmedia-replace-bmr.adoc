...
summary: El medio de arranque de su sistema ASA A20, ASA A30 o ASA A50 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo controlador, retirar el medio de arranque dañado, instalar el nuevo medio de arranque y, finalmente, reinstalar el módulo controlador. 
---
= Sustituya el soporte de arranque: ASA A20, ASA A30 y ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El medio de arranque de su sistema ASA A20, ASA A30 o ASA A50 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica retirar el módulo controlador, retirar el medio de arranque dañado, instalar el nuevo medio de arranque y, finalmente, reinstalar el módulo controlador.
