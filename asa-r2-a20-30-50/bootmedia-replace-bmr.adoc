...
[role="lead"]
Para sustituir el soporte de arranque, debe retirar la controladora deteriorada, extraer el soporte de arranque dañado y, a continuación, instalar el soporte de arranque de repuesto en la controladora afectada.
