...
summary: Reemplace la batería NV en su sistema ASA A20, ASA A30 o ASA A50 cuando la batería comience a perder carga o falla, ya que es responsable de preservar los datos críticos del sistema durante cortes de energía. 
---
