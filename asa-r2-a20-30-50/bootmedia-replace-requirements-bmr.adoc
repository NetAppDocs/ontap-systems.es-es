...
summary: Antes de sustituir el medio de arranque en tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50, asegúrate de cumplir con los requisitos y consideraciones necesarios para una sustitución exitosa. Esto incluye verificar que tienes el medio de arranque de reemplazo correcto, confirmar que el puerto e0M en el controlador con problemas funciona correctamente y determinar si Onboard Key Manager o External Key Manager están habilitados. 
---
= Revisa los requisitos para la recuperación automática del soporte de arranque en un sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
