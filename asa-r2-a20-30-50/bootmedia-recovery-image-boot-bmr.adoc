...
summary: Después de instalar el nuevo dispositivo multimedia de arranque en el sistema de almacenamiento ASA A20, ASA A30 o ASA A50, puede iniciar el proceso de recuperación de medios de arranque automático para restaurar la configuración desde el nodo en buen estado. 
---
= Restaure la imagen ONTAP en el medio de arranque: ASA A20, ASA A30 y ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el nuevo dispositivo multimedia de arranque en el sistema de almacenamiento ASA A20, ASA A30 o ASA A50, puede iniciar el proceso de recuperación de medios de arranque automático para restaurar la configuración desde el nodo en buen estado.
...
.. Vaya al paso 6 para volver a habilitar la devolución automática si estaba deshabilitada.
...
. Restaure el administrador de claves utilizando el procedimiento adecuado para su configuración:
+
[role="tabbed-block"]
====
