...
Puede añadir un módulo de I/O a los sistemas de almacenamiento ASA A20, ASA A30 y ASA A50 cuando haya ranuras disponibles o cuando todas estén completamente ocupadas.
