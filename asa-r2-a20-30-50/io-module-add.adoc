...
[role="lead"]
Añada un módulo I/O a su sistema ASA A20, ASA A30 o ASA A50 para mejorar la conectividad de la red y ampliar la capacidad de su sistema para manejar el tráfico de datos.
