...
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema ASA A20, ASA A30 o ASA A50 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
