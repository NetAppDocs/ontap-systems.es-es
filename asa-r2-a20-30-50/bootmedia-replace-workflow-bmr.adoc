...
---
= Flujo de trabajo para la sustitución de los medios de arranque ASA A20, ASA A30 y ASA A50 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
