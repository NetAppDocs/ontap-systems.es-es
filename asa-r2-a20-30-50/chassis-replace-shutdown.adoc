...
summary: Apague las controladoras del sistema de almacenamiento ASA A20, ASA A30 o ASA A50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el chasis 
---
= Apague las controladoras para reemplazar el chasis: ASA A20, ASA A30 y ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras del sistema de almacenamiento ASA A20, ASA A30 o ASA A50 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el chasis.
