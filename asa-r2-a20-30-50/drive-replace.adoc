...
summary: Es posible sustituir una unidad SSD con error de forma no disruptiva mientras hay operaciones de I/O en curso. 
---
= Reemplazar unidad: ASA A20, ASA A30 y ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
