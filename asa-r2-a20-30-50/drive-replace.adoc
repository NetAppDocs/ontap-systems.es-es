...
summary: Sustituye en caliente una unidad de tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando una unidad tenga error o sea necesario actualizarla. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad en un sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema de almacenamiento ASA A20, ASA A30 o ASA A50 cuando una unidad tenga error o sea necesario actualizarla. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.

Puedes realizar un intercambio en caliente de una unidad sin interrupciones mientras las operaciones de E/S están en curso.
