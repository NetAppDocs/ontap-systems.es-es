...
---
= Apaga el controlador defectuoso en un sistema AFF A320 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A320 antes de sustituirlo, tomando el control y deteniéndolo hasta que aparezca el indicador «LOADER».
