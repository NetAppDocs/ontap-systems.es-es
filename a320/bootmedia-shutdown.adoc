...
summary: Después de completar las tareas NVE o NSE, debe completar el apagado del nodo dañado. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Apaga el controlador defectuoso de tu sistema AFF A320 durante el proceso de recuperación del arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
