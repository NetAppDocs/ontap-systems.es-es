...
summary: El medio de arranque almacena un conjunto primario y secundario de archivos de imagen de arranque que el sistema utiliza cuando arranca. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Sustituye el soporte de arranque de tu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
