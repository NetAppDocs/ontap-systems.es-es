...
summary: Sustituye una fuente de alimentación en tu sistema AFF A320 desconectando la PSU de destino de la fuente de alimentación, desenchufando el cable de alimentación, retirando la PSU antigua, instalando la PSU de reemplazo y luego volviendo a conectar la PSU de reemplazo a la fuente de alimentación. 
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente una fuente de alimentación en tu sistema AFF A320 desconectando, retirando y reemplazando la unidad averiada, y luego vuelve a conectarla para restaurar la energía.
