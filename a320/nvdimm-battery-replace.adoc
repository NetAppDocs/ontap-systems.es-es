...
---
= Sustituye la batería del NVDIMM en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplaza la batería del NVDIMM en tu sistema AFF A320 quitando el módulo controlador, cambiando la batería y volviendo a instalar el módulo controlador.
