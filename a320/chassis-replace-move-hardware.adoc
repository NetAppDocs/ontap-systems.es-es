...
---
= Sustituye el chasis en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A320 moviendo los ventiladores, los discos duros y los módulos controladores del chasis averiado al chasis de reemplazo.
