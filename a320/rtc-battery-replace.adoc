...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador AFF A320 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituir la batería del reloj en tiempo real en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A320 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
