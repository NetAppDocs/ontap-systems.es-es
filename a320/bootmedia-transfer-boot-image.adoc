...
summary: El medio de arranque de reemplazo que instaló no tiene una imagen de arranque, por lo que debe transferir una imagen de arranque usando una unidad flash USB. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Transfiere la imagen de arranque al soporte de arranque de tu sistema AFF A320 usando una memoria USB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
