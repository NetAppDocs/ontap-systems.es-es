...
summary: Sustituye el NVDIMM de tu módulo controlador AFF A320 cuando el sistema registre que la vida útil de la memoria flash está a punto de finalizar o que el NVDIMM identificado no está en buen estado. No reemplazar un NVDIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituir un módulo NVDIMM en tu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un NVDIMM en tu sistema AFF A320 cuando el sistema detecte que la vida útil de la flash está casi al final o que el NVDIMM identificado no está en buen estado. No reemplazar un NVDIMM defectuoso puede causar un pánico del sistema.
