...
summary: Debe iniciar la imagen ONTAP desde la unidad USB, restaurar el sistema de archivos y verificar las variables ambientales. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Arranca la imagen de recuperación en tu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
