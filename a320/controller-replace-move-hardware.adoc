...
---
= Sustituir el controlador en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A320 quitando el controlador con fallos, moviendo los componentes FRU al módulo de reemplazo, instalándolo en el chasis y arrancando en modo de mantenimiento.
