...
---
= Vuelve a cablear el sistema y reasigna los discos en un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF A320 recableando el almacenamiento y confirmando la reasignación de los discos.
