...
summary: Después de verificar las variables de entorno, debe completar los pasos específicos de los sistemas que tienen Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption habilitados. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
