...
summary: Antes de apagar el controlador dañado y verificar el estado de las claves de cifrado integradas, debe verificar el estado del controlador dañado, deshabilitar la devolución automática y verificar qué versión de ONTAP está ejecutando el sistema. El sistema AFF A320 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
