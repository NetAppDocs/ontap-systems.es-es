...
---
= Sustituir una tarjeta PCIe en tu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta PCIe en tu sistema AFF A320 desconectando los cables y los módulos SFP/QSFP, retirando el adaptador vertical, cambiando la tarjeta y volviendo a conectar los cables.
...
image::../media/drw_a320_pci_card_replace_animated_gif.png[Sustituya una tarjeta PCI]
