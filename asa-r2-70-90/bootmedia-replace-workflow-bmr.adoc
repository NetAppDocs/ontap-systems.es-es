...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Dos"]link:bootmedia-shutdown-asa-r2.html["Apague el controlador dañado"]
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Cuatro"]link:bootmedia-recovery-image-boot-bmr.html["Restauración de imagen en soporte de arranque (recuperación automática del arranque)"]
[role="quick-margin-para"]
