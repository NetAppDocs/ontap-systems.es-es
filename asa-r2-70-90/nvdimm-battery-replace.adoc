...
Apague o tome el control de la controladora dañada. - Para apagar el controlador dañado, debe determinar el estado del controlador y, si es necesario, tomar el control del controlador para que el controlador en buen estado continúe sirviendo datos del almacenamiento del controlador dañado.
