...
summary: Reemplace el chasis del sistema ASA A70 o ASA A90 cuando se produzca un error de hardware o actualización que lo requiera. Este proceso implica apagar el sistema, quitar el chasis existente, instalar el nuevo y reconfigurar los componentes para garantizar un funcionamiento adecuado del sistema. 
---
...
[role="lead"]
Reemplace el chasis del sistema ASA A70 o ASA A90 cuando se produzca un error de hardware o actualización que lo requiera. Este proceso implica apagar el sistema, quitar el chasis existente, instalar el nuevo y reconfigurar los componentes para garantizar un funcionamiento adecuado del sistema.
