...
---
= Sustituye la NVRAM de tu sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace la NVRAM en su sistema ASA A70 o ASA A90 cuando la memoria no volátil se vuelva defectuosa o requiera una actualización.  El proceso de reemplazo implica apagar el controlador dañado, quitar completamente la energía tirando del controlador unos centímetros hacia afuera, reemplazar el módulo NVRAM o el DIMM NVRAM , reasignar los discos y devolver la parte defectuosa a NetApp.
