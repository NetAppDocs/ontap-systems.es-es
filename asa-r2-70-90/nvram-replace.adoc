...
[role="lead"]
Sustituya el NVRAM en su sistema ASA A70 o ASA A90 cuando la memoria no volátil falle o necesite una actualización. El proceso de sustitución implica apagar la controladora deteriorada, sustituir el módulo NVRAM o NVRAM DIMM, reasignar los discos y devolver la pieza averiada a NetApp.
