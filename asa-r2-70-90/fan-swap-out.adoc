...
summary: Sustituya un módulo de ventilador del sistema ASA A70 o ASA A90 si se produce un error en un ventilador o no está funcionando de forma eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general. 
---
...
[role="lead"]
Sustituya un módulo de ventilador del sistema ASA A70 o ASA A90 si se produce un error en un ventilador o no está funcionando de forma eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general.
