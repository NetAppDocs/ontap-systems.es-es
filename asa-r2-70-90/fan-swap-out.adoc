...
summary: Sustituya un módulo de ventiladores en su sistema ASA A70 o ASA A90 cuando se produzca un error en un ventilador o no esté funcionando de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp. 
---
= Sustituye un módulo de ventilador en tu sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya un módulo de ventiladores en su sistema ASA A70 o ASA A90 cuando se produzca un error en un ventilador o no esté funcionando de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
