...
Puede añadir un módulo de I/O al sistema de almacenamiento ASA A70 y ASA A90 cuando haya ranuras vacías disponibles o cuando todas estén completamente ocupadas.
