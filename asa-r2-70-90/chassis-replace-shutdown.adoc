...
summary: Apague las controladoras en su sistema de almacenamiento ASA A70 o ASA A90 cuando necesite reemplazar el chasis. Es crucial apagar las controladoras con seguridad para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
= Apague los controladores: ASA A70 y ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras en su sistema de almacenamiento ASA A70 o ASA A90 cuando necesite reemplazar el chasis. Es crucial apagar las controladoras con seguridad para evitar la pérdida de datos y garantizar la estabilidad del sistema.
