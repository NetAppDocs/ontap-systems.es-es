...
summary: Apague las controladoras de su sistema de almacenamiento ASA A70 o ASA A90 para evitar la pérdida de datos y garantizar la estabilidad del sistema cuando reemplace el chasis. 
---
= Apague las controladoras para reemplazar el chasis: ASA A70 y ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras de su sistema de almacenamiento ASA A70 o ASA A90 para evitar la pérdida de datos y garantizar la estabilidad del sistema cuando reemplace el chasis.
...
.El futuro
Una vez apagadas las controladoras, debe link:chassis-replace-move-hardware.html["sustituya el chasis"].
