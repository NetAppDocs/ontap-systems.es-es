...
---
= Sustituye un módulo de E/S en tu sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puede utilizar este procedimiento con todas las versiones de ONTAP compatibles con su sistema de almacenamiento.
