...
---
= Sustituye el controlador en un sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de haber reemplazado el controlador ASA A70 o ASA A90 defectuoso, deberálink:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"] .
