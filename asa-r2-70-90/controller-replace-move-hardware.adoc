...
summary: Reemplace la controladora en su sistema ASA A70 o ASA A90 cuando se produzca un error de hardware o actualización que lo requiera. Este proceso implica retirar la controladora dañada, mover los componentes a la controladora de reemplazo, instalar la controladora de reemplazo y reiniciar el sistema. 
---
...
[role="lead"]
Reemplace la controladora en su sistema ASA A70 o ASA A90 cuando se produzca un error de hardware o actualización que lo requiera. Este proceso implica retirar la controladora dañada, mover los componentes a la controladora de reemplazo, instalar la controladora de reemplazo y reiniciar el sistema.
