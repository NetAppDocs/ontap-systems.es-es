...
---
= Apague el controlador: ASA A70 y ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar las tareas de NVE o NSE, deberá completar el apagado de la controladora dañada. Apague o tome el control de la controladora dañada.
