...
summary: Sustituya el módulo de gestión del sistema en el sistema ASA A70 o ASA A90 cuando presente defectos o que el firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp. 
---
= Sustituir el módulo de administración de sistemas en un sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya el módulo de gestión del sistema en el sistema ASA A70 o ASA A90 cuando presente defectos o que el firmware esté dañado. El proceso de reemplazo implica apagar la controladora, reemplazar el módulo de gestión del sistema con errores, reiniciar la controladora, actualizar las claves de licencia y devolver la parte con error a NetApp.
...
WARNING: El módulo de administración de sistemas no es intercambiable en caliente. Antes de sustituirlo, vuelve a colocar las unidades, apaga el nodo, desconecta la alimentación del controlador y saca el controlador unas pulgadas del chasis.
