...
summary: Si el medio de arranque del sistema ASA A70 o ASA A90 está dañado, puede iniciar la imagen de recuperación, restaurar la configuración desde el nodo asociado y verificar las variables de entorno. 
---
