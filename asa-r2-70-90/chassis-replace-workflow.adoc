...
summary: Comience a sustituir el chasis de su sistema de almacenamiento ASA A70 o ASA A90 apagando las controladoras, quitando y reemplazando el chasis, y verificando operaciones del sistema. 
---
...
[role="lead"]
Comience a sustituir el chasis de su sistema de almacenamiento ASA A70 o ASA A90 apagando las controladoras, quitando y reemplazando el chasis, y verificando operaciones del sistema.
