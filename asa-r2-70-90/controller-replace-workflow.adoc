...
summary: Para comenzar a sustituir la controladora de su sistema de almacenamiento ASA A70 o ASA A90, apague la controladora dañada. Para ello, retire y sustituya la controladora, restaure la configuración del sistema y devuelva el control de los recursos de almacenamiento a la controladora de reemplazo. 
---
= Flujo de trabajo para reemplazar el controlador ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para comenzar a sustituir la controladora de su sistema de almacenamiento ASA A70 o ASA A90, apague la controladora dañada. Para ello, retire y sustituya la controladora, restaure la configuración del sistema y devuelva el control de los recursos de almacenamiento a la controladora de reemplazo.
