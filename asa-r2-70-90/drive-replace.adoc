...
summary: Sustituye en caliente una unidad de tu sistema ASA A70 o ASA A90 cuando una unidad con error falle o requiera una actualización. Este proceso consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad SSD en un sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema ASA A70 o ASA A90 cuando una unidad con error falle o requiera una actualización. Este proceso consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema.
