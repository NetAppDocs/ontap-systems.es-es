...
summary: Restaure la imagen de ONTAP en el soporte de arranque de reemplazo en su sistema ASA A1K. El proceso implica iniciar el proceso de recuperación de arranque desde el aviso de Loader y supervisar el proceso de recuperación hasta que se completa y se reinicia el nodo. 
---
= Restaurar la imagen ONTAP en el medio de arranque - ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el nuevo dispositivo multimedia de arranque en el sistema ASA A1K, puede iniciar el proceso de recuperación de medios de arranque automático para restaurar la configuración desde el nodo asociado.
