...
summary: Devolver el control de los recursos de almacenamiento a la controladora de reemplazo para que su sistema ASA A1K pueda reanudar el funcionamiento normal. 
---
= Devuelve el controlador en tu sistema ASA A1K para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devolver el control de los recursos de almacenamiento a la controladora de reemplazo para que su sistema ASA A1K pueda reanudar el funcionamiento normal. El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado o cifrado mediante Onboard Key Manager (OKM).
