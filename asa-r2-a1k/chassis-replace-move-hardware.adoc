...
summary: Sustituye el chasis de tu sistema ASA A1K cuando un fallo de hardware lo requiera. El proceso de sustitución implica retirar el controlador, las tarjetas de E/S, el módulo NVRAM12, el módulo de administración de sistemas y las fuentes de alimentación, instalar el chasis de sustitución y volver a instalar los componentes del chasis. 
---
= Sustituye el chasis de tu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
