...
summary: Agregue un módulo de E/S a su sistema ASA A1K para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos. 
---
= Agrega un módulo de I/O a un sistema ASA A1K para mejorar la conectividad de red
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agregue un módulo de E/S a su sistema ASA A1K para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Puede añadir un módulo de I/O al sistema de almacenamiento ASA A1K cuando haya ranuras vacías o cuando todas estén completamente ocupadas. . Acerca de esta tarea
