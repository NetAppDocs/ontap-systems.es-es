...
summary: Reemplace un módulo de ventilador defectuoso o averiado en su sistema ASA A1K para mantener un enfriamiento adecuado y evitar problemas de rendimiento del sistema.  Los ventiladores son intercambiables en caliente y se pueden reemplazar sin apagar el sistema. 
---
= Intercambia en caliente un ventilador en un sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
