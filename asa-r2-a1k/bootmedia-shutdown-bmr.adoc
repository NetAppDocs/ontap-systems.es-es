...
summary: Apague la controladora deteriorada en su sistema de almacenamiento ASA A1K para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir los medios de arranque. 
---
...
[role="lead"]
Apague la controladora deteriorada en su sistema de almacenamiento ASA A1K para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir los medios de arranque.
