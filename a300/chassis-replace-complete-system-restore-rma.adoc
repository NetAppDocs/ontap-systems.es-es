...
---
= Completa la sustitución del chasis de un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Finaliza la sustitución del chasis de tu sistema AFF A300 comprobando el estado de HA del chasis, cambiando de nuevo los agregados si es necesario y devolviendo el componente defectuoso a NetApp.
