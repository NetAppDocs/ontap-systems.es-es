...
summary: Para restablecer el funcionamiento completo de tu sistema AFF A300, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF A300 restableciendo la configuración de cifrado de almacenamiento de NetApp (si es necesario), instalando licencias para el nuevo controlador y devolviendo la unidad con error a NetApp.
