...
summary: Restaura la encriptación en el medio de arranque de reemplazo. Completa los pasos específicos para los sistemas que tienen activado Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption. El sistema AFF A300 solo admite procedimientos manuales de recuperación de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurar el cifrado en el medio de arranque de reemplazo. El sistema AFF A300 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
