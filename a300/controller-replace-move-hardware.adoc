...
---
= Sustituye el controlador de tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A300 retirando el controlador defectuoso, moviendo los componentes FRU al módulo de reemplazo, instalándolo en el chasis e iniciando en modo de mantenimiento.
