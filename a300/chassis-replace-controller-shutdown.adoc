...
summary: Para sustituir el chasis, debe apagar la controladora. Este procedimiento es disruptivo. En el caso de un clúster de dos nodos, tendrá una interrupción del servicio completa y una interrupción parcial en un clúster de varios nodos. 
---
...
[role="lead"]
Debe apagar las controladoras antes de sustituir el chasis.
...
== Opción 2: Las controladoras están en un MetroCluster de dos nodos
