...
---
= Sustituir una tarjeta PCIe en tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta PCIe en tu sistema AFF A300 desconectando los cables, retirando la tarjeta, instalando la de reemplazo y volviendo a conectar los cables.
