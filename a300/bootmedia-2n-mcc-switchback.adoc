...
summary: Tras completar la sustitución del medio de arranque en una configuración de dos nodos MetroCluster, realiza la operación de conmutación MetroCluster para devolver la configuración a su estado operativo normal. El sistema AFF A300 solo admite procedimientos manuales de recuperación del medio de arranque. 
---
= Cambia de nuevo los agregados en una configuración de dos nodos de MetroCluster para tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
