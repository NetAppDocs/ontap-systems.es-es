...
[role="lead"]
El procedimiento para arrancar el controlador dañado de la imagen de recuperación depende de si el sistema está en una configuración de MetroCluster de dos controladoras.
