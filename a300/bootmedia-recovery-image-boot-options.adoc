...
summary: El procedimiento para iniciar el controlador dañado desde la imagen de recuperación depende de si el sistema está en una configuración MetroCluster de dos nodos. El sistema AFF A300 solo admite procedimientos de recuperación de medios de arranque manuales. 
---
= Arranca la imagen de recuperación en un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El procedimiento para iniciar el controlador dañado desde la imagen de recuperación depende de si el sistema está en una configuración MetroCluster de dos controladores. El sistema AFF A300 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
