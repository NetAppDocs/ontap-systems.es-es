...
---
= Cambia un ventilador intercambiable en caliente en tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente un módulo de ventilador en tu sistema AFF A300 sin interrumpir el servicio para mantener un flujo de aire adecuado y la refrigeración del sistema.
