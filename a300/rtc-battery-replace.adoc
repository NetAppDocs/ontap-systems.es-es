...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador AFF A300 para asegurarte de que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A300 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
...
+
image::../media/drw_rxl_rtc_battery.png[Retire o sustituya la batería del RTC]
