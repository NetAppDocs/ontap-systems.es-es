...
---
= Apaga el controlador defectuoso de un sistema AFF A300 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A300 antes de reemplazarlo, usando el procedimiento adecuado para tu configuración.
