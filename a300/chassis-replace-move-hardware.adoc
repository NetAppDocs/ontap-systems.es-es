...
---
= Sustituye el chasis en un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A300 moviendo las fuentes de alimentación, los ventiladores y los módulos controladores del chasis averiado al chasis de reemplazo.
