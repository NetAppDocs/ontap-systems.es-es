...
summary: 'El medio de arranque almacena un conjunto primario y secundario de archivos de sistema (imagen de arranque) que el sistema utiliza cuando arranca. El sistema AFF A300 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. Dependiendo de la configuración de su red, puede realizar un reemplazo disruptivo o no disruptivo.' 
---
