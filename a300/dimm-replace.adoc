...
summary: Sustituye un módulo DIMM de tu módulo controlador AFF A300 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. Si no sustituyes un módulo DIMM defectuoso, puede producirse un pánico en el sistema. 
---
= Sustituye un módulo DIMM en tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema AFF A300 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC no corregible, lo cual normalmente es causado por una falla en un solo DIMM.
...
== Paso 5: (Solo MetroCluster de dos nodos): Vuelva a conmutar los agregados
