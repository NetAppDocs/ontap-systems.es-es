...
---
= Vuelve a cablear el sistema y reasigna los discos en tu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Finaliza la sustitución del controlador de tu sistema AFF A300 volviendo a cablear el almacenamiento y confirmando la reasignación de los discos.
