...
summary: Apaga el controlador de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el chasis. 
---
= Apaga los controladores AFX 2K para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el chasis.
