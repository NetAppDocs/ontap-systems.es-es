...
summary: Apaga el controlador de tu sistema de almacenamiento afx 2k para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el chasis. 
---
= Apaga el controlador para sustituir el chasis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
