...
summary: Puedes realizar un intercambio en caliente de un módulo de E/S Ethernet en tu sistema de almacenamiento afx 2k si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Intercambio en caliente de un módulo de E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
