...
summary: Sustituye la batería del reloj en tiempo real de tu sistema de almacenamiento AFX 2K para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Cambia la batería del reloj en tiempo real de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería del reloj en tiempo real (RTC), conocida comúnmente como pila de botón, en tu sistema de almacenamiento AFX 2K para asegurarte de que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
