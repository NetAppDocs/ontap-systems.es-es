...
summary: Cambia la batería del reloj en tiempo real de tu sistema de almacenamiento afx 2k para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando correctamente. 
---
= Reemplaza la batería del reloj en tiempo real - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
