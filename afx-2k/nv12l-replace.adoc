...
summary: Sustituye el NVRAM12-EX de tu sistema de almacenamiento AFX 2K cuando la memoria no volátil presente algún fallo o necesite una actualización. 
---
= Sustituye el NVRAM12-EX de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el NVRAM12-EX de tu sistema de almacenamiento AFX 2K cuando la memoria no volátil presente un fallo o necesite una actualización. El proceso de sustitución implica apagar el controlador con problemas, reemplazar el módulo NVRAM12-EX, el DIMM de NVRAM o la batería de NVRAM, y devolver la pieza defectuosa a NetApp.
