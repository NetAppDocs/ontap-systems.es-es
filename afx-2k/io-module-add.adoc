...
summary: Agrega un módulo de I/O a tu sistema de almacenamiento afx 2k para mejorar la conectividad de red y ampliar la capacidad de tu sistema para manejar el tráfico de datos. 
---
= Agregar módulo de E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
