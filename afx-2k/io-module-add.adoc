...
summary: Añade un módulo de E/S a tu sistema de almacenamiento AFX 2K para mejorar la conectividad de red y ampliar la capacidad de tu sistema para gestionar el tráfico de datos. 
---
= Agrega un módulo de I/O a un sistema AFX 2K para mejorar la conectividad de red
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Añade un módulo de E/S a tu sistema de almacenamiento AFX 2K para mejorar la conectividad de red y ampliar la capacidad de tu sistema para gestionar el tráfico de datos.

Puedes añadir un módulo de E/S a tu sistema de almacenamiento AFX 2K cuando hay ranuras libres disponibles o cuando todas las ranuras están completamente ocupadas.
