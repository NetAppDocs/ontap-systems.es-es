...
summary: Sustituye un módulo de ventilador averiado o defectuoso de tu sistema afx 2k para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema. Los ventiladores son intercambiables en caliente y pueden reemplazarse sin necesidad de apagar el sistema. 
---
= Reemplazar un ventilador - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
