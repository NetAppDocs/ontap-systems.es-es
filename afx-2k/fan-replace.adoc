...
summary: Sustituye un módulo de ventilador averiado o defectuoso de tu sistema AFX 2K para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema. Los ventiladores son intercambiables en caliente y puedes reemplazarlos sin apagar el sistema. 
---
= Cambia en caliente un ventilador en tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de ventilador averiado o defectuoso de tu sistema AFX 2K para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema. Los ventiladores son intercambiables en caliente y puedes reemplazarlos sin apagar el sistema. Este procedimiento incluye identificar el ventilador defectuoso usando los mensajes de error de la consola y los indicadores LED, retirar el frontal, intercambiar el módulo del ventilador y devolver la pieza averiada a NetApp.
