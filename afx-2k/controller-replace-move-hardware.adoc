...
summary: Sustituye el controlador de tu sistema de almacenamiento afx 2k cuando lo requiera un fallo de hardware. El proceso de sustitución consiste en retirar el controlador averiado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo. 
---
= Sustituye el controlador - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
