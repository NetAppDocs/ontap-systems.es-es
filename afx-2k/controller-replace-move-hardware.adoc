...
summary: Sustituye el controlador de tu sistema de almacenamiento AFX 2K cuando lo requiera un fallo de hardware. El proceso de sustitución implica quitar el controlador averiado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo. 
---
= Sustituye el controlador de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema de almacenamiento AFX 2K cuando lo requiera un fallo de hardware. El proceso de sustitución implica quitar el controlador averiado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
+
El DIMM encaja perfectamente en la ranura, pero debería poder insertarse fácilmente.  De lo contrario, vuelva a alinear el DIMM con la ranura y vuelva a insertarlo.
...
.El futuro
Tras sustituir el controlador AFX 2K defectuoso, link:controller-replace-system-config-restore-and-verify.html["restaurar la configuración del sistema"].
