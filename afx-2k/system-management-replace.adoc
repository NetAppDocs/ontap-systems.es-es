...
summary: Sustituye el módulo de administración de sistemas de tu sistema de almacenamiento AFX 2K cuando presente un fallo o su firmware esté dañado. El proceso de sustitución consiste en apagar el controlador, sustituir el módulo de administración de sistemas averiado, reiniciar el controlador, actualizar las claves de licencia y devolver la pieza averiada a NetApp. 
---
= Sustituye el módulo de administración de sistemas en un sistema AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Sustituya el módulo Gestión del sistema]
...
+
image::../media/drw_afx_2k_boot_media_remove_replace_ieops-2877.svg[Sustitución de soporte de arranque]
