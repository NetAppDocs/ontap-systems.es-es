...
summary: Sustituye un módulo de E/S de tu sistema de almacenamiento AFX 2K cuando el módulo falle o necesite una actualización para admitir un mayor rendimiento o funciones adicionales. El proceso de sustitución implica apagar el controlador, reemplazar el módulo de E/S defectuoso, reiniciar el controlador y devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo de E/S en tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de E/S de tu sistema de almacenamiento AFX 2K cuando falle. El proceso de sustitución consiste en apagar el controlador, sustituir el módulo de E/S defectuoso, reiniciar el controlador y devolver la pieza defectuosa a NetApp.
...
NOTE: La siguiente ilustración muestra cómo extraer un módulo de E/S vertical. Por lo general, solo quitarás un módulo de E/S.
