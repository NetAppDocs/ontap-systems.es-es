...
summary: Sustituye la batería NV de tu sistema de almacenamiento afx 2k cuando la batería empiece a perder carga o falle, ya que es la responsable de preservar los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en apagar el controlador averiado, extraer el módulo del controlador, reemplazar la batería NV, volver a instalar el módulo del controlador y devolver la pieza averiada a NetApp. 
---
= Reemplaza la batería NV - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Este procedimiento se aplica a la sustitución de una batería NV defectuosa del módulo NVRAM en las ranuras 4 y 5 del controlador AFX 2K. Para obtener información sobre cómo sustituir la batería NV del módulo NVRAM12-EX en las ranuras 6 y 7 del controlador AFX 2K, consulta link:../install-setup/nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Sustituye la batería NV del NVRAM12-EX"].
