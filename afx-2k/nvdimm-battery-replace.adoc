...
summary: Sustituye la batería NV de tu sistema de almacenamiento AFX 2K cuando la batería empiece a perder carga o falle, ya que es la responsable de preservar los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en apagar el controlador averiado, extraer el módulo del controlador, sustituir la batería NV, volver a instalar el módulo del controlador y devolver la pieza defectuosa a NetApp. 
---
= Sustituye la batería NV de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NV de tu sistema de almacenamiento AFX 2K cuando la batería empiece a perder carga o falle, ya que es la responsable de preservar los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en apagar el controlador averiado, extraer el módulo del controlador, sustituir la batería NV, volver a instalar el módulo del controlador y devolver la pieza defectuosa a NetApp.

.Acerca de esta tarea
Este procedimiento se aplica a la sustitución de una batería NV defectuosa del módulo NVRAM en las ranuras 4 y 5 del controlador AFX 2K. Para información sobre cómo sustituir la batería NV del módulo NVRAM12-EX en las ranuras 6 y 7 del controlador AFX 2K, consulta link:nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Sustituye la batería NV del NVRAM12-EX"].
...
+
image::../media/drw_a1k_remove_replace_nvmembat_ieops-1379.svg[Sustituya la batería NV]
