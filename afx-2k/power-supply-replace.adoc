...
summary: Sustituye una fuente de alimentación de CA en tu sistema de almacenamiento AFX 2K cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. El proceso de sustitución consiste en desconectar la PSU en cuestión, desenchufar el cable de alimentación, retirar la PSU defectuosa e instalar la PSU de reemplazo, y luego volver a conectarla a la fuente de alimentación. 
---
= Intercambia en caliente una fuente de alimentación en tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
