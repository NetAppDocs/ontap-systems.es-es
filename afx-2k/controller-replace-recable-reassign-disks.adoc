...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema de almacenamiento AFX 2K pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en tu sistema de almacenamiento AFX 2K para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema de almacenamiento AFX 2K pueda reanudar su funcionamiento normal. El procedimiento de devolución varía en función del tipo de cifrado que utilice tu sistema: sin cifrado o cifrado mediante Onboard Key Manager (OKM).
