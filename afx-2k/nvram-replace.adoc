...
summary: Sustituye la NVRAM de tu sistema de almacenamiento afx 2k cuando la memoria no volátil presente algún fallo o sea necesario actualizarla. 
---
= Reemplazar NVRAM - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
