...
summary: Sustituye la NVRAM de tu sistema de almacenamiento AFX 2K cuando la memoria no volátil presente un fallo o necesite una actualización. 
---
= Sustituye la NVRAM de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la NVRAM de tu sistema de almacenamiento AFX 2K cuando la memoria no volátil presente un fallo o necesite una actualización. El proceso de sustitución consiste en apagar el controlador afectado, reemplazar el módulo NVRAM o el DIMM de NVRAM y devolver la pieza defectuosa a NetApp.
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Retire el módulo NVRAM12 y los DIMM]
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Quite el módulo NVRAM 12 y los DIMM]
...
NOTE: El ID del sistema Override solo es necesario para el reemplazo del módulo NVRAM y no para el reemplazo del DIMM de NVRAM.
