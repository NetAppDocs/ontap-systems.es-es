...
summary: Después de instalar el nuevo dispositivo de arranque en tu sistema de almacenamiento AFX 2K, puedes iniciar el proceso automático de recuperación del dispositivo de arranque para restaurar la configuración desde el nodo asociado. 
---
= Inicia la imagen de recuperación en tu sistema de almacenamiento AFX 2K usando el proceso de recuperación de arranque automático
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de instalar el nuevo dispositivo de arranque en tu sistema de almacenamiento AFX 2K, puedes iniciar el proceso automático de recuperación del dispositivo de arranque para restaurar la configuración desde el nodo asociado.
