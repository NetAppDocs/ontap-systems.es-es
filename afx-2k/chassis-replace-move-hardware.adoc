...
summary: Sustituye el chasis de tu sistema de almacenamiento AFX 2K cuando un fallo de hardware lo requiera. El proceso de sustitución consiste en retirar el controlador de la parte frontal del chasis, extraer las unidades de alimentación, la NVRAM12, los módulos de E/S y los espacios vacíos, y el módulo de administración de sistemas, para luego instalar el chasis de repuesto y volver a instalar los componentes del chasis. 
---
= Sustituye el chasis de tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
