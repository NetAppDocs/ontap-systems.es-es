...
summary: Prepárate para sustituir el chasis defectuoso de tu sistema de almacenamiento AFX 2K identificando el chasis defectuoso, comprobando los componentes de recambio y etiquetando los cables y los módulos controladores. 
---
= Prepárate para sustituir el chasis de tu AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
