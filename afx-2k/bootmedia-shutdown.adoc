...
summary: Apaga el controlador de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el medio de arranque. 
---
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el medio de arranque.
