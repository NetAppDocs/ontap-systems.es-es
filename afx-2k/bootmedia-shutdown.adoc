...
summary: Apaga el controlador defectuoso de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque. 
---
= Apaga el controlador de tu sistema de almacenamiento AFX 2K durante el proceso automático de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento AFX 2K para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque.
