...
summary: Apaga el controlador defectuoso de tu sistema de almacenamiento afx 2k para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el boot media. 
---
= Apaga el controlador para reemplazar el soporte de arranque - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
