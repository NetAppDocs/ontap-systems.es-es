...
summary: Empieza a sustituir el chasis de tu sistema de almacenamiento AFX 2K revisando los requisitos de sustitución, apagando el controlador, sustituyendo el chasis y comprobando el funcionamiento del sistema. 
---
= Flujo de trabajo para reemplazar el chasis AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a sustituir el chasis de tu sistema de almacenamiento AFX 2K revisando los requisitos de sustitución, apagando el controlador, sustituyendo el chasis y comprobando el funcionamiento del sistema.
