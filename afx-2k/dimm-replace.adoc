...
summary: Sustituye un DIMM en tu sistema de almacenamiento AFX 2K si se detectan errores de memoria excesivos, ya sean corregibles o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución implica apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp. 
---
= Sustituye un módulo DIMM en tu sistema de almacenamiento AFX 2K para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema de almacenamiento AFX 2K si se detectan errores de memoria excesivos, ya sean corregibles o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución implica apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp.
