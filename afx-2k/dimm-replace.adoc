...
summary: Sustituye un DIMM en tu sistema de almacenamiento afx 2k si se detectan errores de memoria excesivos, ya sean corregibles o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP. El proceso de sustitución consiste en apagar el controlador afectado, retirarlo, reemplazar el DIMM, volver a instalar el controlador y luego devolver la pieza defectuosa a NetApp. 
---
= Reemplaza un DIMM - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
