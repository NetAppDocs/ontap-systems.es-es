...
summary: El sistema de almacenamiento AFX 2K ofrece flexibilidad a la hora de ampliar o sustituir módulos de E/S para mejorar la conectividad de red y el rendimiento. Añadir o sustituir un módulo de E/S es fundamental a la hora de actualizar las capacidades de red o solucionar el fallo de un módulo. 
---
= Descubre cómo añadir y sustituir módulos de E/S en tu sistema de almacenamiento AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
