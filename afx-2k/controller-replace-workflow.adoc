...
summary: Empieza a sustituir el controlador de tu sistema de almacenamiento AFX 2K apagando el controlador averiado, extrayendo y sustituyendo el controlador, reconfigurando los ajustes del sistema y comprobando el funcionamiento del sistema. 
---
= Flujo de trabajo para reemplazar el controlador AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a sustituir el controlador de tu sistema de almacenamiento AFX 2K apagando el controlador averiado, extrayendo y sustituyendo el controlador, restaurando la configuración del sistema y comprobando el funcionamiento del sistema.
