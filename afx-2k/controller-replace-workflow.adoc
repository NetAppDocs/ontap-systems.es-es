...
summary: Empieza a sustituir el controlador en tu sistema de almacenamiento afx 2k apagando el controlador averiado, extrayendo y sustituyendo el controlador, reconfigurando los ajustes del sistema y comprobando el funcionamiento del sistema. 
---
= Flujo de reemplazo del controlador - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
