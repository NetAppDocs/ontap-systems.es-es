...
summary: El soporte de arranque de tu sistema de almacenamiento afx 2k almacena datos esenciales de firmware y configuración. El proceso de sustitución implica quitar el módulo de administración de sistemas, retirar el soporte de arranque dañado, instalar el soporte de arranque de repuesto en el módulo de administración de sistemas y luego volver a instalar el módulo de administración de sistemas. 
---
= Sustituye el soporte de arranque - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El soporte de arranque de tu sistema de almacenamiento AFX 2K almacena datos esenciales de firmware y configuración. El proceso de sustitución consiste en quitar el módulo de administración de sistemas, retirar el soporte de arranque dañado, instalar el soporte de arranque de repuesto en el módulo de administración de sistemas y luego volver a instalar el módulo de administración de sistemas.
...
+
.. Retire los cables del módulo de administración del sistema y etiquételos para garantizar una reconexión correcta durante la reinstalación.
...
.El futuro
Después de reemplazar el medio de arranque,link:bootmedia-recovery-image-boot.html["Restaure la imagen ONTAP desde el nodo del partner"] .
