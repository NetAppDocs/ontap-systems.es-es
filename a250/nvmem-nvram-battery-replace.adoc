...
---
= Sustituye la batería del NVMEM de tu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVMEM de tu sistema AFF A250 cuando empiece a perder carga o falle, ya que conserva los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en quitar el módulo controlador, reemplazar la batería y volver a instalar el módulo controlador.
