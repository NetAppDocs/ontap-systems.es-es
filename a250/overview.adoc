...
---
= Especificaciones clave para un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta las especificaciones seleccionadas del sistema de almacenamiento AFF A250, correspondientes a un único par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para ver la lista completa de especificaciones del AFF A250.
