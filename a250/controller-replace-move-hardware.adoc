...
---
= Sustituye el controlador de tu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la controladora en tu sistema AFF A250 cuando lo requiera un fallo de hardware. El proceso de sustitución implica quitar la controladora dañada, mover los componentes a la controladora de reemplazo, instalar la controladora de reemplazo y reiniciarla.
...
.El futuro
Después de que hayas reemplazado el controlador A250 deteriorado, necesitas link:controller-replace-system-config-restore-and-verify.html["restaurar y verificar la configuración del sistema"].
