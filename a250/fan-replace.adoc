...
---
= Cambia un ventilador intercambiable en caliente en tu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de ventilador averiado en tu sistema AFF A250 para mantener una refrigeración adecuada y evitar problemas de rendimiento. Los módulos de ventilador son intercambiables en caliente y pueden reemplazarse sin apagar el sistema.
