...
---
= Instala un sistema AFF A250 usando estas instrucciones gráficas rápidas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y conecta tu sistema de almacenamiento AFF A250 usando las instrucciones gráficas rápidas.
