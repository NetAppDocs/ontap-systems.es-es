...
summary: Empieza a reemplazar el medio de arranque en tu sistema de almacenamiento AFF A250 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el medio de arranque, restaurando la imagen en el medio de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema AFF A250 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La recuperación automática de la imagen de arranque consiste en que el sistema identifique y seleccione automáticamente la opción adecuada del menú de arranque. Utiliza la imagen de arranque del nodo asociado para reinstalar ONTAP en el soporte de arranque de sustitución de tu sistema de almacenamiento AFF A250.
