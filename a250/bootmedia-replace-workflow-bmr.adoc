...
[role="lead"]
La recuperación automatizada de la imagen de arranque implica que el sistema identifica y selecciona automáticamente la opción de menú de arranque adecuada. Utiliza la imagen de arranque en el nodo asociado para reinstalar ONTAP en el medio de arranque de reemplazo en tu sistema de almacenamiento AFF A250.
