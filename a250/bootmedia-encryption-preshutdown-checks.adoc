...
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque en un sistema AFF A250 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de comprobar la compatibilidad y el estado de la clave de cifrado en el soporte de arranque, link:bootmedia-shutdown.html["apague la controladora"].
