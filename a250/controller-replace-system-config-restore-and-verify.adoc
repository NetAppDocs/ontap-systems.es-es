...
---
= Restaurar y verificar la configuración del controlador en un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la sustitución del hardware y arrancar en modo de mantenimiento, verifica la configuración de bajo nivel del controlador de reemplazo y vuelve a configurar los ajustes del sistema según sea necesario.
