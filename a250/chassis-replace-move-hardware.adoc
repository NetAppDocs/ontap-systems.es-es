...
---
= Sustituye el chasis en un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A250 cuando un fallo de hardware lo requiera. El proceso de sustitución implica quitar los controladores y las fuentes de alimentación (PSUs), quitar las unidades, instalar el chasis de reemplazo y volver a instalar los componentes del chasis.
...
.El futuro
Después de haber sustituido el chasis AFF A250 dañado y reinstalado los componentes, necesitas link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"]
