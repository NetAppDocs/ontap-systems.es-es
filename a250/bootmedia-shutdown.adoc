...
---
= Apaga el controlador para la recuperación manual de medios de arranque - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador dañado de tu sistema de almacenamiento AFF A250 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automatizado de recuperación del boot media.
