...
summary: Después de instalar el nuevo dispositivo de medios de arranque en tu sistema AFF A250, puedes iniciar el proceso automatizado de recuperación de medios de arranque para restaurar la configuración desde el nodo asociado. 
---
= Recuperación automática de medios de arranque desde el nodo asociado - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
