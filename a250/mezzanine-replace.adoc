...
---
= Sustituir o instalar una tarjeta de entrepiso en un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta mezzanine con error en tu sistema AFF A250 o instala una nueva para ampliar las opciones de conectividad. El proceso de sustitución consiste en quitar los cables y los módulos SFP o QSFP, reemplazar la tarjeta y volver a conectar los cables.
