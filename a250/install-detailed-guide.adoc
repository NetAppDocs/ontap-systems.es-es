...
---
= Instala un sistema AFF A250 siguiendo las instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Utiliza el cable de interconexión del clúster de 25 GbE para conectar los puertos de interconexión del clúster e0c a e0c y e0d a e0d.
+
