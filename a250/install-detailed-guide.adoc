...
---
= Instala tu sistema AFF A250 siguiendo las instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A250 siguiendo estas instrucciones detalladas paso a paso, desde la preparación del sitio hasta la puesta en marcha del clúster ONTAP.
...
.Pasos
. Utiliza el cable de interconexión de clúster de 25 GbE para conectar los puertos de interconexión de clúster e0c con e0c y e0d con e0d.
+
...
NOTE: link:https://hwu.netapp.com["Hardware Universe de NetApp"^] la prioridad de ranura para las tarjetas de red host (Fibre Channel o 25 GbE) es la ranura 2. Sin embargo, si tienes ambas tarjetas, la tarjeta Fibre Channel va en la ranura 2 y la tarjeta 25 GbE va en la ranura 1 (como se muestra en las opciones abajo). Si tienes un shelf externo, la tarjeta de almacenamiento va en la ranura 1, la única ranura admitida para shelves.
...
--
.Opción 2: Cable a red de datos o host de 25 GbE
--
Los puertos de 25 GbE de los controladores están conectados a conmutadores de red de datos o host de 25 GbE.
...
+
image:../media/drw_affa250_1shelf_cabling_a.png["Cableado del controlador 1"]

. Conecte el cable de la controladora B a la bandeja.
+
image:../media/drw_affa250_1shelf_cabling_b.png["Cableado del controlador 2"]
...
NOTE: Para obtener información sobre cómo establecer la conectividad continua de un puerto de consola del controlador para la administración remota, consulte el artículo de la base de conocimientos. https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/How_to_connect_an_ONTAP_controller_console_port_for_remote_management["Cómo conectar un puerto de consola del controlador ONTAP para administración remota"^].
