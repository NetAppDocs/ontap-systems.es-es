...
summary: Empieza a reemplazar el soporte de arranque en tu sistema de almacenamiento AFF A250 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo para reemplazar el soporte de arranque en un sistema AFF A250 usando el proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Empieza a reemplazar el soporte de arranque en tu sistema de almacenamiento AFF A250 revisando los requisitos de reemplazo, comprobando el estado de cifrado, apagando el controlador, reemplazando el soporte de arranque, arrancando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema.
