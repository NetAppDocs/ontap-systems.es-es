...
summary: Para completar la sustitución del controlador de tu sistema AFF A250, restaura la configuración de NetApp Storage Encryption si es necesario, instala las licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del controlador de tu sistema AFF A250, restaura la configuración de NetApp Storage Encryption (si es necesario), confirma que las interfaces lógicas (LIF) informan a sus puertos de origen, realiza una comprobación de estado del cluster y devuelve la pieza con error a NetApp.
