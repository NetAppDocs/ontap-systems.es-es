...
---
= Sustitución completa del controlador - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución de la controladora de tu sistema AFF A250 a pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption (si es necesario), instalar licencias para la nueva controladora y devolver la pieza averiada a NetApp, como se describe en las instrucciones de RMA enviadas con el kit.
