...
summary: Restaura la encriptación en el medio de arranque de repuesto en tu sistema AFF A250. Completa los pasos específicos para los sistemas que tienen activado Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption. 
---
= Restablece el cifrado en el soporte de arranque de un sistema AFF A250 después del proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura el cifrado en el soporte de arranque de reemplazo de tu sistema AFF A250 para asegurar la protección continua de los datos. El proceso de reemplazo implica verificar la disponibilidad de las claves, volver a aplicar la configuración de cifrado y confirmar el acceso seguro a tus datos.
...
====
.El futuro
Tras restablecer el cifrado en el soporte de arranque, link:bootmedia-complete-rma.html["Devuelva la pieza fallida a NetApp"].
