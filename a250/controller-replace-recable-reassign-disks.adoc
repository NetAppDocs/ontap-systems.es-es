...
---
= Recuperar el sistema y reasignar discos - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la restauración y verificar la configuración del sistema A250, necesitas volver a cablear el sistema y reasignar los discos.
