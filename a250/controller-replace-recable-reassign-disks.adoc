...
---
= Vuelve a cablear el sistema y reasigna los discos en tu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vuelve a conectar el almacenamiento, confirma la reasignación de discos y restablece NetApp Storage Encryption para que tu sistema AFF A250 vuelva a funcionar plenamente.
