...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador AFF A250 para asegurarte de que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real de tu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A250 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
...
.. Suelte los pulgares de la parte superior de los mecanismos de bloqueo y siga presionando hasta que los mecanismos de bloqueo encajen en su lugar. + El módulo del controlador debe estar completamente insertado y alineado con los bordes del chasis.
