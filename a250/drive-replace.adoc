...
---
= Intercambia en caliente una unidad en un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente una unidad con error en tu sistema AFF A250 sin interrupciones mientras hay operaciones de E/S en curso para restaurar la capacidad de almacenamiento y el rendimiento del sistema.
