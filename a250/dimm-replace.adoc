...
summary: Sustituye un módulo DIMM de tu controlador AFF A250 cuando el sistema detecte un exceso de errores CECC según las alertas de Health Monitor o errores ECC no corregibles que impidan que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en tu sistema AFF A250 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en tu sistema AFF A250 cuando el sistema de almacenamiento detecte un número excesivo de errores de memoria corregibles (CECC) o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP.
