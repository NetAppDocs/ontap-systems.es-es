...
summary: 'Completa la sustitución del chasis de tu sistema FAS2700 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente defectuoso a NetApp.' 
---
= Completa la sustitución del chasis de un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de tu sistema FAS2700 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente defectuoso a NetApp.
