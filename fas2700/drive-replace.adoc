...
summary: Sustituye una unidad de tu sistema FAS2700 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se encienden tanto el LED de fallo del panel de control como el LED de fallo de la unidad con error. 
---
= Sustituir una unidad en tu sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad de tu sistema FAS2700 cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Se encienden tanto el LED de fallo del panel de control como el LED de fallo de la unidad con error.
