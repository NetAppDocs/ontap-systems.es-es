...
También puede elegir ver el https://www.youtube.com/embed/Ziqg9HL8oYQ?rel=0["_Sustituir vídeo_ de la unidad que ha fallado"^] que muestra información general del procedimiento de reemplazo de unidad integrada.
