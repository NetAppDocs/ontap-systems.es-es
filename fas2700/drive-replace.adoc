...
summary: Realiza un intercambio en caliente de una unidad en tu sistema FAS2700 cuando la plataforma registre un mensaje de advertencia en la consola del sistema indicando que una unidad con error. Se encienden tanto el LED de fallo del panel de visualización del operador como el LED de fallo de la unidad con error. 
---
= Intercambia en caliente una unidad en un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad con error en tu sistema FAS2700 sin interrumpir el servicio, incluso mientras se están realizando operaciones de E/S, para restablecer la capacidad de almacenamiento y el rendimiento del sistema.
