...
summary: Antes de sustituir el controlador de tu sistema FAS2700, revisa los requisitos previos para el procedimiento de sustitución y selecciona el adecuado para tu versión de ONTAP. 
---
= Revisa los requisitos antes de sustituir el controlador de tu sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema FAS2700, revisa los requisitos previos para el procedimiento de sustitución y selecciona el adecuado para tu versión de ONTAP.
