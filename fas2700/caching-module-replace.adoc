...
summary: Sustituye el módulo de almacenamiento en caché de tu sistema FAS2700 cuando tu sistema registre un solo mensaje ASUP de AutoSupport que indique que el módulo se ha desconectado. Si no lo haces, el rendimiento disminuirá. 
---
= Sustituye el módulo de almacenamiento en caché en un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el módulo de almacenamiento en caché de tu sistema FAS2700 cuando tu sistema registre un solo mensaje AutoSupport (ASUP) que indique que el módulo se ha desconectado. Si no lo haces, el rendimiento disminuirá.
