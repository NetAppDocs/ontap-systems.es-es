...
summary: En esta página encontrarás instrucciones detalladas paso a paso para instalar tu sistema FAS2700. 
---
= Instala un sistema FAS2700 siguiendo las instrucciones detalladas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sigue las instrucciones detalladas paso a paso para instalar tu sistema FAS2700, desde la preparación para la instalación hasta la configuración inicial.
