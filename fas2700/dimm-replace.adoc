...
summary: Sustituye el DIMM de tu sistema FAS2700 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC no corregible, lo que normalmente es causado por una falla en un solo DIMM. 
---
= Sustituir un módulo DIMM en un sistema FAS2700 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el DIMM de tu sistema FAS2700 cuando el sistema de almacenamiento detecte un número excesivo de errores ECC corregibles o un error ECC no corregible, lo que normalmente es causado por una falla en un solo DIMM.
