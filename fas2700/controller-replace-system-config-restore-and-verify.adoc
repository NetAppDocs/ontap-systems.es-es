...
summary: Restaura y comprueba la configuración del controlador en tu sistema FAS2700 después de completar la sustitución del hardware y arrancar en modo de mantenimiento. 
---
= Restaurar y verificar la configuración del controlador en un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaura y comprueba la configuración del controlador en tu sistema FAS2700 después de completar la sustitución del hardware y arrancar en modo de mantenimiento.
