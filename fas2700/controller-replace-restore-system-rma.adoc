...
summary: Para restaurar tu sistema FAS2700 a su pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption, instalar las licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp. 
---
= Completa la sustitución del controlador para un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para que tu sistema FAS2700 vuelva a funcionar plenamente, debes restablecer la configuración de cifrado de almacenamiento NetApp (si es necesario), instalar licencias para el nuevo controlador y devolver la pieza con error a NetApp, como se describe en las instrucciones de RMA incluidas con el kit.
