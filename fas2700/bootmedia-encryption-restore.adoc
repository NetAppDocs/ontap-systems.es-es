...
summary: Restaurar el cifrado en el medio de arranque de reemplazo. El sistema FAS2700 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de tu sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurar el cifrado en el medio de arranque de reemplazo. El sistema FAS2700 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
