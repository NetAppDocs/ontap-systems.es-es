...
---
= Reemplace el soporte de arranque: AFF A220 y FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_2600_boot_media_move_aminated_gif.png[el soporte de arranque drw 2600 mueve el gif aminado]
