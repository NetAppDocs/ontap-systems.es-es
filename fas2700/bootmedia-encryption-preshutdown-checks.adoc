...
summary: Verifique el estado y la compatibilidad de la clave de cifrado antes de apagar el controlador dañado en un sistema FAS2700. El sistema FAS2700 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique el estado y la compatibilidad de la clave de cifrado antes de apagar el controlador dañado en un sistema FAS2700. Este procedimiento incluye verificar la compatibilidad de la versión de ONTAP con NetApp Volume Encryption (NVE), verificar la configuración del administrador de claves y realizar copias de seguridad de la información de cifrado para garantizar la seguridad de los datos durante la recuperación del medio de arranque.
