...
summary: Traslada las fuentes de alimentación, las unidades y los módulos controladores del chasis averiado al chasis de recambio, y cambia el chasis antiguo del bastidor de equipos o del armario del sistema por uno nuevo del mismo modelo. 
---
= Sustituye el chasis de tu sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mueve las fuentes de alimentación, las unidades y los módulos controladores del chasis averiado al chasis de reemplazo en tu sistema FAS2700 y luego cambia el chasis antiguo en el rack de equipos o gabinete del sistema por el nuevo del mismo modelo.
