...
summary: Apaga el controlador defectuoso de tu sistema FAS2700 antes de reemplazarlo, tomándolo y deteniéndolo hasta el prompt LOADER. 
---
= Apaga el controlador defectuoso de tu sistema FAS2700 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema FAS2700 antes de reemplazarlo, tomándolo y deteniéndolo hasta el prompt LOADER.
