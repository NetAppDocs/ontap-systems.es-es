...
---
= Intercambia en caliente una fuente de alimentación en tu sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia en caliente una fuente de alimentación en tu sistema FAS2700 apagando, desconectando y retirando la unidad con error, luego instala y vuelve a conectar la de reemplazo.
