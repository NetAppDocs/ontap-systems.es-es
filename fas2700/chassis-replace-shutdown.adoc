...
summary: Apaga o toma el control del controlador defectuoso de tu sistema FAS2700 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis. 
---
= Apaga tu controlador FAS2700 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga o toma el control del controlador defectuoso de tu sistema FAS2700 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis.
