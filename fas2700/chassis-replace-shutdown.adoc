...
summary: Apaga los controladores de tu sistema FAS2700 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis. 
---
= Apaga los controladores del FAS2700 para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema FAS2700 usando el procedimiento adecuado para tu configuración antes de reemplazar el chasis.
