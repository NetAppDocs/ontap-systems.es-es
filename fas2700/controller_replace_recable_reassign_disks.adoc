...
---
= Recuperar el sistema y reasignar los discos: AFF A220 y FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Pareja de HA
 a| 
link:controller_replace_complete_system_restoration.md#["Comprobar el cambio de ID del sistema en un sistema de alta disponibilidad"]
...
Independiente
 a| 
link:controller_replace_complete_system_restoration.md#["Reasignar manualmente el ID del sistema en un sistema independiente en ONTAP"]
...
Configuración MetroCluster de dos nodos
 a| 
link:controller_replace_complete_system_restoration.md#["Reasignar manualmente el ID del sistema en sistemas de una configuración de MetroCluster de dos nodos"]
