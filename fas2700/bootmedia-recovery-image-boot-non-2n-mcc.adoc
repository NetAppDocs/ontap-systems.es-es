...
summary: Arranque la imagen de recuperación de ONTAP desde la unidad USB en un sistema FAS2700 para restaurar el medio de arranque. El sistema FAS2700 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Arranca la imagen de recuperación en un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
