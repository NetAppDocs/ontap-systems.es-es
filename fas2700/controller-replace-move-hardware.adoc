...
summary: Sustituye el controlador de tu sistema FAS2700 retirando el controlador averiado, trasladando los componentes FRU al módulo controlador de repuesto, instalándolo en el chasis y arrancando en modo de mantenimiento. 
---
= Sustituye el controlador en un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema FAS2700 retirando el controlador averiado, trasladando los componentes FRU al módulo controlador de repuesto, instalándolo en el chasis y arrancando en modo de mantenimiento.
