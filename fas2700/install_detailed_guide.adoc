...
---
= Guía detallada: AFF A220 y FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para instalar el sistema FAS2700 o AFF A220, debe crear una cuenta en el sitio de soporte de NetApp, registrar el sistema y obtener claves de licencia. También es necesario realizar el inventario del número y tipo de cables adecuados para el sistema y recopilar información específica de la red.
...
+
https://docs.netapp.com/us-en/ontap-systems/sas3/index.html["Instalación y cableado"]
