...
---
= Añada el módulo I/O: AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si dispone de PSU de CC, vuelva a conectar los bloques de cables a las PSU.
...
NOTE: Si el sistema de almacenamiento tiene suministros de alimentación de CC, desconecte el bloque de cables de alimentación de la PSU.
