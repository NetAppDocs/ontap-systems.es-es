...
[role="lead"]
Reemplace el chasis en el sistema AFF A70 o AFF A90 cuando un fallo de hardware lo requiera. El proceso de sustitución implica la retirada de las unidades de alimentación (PSU), la extracción del chasis existente, la instalación del nuevo y la reinstalación de los componentes del chasis.
