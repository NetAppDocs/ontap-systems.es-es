...
summary: Reemplace el chasis en el sistema AFF A70 o AFF A90 cuando un error de hardware o actualización lo requiera. Este proceso implica apagar el sistema, quitar el chasis existente, instalar el nuevo y reconfigurar los componentes para garantizar un funcionamiento adecuado del sistema. 
---
...
[role="lead"]
Reemplace el chasis en el sistema AFF A70 o AFF A90 cuando un error de hardware o actualización lo requiera. Este proceso implica apagar el sistema, quitar el chasis existente, instalar el nuevo y reconfigurar los componentes para garantizar un funcionamiento adecuado del sistema.
