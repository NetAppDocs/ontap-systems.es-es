...
summary: 'Reemplace el chasis del sistema AFF A70 o AFF A90 cuando se produzca un error de hardware o actualización que lo requiera. El proceso de sustitución implica la retirada de las unidades de alimentación (PSU), la extracción del chasis existente, la instalación del nuevo y la reinstalación de los componentes del chasis.' 
---
...
[role="lead"]
Reemplace el chasis del sistema AFF A70 o AFF A90 cuando se produzca un error de hardware o actualización que lo requiera. El proceso de sustitución implica la retirada de las unidades de alimentación (PSU), la extracción del chasis existente, la instalación del nuevo y la reinstalación de los componentes del chasis.
