...
---
= Especificaciones clave para un sistema AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta algunas especificaciones del sistema de almacenamiento AFF A90 en una configuración de par único de alta disponibilidad. Visita NetApp Hardware Universe (HWU) para ver las especificaciones completas de este sistema de almacenamiento.
