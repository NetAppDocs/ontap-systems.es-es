...
---
= Vuelva a conectar y devolver el controlador - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para continuar con el procedimiento de reemplazo, vuelva a cablear el almacenamiento, las conexiones de red y vuelva a devolver la controladora.
