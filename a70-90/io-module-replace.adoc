...
---
= Sustituya el módulo de E/S - AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya un módulo de E/S de su sistema AFF A70 o AFF A90 cuando el módulo falle o necesite una actualización para admitir un rendimiento superior o funciones adicionales.
