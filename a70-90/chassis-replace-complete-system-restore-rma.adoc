...
summary: Reinicie las controladoras, verifique el estado del sistema y devuelva la parte con errores a NetApp para completar el paso final en el flujo de trabajo de reemplazo del chasis de AFF A70 y AFF A90. 
---
...
[role="lead"]
Reinicie las controladoras, verifique el estado del sistema y devuelva la parte con errores a NetApp para completar el paso final en el flujo de trabajo de reemplazo del chasis de AFF A70 y AFF A90.
