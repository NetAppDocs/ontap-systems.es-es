...
summary: Restaure el cifrado en el medio de arranque de reemplazo en su sistema AFF A70 o AFF A90 para garantizar una protección de datos continua. Este proceso implica verificar la disponibilidad de claves, volver a aplicar la configuración de cifrado, confirmar el acceso seguro a sus datos. 
---
= Restaure el cifrado en el medio de arranque: AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
