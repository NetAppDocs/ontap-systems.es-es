...
[role="lead"]
Restaure el cifrado en el medio de arranque de reemplazo en su sistema AFF A70 o AFF A90 para garantizar una protección de datos continua. Este proceso implica verificar la disponibilidad de claves, volver a aplicar la configuración de cifrado y confirmar el acceso seguro a sus datos.
