...
---
= Conecta el hardware de tu AFF A70 o AFF A90 para la conectividad de red y almacenamiento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
--
Utilice el cable 100 GbE para conectar los puertos e1a y e7a de los controladores A y B a los conmutadores de red del clúster A y B.
...
A continuación se muestran algunos ejemplos típicos de cableado de red host. Consulta link:https://hwu.netapp.com["Hardware Universe de NetApp"^] para tu configuración específica del sistema.

.Pasos
. Conecte los puertos e9a y e9b al switch de red de datos Ethernet.
+

NOTE: No utilices los puertos e1b y e7b para las conexiones de red del host. Utiliza una tarjeta de host independiente.
...
. Conecta tus tarjetas de 10/25 GbE a los switches de red del host.
+
...
Los siguientes procedimientos de cableado muestran cómo conectar tus controladores a un shelf de almacenamiento. Elige una de las siguientes opciones de cableado que se adapten a tu configuración.
...
.Acerca de esta tarea
Los sistemas de almacenamiento AFF A70 y AFF A90 admiten estanterías NS224 con el módulo NSM100 o NSM100B. Las principales diferencias entre los módulos son:
...
.. Conecta el puerto e11b al shelf 2, puerto e0b del NSM A.
+
...
====
.El futuro
Una vez que hayas conectado el hardware de tu sistema AFF A70 o AFF A90, link:install-power-hardware.html["Encienda el sistema de almacenamiento AFF A70 o AFF A90"].
