...
summary: Sustituya un módulo de ventilador del sistema AFF A70 o AFF A90 si se produce un error en un ventilador o no está funcionando de forma eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de sustitución implica apagar la controladora deteriorada, extraer la controladora, sustituir el ventilador, reinstalar la controladora y devolver la pieza averiada a NetApp. 
---
= Intercambia en caliente un módulo de ventilador en tu sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituya un módulo de ventiladores en su sistema AFF A70 o AFF A90 cuando se produzca un error en un ventilador o no esté funcionando de manera eficiente, ya que esto puede afectar a la refrigeración del sistema y al rendimiento general. El proceso de reemplazo implica que se apague la controladora, se retire la controladora, se sustituya el ventilador, se reinstale la controladora y se devuelva la parte fallida a NetApp.
