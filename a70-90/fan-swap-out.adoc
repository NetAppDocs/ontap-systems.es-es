...
summary: Sustituya un módulo de ventilador en su sistema AFF A70 o AFF A90 cuando se produzca un error en un ventilador o no esté funcionando de manera eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general. 
---
...
[role="lead"]
Sustituya un módulo de ventilador en su sistema AFF A70 o AFF A90 cuando se produzca un error en un ventilador o no esté funcionando de manera eficiente, lo que puede afectar a la refrigeración del sistema y al rendimiento general.
