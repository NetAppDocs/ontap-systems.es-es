...
[role="lead"]
Consulta algunas especificaciones del sistema de almacenamiento AFF A70 en una configuración de par único de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para obtener una lista completa de las especificaciones del AFF A70.
