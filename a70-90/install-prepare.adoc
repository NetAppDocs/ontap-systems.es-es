...
summary: Prepárese para instalar su sistema de almacenamiento AFF A70 o AFF A90 preparando el sitio, desempaquetando las cajas y comparando el contenido de las cajas con la hoja de embalaje, y registrando el sistema para acceder a los beneficios de soporte. 
---
= Prepárate para instalar un sistema de almacenamiento AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepárese para instalar su sistema de almacenamiento AFF A70 o AFF A90 preparando el sitio, desempaquetando las cajas y comparando el contenido de las cajas con la hoja de embalaje, y registrando el sistema para acceder a los beneficios de soporte.
...
.Pasos
. Localice los números de serie del sistema (SSN) de cada controlador que se esté instalando.
+
...
.El futuro
Después de haber preparado para instalar su hardware de AFF A70 o AFF A90, ustedlink:install-hardware.html["Instale el hardware para el sistema de almacenamiento AFF A70 o AFF A90"].
