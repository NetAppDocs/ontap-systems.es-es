...
---
= Sustituya el soporte de arranque: AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para sustituir el soporte de arranque, debe extraer el módulo de gestión del sistema de la parte posterior del sistema, extraer el soporte de arranque defectuoso, instalar el soporte de arranque de repuesto en el módulo de gestión del sistema y transferir la imagen de arranque a una unidad flash USB.
