...
---
= Sustituye el controlador en tu sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Retira el módulo controlador del chasis antes de sustituirlo o de cambiar cualquier componente interno.
...
.El futuro
Después de haber reemplazado el controlador AFF A70 o AFF A90 defectuoso, deberálink:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"] .
