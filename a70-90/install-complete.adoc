...
summary: Después de activar el sistema de almacenamiento AFF A70 o AFF A90, estará listo para detectar su red de clúster y configurar un clúster de ONTAP. 
---
