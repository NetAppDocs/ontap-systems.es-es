...
---
= Instalación y configuración completas del sistema de almacenamiento: AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_autodiscovery_controler_select.svg[Cómo descubrir sus controladores con el Explorador de archivos de Windows]
