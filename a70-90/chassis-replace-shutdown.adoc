...
summary: Apague las controladoras de su sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el chasis. 
---
= Apague las controladoras para reemplazar el chasis: AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras de su sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir el chasis.
...
.El futuro
Tras apagar los controladores,link:chassis-replace-move-hardware.html["sustituya el chasis"] .
