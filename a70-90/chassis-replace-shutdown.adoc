...
summary: Apague las controladoras en su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el chasis. Antes de realizar tareas de mantenimiento o sustitución de componentes, es crítico apagar la controladora de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
= Apague los controladores: AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague las controladoras en su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el chasis. Antes de realizar tareas de mantenimiento o sustitución de componentes, es crítico apagar la controladora de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema.
