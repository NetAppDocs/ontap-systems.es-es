...
summary: Apague las controladoras en su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el chasis. Es crucial apagar la controladora con seguridad para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
...
[role="lead"]
Apague las controladoras en su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el chasis. Es crucial apagar las controladoras con seguridad para evitar la pérdida de datos y garantizar la estabilidad del sistema.
