...
---
= Revisa los requisitos para la recuperación mediante un soporte de arranque manual en un sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si tu sistema ejecuta ONTAP 9.17.1 o una versión posterior, usa la link:bootmedia-replace-workflow-bmr.html["procedimiento de recuperación de arranque automatizado"].
