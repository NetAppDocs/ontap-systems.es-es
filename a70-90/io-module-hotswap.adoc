...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF A70 o AFF A90 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Realiza un intercambio en caliente de un módulo de E/S en tu sistema AFF A70 o AFF A90 sin necesidad de apagarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento AFF A70 o AFF A90 si falla un módulo y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
