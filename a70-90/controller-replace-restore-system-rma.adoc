...
[role="lead"]
Compruebe que las interfaces lógicas (LIF) informan a su puerto principal, realice una comprobación del estado del clúster y, a continuación, devuelva la parte fallida a NetApp para completar el paso final del procedimiento de sustitución de la controladora AFF A70 y AFF A90.
