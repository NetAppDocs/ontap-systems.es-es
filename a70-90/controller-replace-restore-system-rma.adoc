...
[role="lead"]
Compruebe que las interfaces lógicas informan a su puerto de inicio, realice una comprobación del estado del clúster y, a continuación, devuelva la parte con error a NetApp para completar el paso final del procedimiento de sustitución de las controladoras AFF A70 y AFF A90.
