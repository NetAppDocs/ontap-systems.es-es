...
summary: Reemplace un DIMM en su sistema AFF A70 o AFF A90 si se detectan demasiados errores de memoria corregibles o que no se pueden corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora dañada, extraerla, sustituir el DIMM y luego reinstalar la controladora. 
---
...
[role="lead"]
Reemplace un DIMM en su sistema AFF A70 o AFF A90 si se detectan demasiados errores de memoria corregibles o que no se pueden corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora dañada, extraerla, sustituir el DIMM y luego reinstalar la controladora.
