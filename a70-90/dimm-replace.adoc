...
summary: Reemplace un DIMM en su sistema AFF A70 o AFF A90 cuando se detecten demasiados errores corregibles o que no se pueden corregir. Estos problemas, a menudo provocados por un único fallo de DIMM, pueden impedir que el sistema de almacenamiento arranque el ONTAP. 
---
...
[role="lead"]
Reemplace un DIMM en su sistema AFF A70 o AFF A90 cuando se detecten demasiados errores corregibles o que no se pueden corregir. Estos problemas, a menudo provocados por un único fallo de DIMM, pueden impedir que el sistema de almacenamiento arranque el ONTAP.
