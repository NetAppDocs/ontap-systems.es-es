...
summary: Reemplace un DIMM en su sistema AFF A70 o AFF A90 si se detectan demasiados errores de memoria corregibles o que no se pueden corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp. 
---
= Sustituye un módulo DIMM en un sistema AFF A70 o AFF A90 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace un DIMM en su sistema AFF A70 o AFF A90 si se detectan demasiados errores de memoria corregibles o que no se pueden corregir. Estos errores pueden impedir que el sistema de almacenamiento arranque la ONTAP. El proceso de sustitución implica apagar la controladora deteriorada, extraerla, sustituir el DIMM, volver a instalar la controladora y, a continuación, devolver la pieza averiada a NetApp.

.Antes de empezar
* Asegúrate de que el resto de componentes del sistema funcionen correctamente. Si no es así, ponte en contacto con el soporte técnico.
...
Para sustituir el módulo DIMM, localízalo dentro del controlador y sigue la secuencia específica de pasos.
