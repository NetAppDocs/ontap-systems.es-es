...
---
= Flujo de trabajo de instalación y configuración de AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Antes de encender los controladores, enciende cada shelf NS224 y asígnale un identificador de shelf único. Luego conecta el laptop o la consola al controlador y conecta los controladores a las fuentes de alimentación.
