...
---
= Encender un sistema de almacenamiento AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.El futuro
Después de encender su sistema de almacenamiento AFF A70 o AFF A90 , https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura tu cluster"] .
