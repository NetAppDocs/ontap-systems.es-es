...
summary: Si el soporte de arranque del sistema AFF A70 o AFF A90 está dañado, puede iniciar la imagen de recuperación desde una unidad USB, restaurar la configuración desde el nodo asociado y verificar las variables de entorno. 
---
...
[role="lead"]
Si el soporte de arranque del sistema AFF A70 o AFF A90 está dañado, puede iniciar la imagen de recuperación desde una unidad USB, restaurar la configuración desde el nodo asociado y verificar las variables de entorno.
