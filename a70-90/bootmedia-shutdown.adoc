...
summary: Apague el controlador dañado en su sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación del medio de arranque manual. 
---
= Apaga el controlador de tu sistema AFF A70 o AFF A90 durante el proceso de recuperación del arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación automática del medio de arranque.
