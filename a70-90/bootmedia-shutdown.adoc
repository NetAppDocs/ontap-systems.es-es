...
summary: Apaga el controlador de tu sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque. 
---
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque.
