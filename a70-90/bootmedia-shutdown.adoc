...
summary: Apague la controladora de su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el medio de arranque. Antes de realizar tareas de mantenimiento o sustitución de componentes, es crítico apagar la controladora de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema. 
---
= Apague la controladora para sustituir el soporte de arranque, AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague la controladora de su sistema de almacenamiento AFF A70 o AFF A90 cuando necesite reemplazar el medio de arranque. Antes de realizar tareas de mantenimiento o sustitución de componentes, es crítico apagar la controladora de forma segura para evitar la pérdida de datos y garantizar la estabilidad del sistema.
