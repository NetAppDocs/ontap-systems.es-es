...
---
= Inicio rápido para la sustitución de soportes de arranque - AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF A70 o AFF A90 preparando el medio de reemplazo, instalándolo en el sistema, restaurando la imagen de arranque y verificando la funcionalidad del sistema.
