...
.Antes de empezar
* Asegúrese de tener la pieza de repuesto disponible. Debe sustituir el componente fallido por un componente de sustitución que ha recibido del proveedor.
...
== Paso 3: Reemplace los DIMM NVRAM
