...
summary: Apague la controladora deficiente en su sistema de almacenamiento AFF A70 o AFF A90 para evitar la pérdida de datos y garantizar la estabilidad del sistema al sustituir los medios de arranque. 
---
