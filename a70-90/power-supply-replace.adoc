...
summary: Sustituye una fuente de alimentación de CA o CC en tu sistema AFF A70 o AFF A90 cuando falle o se averíe, asegurando que tu sistema siga recibiendo la energía necesaria para un funcionamiento estable. El proceso de sustitución consiste en desconectar la fuente de alimentación averiada de la toma de corriente, desenchufar el cable de alimentación, reemplazar la fuente de alimentación averiada y luego volver a conectarla a la toma de corriente. 
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
