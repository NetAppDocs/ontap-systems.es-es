...
---
= Flujo de reemplazo de controladores AFF A70 y AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador de su sistema de almacenamiento AFF A70 o AFF A90 apagando el controlador averiado, extrayéndolo y reemplazándolo, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de reemplazo.
