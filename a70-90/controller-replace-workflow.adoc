...
summary: La sustitución de controladoras AFF A70 y AFF A90 incluye los pasos para apagar la controladora, quitar y sustituir la controladora, reconfigurar los ajustes del sistema y verificar las operaciones del sistema. 
---
...
[role="lead"]
La sustitución de controladoras AFF A70 y AFF A90 incluye los pasos para apagar la controladora, quitar y sustituir la controladora, reconfigurar los ajustes del sistema y verificar las operaciones del sistema.
