...
summary: Antes de reemplazar el medio de arranque en su sistema de almacenamiento AFF A70 o AFF A90 , asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. 
---
...
[role="lead"]
Antes de reemplazar el medio de arranque de su sistema de almacenamiento AFF A70 o AFF A90 , asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. Esto incluye verificar que tenga el medio de arranque de reemplazo correcto, confirmar que los puertos del clúster en la controladora dañada funcionen correctamente y determinar si el Administrador de claves integrado (OKM) o el Administrador de claves externo (EKM) están habilitados.
