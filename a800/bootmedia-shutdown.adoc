...
---
= Apague el controlador para la recuperación manual del medio de arranque - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague el controlador dañado en su sistema de almacenamiento AFF A800 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso de recuperación automática del medio de arranque.
