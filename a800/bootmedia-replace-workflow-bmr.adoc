...
summary: Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF A800 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el medio de arranque, restaurando la imagen en el medio de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo para la sustitución del soporte de arranque en un sistema AFF A800 mediante el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para empezar, revisa los requisitos de sustitución, apaga el controlador, sustituye el soporte de arranque, restaura la imagen y comprueba el funcionamiento del sistema.
