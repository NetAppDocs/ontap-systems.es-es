...
---
= Sustituye la batería del NVDIMM de tu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería NVDIMM de tu sistema AFF A800 cuando empiece a perder carga o falle, porque conserva los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en quitar el módulo controlador, reemplazar la batería y volver a instalar el módulo controlador.
