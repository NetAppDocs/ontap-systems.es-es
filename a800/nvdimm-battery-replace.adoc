...
[role="lead"]
Sustituye la batería NV de tu sistema AFF A800 cuando empiece a perder carga o deje de funcionar, ya que esta conserva los datos críticos del sistema durante los cortes de energía. El proceso de sustitución consiste en retirar el módulo controlador, cambiar la batería y volver a instalar el módulo controlador.
