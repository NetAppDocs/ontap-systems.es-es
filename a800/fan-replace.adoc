...
---
= Sustituye un ventilador en tu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de ventilador de tu sistema AFF A800 cuando un ventilador falle o no funcione de forma eficiente para mantener una refrigeración adecuada y evitar problemas de rendimiento del sistema.
