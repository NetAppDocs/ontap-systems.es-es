...
---
= Especificaciones clave de un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A continuación se detallan algunas especificaciones del sistema de almacenamiento AFF A800 en una configuración de un solo par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] para consultar las especificaciones completas de este sistema de almacenamiento.
