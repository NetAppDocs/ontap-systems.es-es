...
summary: Mantenga el hardware de AFF A800 
---
= Infórmate sobre el mantenimiento de tu sistema de almacenamiento AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza el mantenimiento del hardware de tu sistema de almacenamiento AFF A800 para garantizar la fiabilidad a largo plazo y un rendimiento óptimo. Haz tareas de mantenimiento periódicas, como reemplazar componentes defectuosos, ya que esto ayuda a evitar el tiempo de inactividad y la pérdida de datos.

Los procedimientos de mantenimiento suponen que el sistema de almacenamiento AFF A800 ya se ha implementado como un nodo de almacenamiento en el entorno ONTAP .
...
Para el sistema de almacenamiento AFF A800, puede realizar procedimientos de mantenimiento en los componentes siguientes.
...
link:nvdimm-battery-replace.html["Batería NVDIMM"]
 a| 
La batería del NVDIMM se encarga de mantener el suministro eléctrico del módulo NVDIMM.
