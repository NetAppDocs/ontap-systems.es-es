...
summary: Comience a reemplazar el controlador en su sistema de almacenamiento AFF A800 apagando el controlador dañado, quitándolo y reemplazándolo, reconfigurando los ajustes del sistema y verificando las operaciones del sistema. 
---
= Flujo de trabajo de reemplazo del controlador - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador en su sistema de almacenamiento AFF A800 apagando el controlador dañado, quitando y reemplazando el controlador, restaurando la configuración del sistema y devolviendo el control de los recursos de almacenamiento al controlador de reemplazo.
