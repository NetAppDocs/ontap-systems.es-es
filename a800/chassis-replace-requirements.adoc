...
summary: Antes de sustituir el chasis de tu sistema AFF A800, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente, que tienes credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias. 
---
= Revisa los requisitos para sustituir un chasis en un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el chasis de tu sistema AFF A800, verifica que cumples los requisitos necesarios para que la sustitución sea exitosa. Esto incluye comprobar que todos los demás componentes del sistema funcionan correctamente, que tienes credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias.
