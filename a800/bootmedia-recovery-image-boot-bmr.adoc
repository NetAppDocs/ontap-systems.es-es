...
summary: Después de instalar el nuevo dispositivo de arranque en tu sistema AFF A800, puedes iniciar el proceso automatizado de recuperación del medio de arranque para restaurar la configuración desde el nodo asociado. 
---
= Arranca la imagen de recuperación en un sistema AFF A800 mediante el proceso de arranque de recuperación automatizado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
