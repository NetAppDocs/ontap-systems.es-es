...
---
= Instala tu sistema AFF A800 siguiendo las instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A800 siguiendo estas instrucciones detalladas paso a paso, desde la preparación del sitio hasta la puesta en marcha del clúster ONTAP.
...
Es necesario realizar un cableado para el clúster de tu plataforma utilizando el método de clúster sin switches de dos nodos o el método de red de interconexión de clúster. Hay un cableado opcional hacia las redes de host Fibre Channel o iSCSI, o hacia el almacenamiento de conexión directa. Este cableado no es exclusivo; puedes tener cableado tanto hacia una red de host como hacia el almacenamiento.
