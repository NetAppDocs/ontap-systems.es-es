...
---
= Sustituye el chasis de tu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el chasis de su sistema AFF A800 cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar los controladores, mover las unidades al chasis de reemplazo, quitar el chasis dañado, instalar el chasis de reemplazo y reinstalar los componentes del chasis.



[[step-1-remove-the-controller-modules-from-the-old-chassis]]
== Paso 1: Retire los módulos del controlador del chasis antiguo

Retire los módulos del controlador del chasis antiguo.
...
Mueva las unidades del chasis antiguo al nuevo.
...
Reemplace el chasis dañado en el rack del equipo o en el gabinete del sistema por el chasis nuevo.
...
== Paso 4: Instale los módulos del controlador en el nuevo chasis

Después de instalar los módulos controladores en el nuevo chasis, inicia el chasis.

En el caso de los pares de alta disponibilidad (HA) con dos módulos controladores en el mismo chasis, el orden en el que instalas los módulos controladores es especialmente importante porque cada módulo intenta reiniciarse en cuanto lo encajas completamente en el chasis.
...
.El futuro
Después de haber reemplazado el chasis AFF A800 dañado y reinstalado los componentes, debelink:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"]
