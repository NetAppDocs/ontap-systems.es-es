...
---
= Apaga los controladores AFF A800 para reemplazar el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apague los controladores de su sistema de almacenamiento AFF A800 para evitar la pérdida de datos y garantizar la estabilidad del sistema al reemplazar el chasis.
