...
summary: Sustituye un módulo DIMM en tu módulo controlador AFF A800 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico en el sistema. 
---
= Sustituye un módulo DIMM en un sistema AFF A800 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en tu sistema AFF A800 cuando el sistema de almacenamiento detecte un número excesivo de errores de memoria corregibles (CECC) o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP.

.Antes de empezar
* Asegúrate de que el resto de componentes del sistema funcionen correctamente. Si no funcionan correctamente, ponte en contacto con soporte técnico.
...
Apague o tome el control del controlador dañado
...
Reemplace el DIMM en el controlador.
