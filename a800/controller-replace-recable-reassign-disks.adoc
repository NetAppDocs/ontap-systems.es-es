...
[role="lead"]
Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema AFF A800 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado o cifrado mediante Onboard Key Manager (OKM).
