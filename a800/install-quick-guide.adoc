...
[role="lead"]
Esta guía da instrucciones gráficas para una instalación típica de su sistema desde el montaje en rack y el cableado hasta la puesta en marcha inicial del sistema. Utilice la link:../media/PDF/215-13082_2023-09_us-en_AFFA800_ISI.pdf["Instrucciones de instalación y configuración de AFF A800"^] Si está familiarizado con la instalación de sistemas de NetApp.
