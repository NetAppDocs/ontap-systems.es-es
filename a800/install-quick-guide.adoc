...
[role="lead"]
Esta guía da instrucciones gráficas para una instalación típica de su sistema desde el montaje en rack y el cableado hasta la puesta en marcha inicial del sistema. Utilice la link:../media/PDF/Jan_2024_Rev3_AFFA800_ISI_IEOPS-1497.pdf["Instrucciones de instalación y configuración de AFF A800"^] Si está familiarizado con la instalación de sistemas de NetApp.
