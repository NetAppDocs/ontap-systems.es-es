...
summary: Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF A800 revisando los requisitos de reemplazo, verificando el estado de cifrado, apagando el controlador, reemplazando el medio de arranque, iniciando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución del soporte de arranque en un sistema AFF A800 mediante el proceso manual de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comience a reemplazar el medio de arranque en su sistema de almacenamiento AFF A800 revisando los requisitos de reemplazo, verificando el estado de cifrado, apagando el controlador, reemplazando el medio de arranque, iniciando la imagen de recuperación, restaurando el cifrado y verificando la funcionalidad del sistema.
