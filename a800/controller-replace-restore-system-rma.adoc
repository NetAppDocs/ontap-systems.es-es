...
summary: Para restablecer el funcionamiento completo de tu sistema AFF A800, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución de la controladora de tu sistema AFF A800, restaura la configuración de NetApp Storage Encryption (si es necesario), confirma que las interfaces lógicas (LIF) informan a sus puertos de origen, realiza una comprobación del estado del clúster y devuelve la pieza defectuosa a NetApp.
