...
summary: Sustituye el NVDIMM de tu módulo controlador AFF A800 cuando el sistema registre que la vida útil de la memoria flash está a punto de finalizar o que el NVDIMM identificado no está en buen estado. No reemplazar un NVDIMM defectuoso puede causar un pánico del sistema. 
---
= Sustituye el NVDIMM en un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el NVDIMM de tu sistema AFF A800 cuando tu sistema registre que la vida útil de la flash está casi al final o que el NVDIMM identificado no está en buen estado. Si no reemplazas un NVDIMM defectuoso, el sistema entrará en pánico.

.Antes de empezar
* Asegúrate de que dispones del módulo NVDIMM de recambio que has recibido de NetApp y de que es compatible con tu sistema AFF A800.
* Asegúrate de que el resto de componentes del sistema de almacenamiento funcionen correctamente. Si no es así, ponte en contacto con el soporte técnico de NetApp.
