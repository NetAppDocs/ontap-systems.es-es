...
---
= Sustituir una tarjeta PCIe en un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una tarjeta PCIe en tu sistema AFF A800 cuando la tarjeta falle o necesite una actualización. El proceso de sustitución consiste en desconectar los cables y los módulos SFP o QSFP, reemplazar la tarjeta y volver a conectar los cables.

.Antes de empezar
* Debe tener disponible la pieza nueva o de repuesto de NetApp .
* Asegúrate de que el resto de componentes del sistema de almacenamiento funcionen correctamente. Si no es así, ponte en contacto con el soporte técnico.
...
== Paso 3: Reemplace la tarjeta PCIe

Sustituye una tarjeta PCIe quitando el cableado y cualquier QSFP o SFP de los puertos de las tarjetas PCIe en el riser de destino, retirando el riser del módulo controlador, quitando y reemplazando la tarjeta PCIe, reinstalando el riser y cualquier QSFP o SFP en los puertos, y volviendo a cablear los puertos.
