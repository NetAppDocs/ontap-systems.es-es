...
---
= Sustituye el controlador en un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador de su sistema AFF A800 cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
Mueve los módulos DIMM del sistema al módulo controlador de recambio.
...
Coloca los módulos NVDIMM en el módulo controlador de recambio.
...
.El futuro
Después de haber reemplazado el controlador A800 dañado, deberálink:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"]
