...
---
= Comprueba la compatibilidad con el cifrado en el soporte de arranque de un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantizar la seguridad de los datos en su sistema de almacenamiento AFF A800, debe verificar la compatibilidad y el estado de la clave de cifrado en el medio de arranque. Compruebe si su versión de ONTAP admite NetApp Volume Encryption (NVE) y, antes de apagar el controlador, compruebe si el administrador de claves está activo.
