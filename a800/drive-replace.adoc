...
---
= Sustituya la unidad SSD o la unidad HDD: AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace una unidad en su sistema AFF A800 cuando una unidad falla o requiere una actualización. El proceso de reemplazo implica identificar la unidad defectuosa, quitarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
