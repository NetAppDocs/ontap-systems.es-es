...
---
= Intercambia en caliente una unidad en un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad de tu sistema AFF A800 cuando una unidad tenga error o sea necesario actualizarla. El proceso de sustitución consiste en identificar la unidad con error, retirarla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
