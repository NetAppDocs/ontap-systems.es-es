...
---
= Completa la sustitución del chasis de un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reinicia los controladores, verifica el estado del sistema y devuelve la pieza defectuosa a NetApp para completar el paso final del procedimiento de sustitución del chasis ASA A250.
