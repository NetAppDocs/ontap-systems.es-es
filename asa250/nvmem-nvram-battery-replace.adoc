...
---
= Sustituye la batería del NVMEM en un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una batería NVMEM defectuosa en un sistema ASA A250 apagando el controlador afectado, abriendo el módulo del controlador e instalando la batería de repuesto. Este procedimiento protege los datos de escritura en caché contra la pérdida debido a una batería degradada.
