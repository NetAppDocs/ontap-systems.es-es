...
summary: Una vez comprobadas las variables de entorno, debes completar los pasos específicos para los sistemas que tengan activado Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE. 
---
= Restablece el cifrado en el soporte de arranque de un sistema ASA A250 después del proceso de recuperación de arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
