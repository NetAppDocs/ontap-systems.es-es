...
summary: Empieza a reemplazar el soporte de arranque en tu sistema de almacenamiento ASA A250 revisando los requisitos de reemplazo, apagando el controlador, reemplazando el soporte de arranque, restaurando la imagen en el soporte de arranque y verificando la funcionalidad del sistema. 
---
= Flujo de trabajo de sustitución de medios de arranque para un sistema ASA A250 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
