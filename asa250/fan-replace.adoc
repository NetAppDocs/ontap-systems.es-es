...
---
= Sustituir un ventilador en un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo de ventilador averiado en un sistema ASA A250 apagando el controlador afectado, abriendo el módulo del controlador e instalando el ventilador de recambio. Este procedimiento mantiene los componentes del controlador refrigerados y previene fallos del sistema relacionados con la temperatura.
