...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema ASA A250 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en tu sistema ASA A250 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la restauración y verificar la configuración del sistema ASA A250, necesitas volver a cablear el sistema y reasignar los discos.
