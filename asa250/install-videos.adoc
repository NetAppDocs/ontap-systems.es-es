...
summary: El vídeo de instalación y configuración muestra cómo instalar y cablear tu nuevo sistema. 
---
= Instala un sistema de almacenamiento ASA A250 con pasos en vídeo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
