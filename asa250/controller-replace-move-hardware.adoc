...
---
= Sustituye el controlador de tu sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema ASA A250 cuando un fallo de hardware lo requiera. El proceso de sustitución implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
.El futuro
Después de que hayas reemplazado el controlador ASA A250 deteriorado, necesitas link:controller-replace-system-config-restore-and-verify.html["restaurar y verificar la configuración del sistema"].
