...
summary: Debes sustituir un módulo DIMM en el módulo controlador cuando tu sistema registre un número creciente de códigos de corrección de errores corregibles ECC. Si no lo haces, se produce un pánico en el sistema. 
---
= Sustituir un módulo DIMM en un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en un sistema ASA A250 cuando el sistema notifique un número creciente de errores ECC corregibles. Este procedimiento incluye apagar el controlador afectado, abrir el módulo del controlador e instalar el módulo DIMM de recambio para evitar un fallo grave del sistema.
