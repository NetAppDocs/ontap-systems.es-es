...
---
= Intercambia en caliente una fuente de alimentación en un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una fuente de alimentación (PSU) averiada en un sistema ASA A250 sin apagar el controlador. Las PSU son redundantes y de rango automático, así que reemplazar una PSU averiada por otra del mismo tipo mantiene el sistema funcionando sin interrupciones.
