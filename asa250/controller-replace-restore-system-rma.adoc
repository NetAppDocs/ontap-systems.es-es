...
summary: Para restablecer el funcionamiento completo del sistema, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza defectuosa a NetApp. 
---
= Completa la sustitución del controlador de un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del controlador de tu sistema ASA A250 a pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption (si es necesario), instalar licencias para el nuevo controlador y devolver la pieza defectuosa a NetApp, como se describe en las instrucciones de RMA enviadas con el kit.
