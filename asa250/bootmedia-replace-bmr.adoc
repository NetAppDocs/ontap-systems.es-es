...
summary: El medio de arranque de tu sistema ASA A250 almacena firmware esencial y datos de configuración. El proceso de reemplazo implica quitar el módulo del controlador, quitar el medio de arranque dañado, instalar el medio de arranque de reemplazo en el módulo del controlador y luego volver a instalar el módulo del controlador. 
---
= Sustituye el soporte de arranque en tu sistema ASA A250 usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El medio de arranque de tu sistema ASA A250 almacena datos esenciales de firmware y configuración. El proceso de reemplazo implica quitar y abrir el módulo del controlador, quitar el medio de arranque dañado, instalar el medio de arranque de reemplazo en el módulo del controlador y luego volver a instalar el módulo del controlador.
