...
summary: Antes de reemplazar el chasis de su sistema ASA A800, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, verificar que tenga credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias. 
---
= Revisa los requisitos para sustituir un chasis en un sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de reemplazar el chasis de su sistema ASA A800, asegúrese de cumplir con los requisitos necesarios para un reemplazo exitoso. Esto incluye verificar que todos los demás componentes del sistema funcionen correctamente, verificar que tenga credenciales de administrador local para ONTAP, el chasis de reemplazo correcto y las herramientas necesarias.
