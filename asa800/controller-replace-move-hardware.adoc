...
---
= Reemplazar el hardware del módulo controlador - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reemplace el controlador de su sistema ASA A800 cuando una falla de hardware lo requiera. El proceso de reemplazo implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
.El futuro
Después de haber reemplazado el controlador ASA A800 dañado, deberálink:controller-replace-system-config-restore-and-verify.html["restaure la configuración del sistema"]
