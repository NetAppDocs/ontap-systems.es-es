...
summary: Apaga el controlador de tu sistema de almacenamiento ASA A800 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el medio de arranque. 
---
= Apaga el controlador de tu sistema ASA A800 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento ASA A800 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automatizado de recuperación del medio de arranque.
