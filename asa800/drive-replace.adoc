...
summary: Debes realizar un intercambio en caliente de una unidad cuando la plataforma registre un mensaje de advertencia en la consola del sistema que indique que una unidad ha fallado. Además, se iluminan tanto el LED de fallo del panel de control del operador como el LED de fallo de la unidad con error. 
---
= Intercambia en caliente una unidad en un sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad en tu sistema ASA A800 cuando una unidad con error o requiera una actualización. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una unidad nueva para garantizar el acceso continuo a los datos y el rendimiento del sistema.
