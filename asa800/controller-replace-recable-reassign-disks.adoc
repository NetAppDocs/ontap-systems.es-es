...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema ASA A800 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en tu sistema ASA A800 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelva el control de los recursos de almacenamiento al controlador de reemplazo para que su sistema ASA A800 pueda reanudar su funcionamiento normal.  El procedimiento de devolución varía según el tipo de cifrado utilizado por su sistema: sin cifrado o cifrado mediante Onboard Key Manager (OKM).
...
Este paso solo se aplica a los sistemas que ejecutan ONTAP en un par HA.
