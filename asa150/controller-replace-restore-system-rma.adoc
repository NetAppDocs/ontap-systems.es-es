...
summary: Para restablecer el funcionamiento completo del sistema, debes restaurar la configuración de NetApp Storage Encryption, instalar licencias para el nuevo controlador y devolver la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema ASA A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
