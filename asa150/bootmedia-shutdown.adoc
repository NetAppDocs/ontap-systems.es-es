...
summary: Apaga el controlador de tu sistema de almacenamiento ASA A150 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque. 
---
= Apaga el controlador de tu sistema ASA A150 antes de reemplazar el soporte de arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento ASA A150 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso manual de recuperación del medio de arranque.
