...
---
= Sustituya el módulo de almacenamiento en caché: ASA A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Sustituya el componente defectuoso por un componente FRU de reemplazo que haya recibido de su proveedor.
