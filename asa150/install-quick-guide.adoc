...
summary: Estos pasos rápidos ofrecen instrucciones ilustradas para instalar tu sistema ASA A150, desde el montaje en rack y el cableado hasta la puesta en marcha inicial del sistema. 
---
= Instala un sistema de almacenamiento ASA A150 siguiendo estos sencillos pasos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
