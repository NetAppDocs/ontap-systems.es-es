...
summary: Use los siguientes vídeos para aprender a montar en rack y conectar los cables del sistema y realizar la configuración inicial del sistema. 
---
= Instala un sistema de almacenamiento ASA A150 con pasos en vídeo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
