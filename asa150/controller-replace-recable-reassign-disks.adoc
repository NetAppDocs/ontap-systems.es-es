...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema ASA A150 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema ASA A150 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
