...
---
= Flujo de trabajo de instalación y configuración de ASA A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Elige el formato que prefieras para instalar tu sistema de almacenamiento ASA A150: instrucciones detalladas paso a paso, guía gráfica rápida o instrucciones en vídeo.
