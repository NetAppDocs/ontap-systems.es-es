...
summary: Esta página proporciona enlaces a los procedimientos de reemplazo de ventiladores por sistema. 
---
= Enlaces de Fan FRU
:allow-uri-read: 
:icons: font
...
[role="lead"]
Esta página proporciona enlaces a los procedimientos de reemplazo de ventiladores organizados por modelo de plataforma.
