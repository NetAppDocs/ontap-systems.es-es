...
summary: Esta página proporciona enlaces a los procedimientos de reemplazo del módulo NVRAM por plataforma. 
---
= Enlaces FRU del módulo NVRAM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esta página proporciona enlaces a los procedimientos de reemplazo del módulo NVRAM organizados por sistema.
