...
* link:../a250/bootmedia-replace-workflow-bmr.html["AFF A250 (recuperación automática)"]
* link:../a250/bootmedia-replace-workflow.html["AFF A250 (recuperación manual)"]
...
* link:../c250/bootmedia-replace-workflow.html["AFF C250 (Recuperación manual)"]
...
* link:../asa-c250/bootmedia-replace-workflow.html["ASA C250 (Recuperación manual)"]
...
* link:../fas500f/bootmedia-replace-workflow.html["FAS500f (Recuperación manual)"]
