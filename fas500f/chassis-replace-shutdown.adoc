...
summary: Para sustituir el chasis, debes apagar los controladores. 
---
= Apaga los controladores del FAS500f para sustituir el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema de almacenamiento FAS500f para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el chasis.
