...
---
= Sustituye el controlador de tu sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema FAS500f cuando un fallo de hardware lo requiera. El proceso de sustitución implica quitar el controlador dañado, mover los componentes al controlador de reemplazo, instalar el controlador de reemplazo y reiniciarlo.
...
.El futuro
Después de que hayas sustituido el controlador FAS500f deteriorado, necesitas link:controller-replace-system-config-restore-and-verify.html["restaurar y verificar la configuración del sistema"].
