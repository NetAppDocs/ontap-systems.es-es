...
summary: Después de comprobar las variables de entorno, debes completar los pasos específicos para los sistemas que tienen habilitado Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE. 
---
= Restablece el cifrado en el soporte de arranque de un sistema FAS500f después del proceso de recuperación mediante arranque manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de sustituir el soporte de arranque, restaura el cifrado si tu sistema FAS500f usa Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption para proteger tus datos.
