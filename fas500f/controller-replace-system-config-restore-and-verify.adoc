...
---
= Restaure y verifique la configuración del sistema - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Después de completar la sustitución del hardware y arrancar tu sistema FAS500f en modo de mantenimiento, necesitas verificar la configuración de bajo nivel del sistema del controlador de reemplazo y reconfigurar los ajustes del sistema según sea necesario.
