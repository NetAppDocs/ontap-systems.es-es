...
---
= Restaurar y verificar la configuración del controlador en un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Una vez completada la sustitución del hardware y tras arrancar tu sistema FAS500f en modo de mantenimiento, necesitas comprobar la configuración de bajo nivel del controlador de reemplazo y volver a configurar los ajustes del sistema según sea necesario.
