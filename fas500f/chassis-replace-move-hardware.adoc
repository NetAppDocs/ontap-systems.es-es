...
---
= Sustituye el chasis de tu sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema FAS500f cuando lo requiera un fallo de hardware. El proceso de sustitución implica quitar los controladores y las fuentes de alimentación (PSUs), quitar las unidades, instalar el chasis de reemplazo y volver a instalar los componentes del chasis.
...
.El futuro
Después de que hayas reemplazado el chasis FAS500f dañado y reinstalado los componentes, necesitas link:chassis-replace-complete-system-restore-rma.html["complete el reemplazo del chasis"]
