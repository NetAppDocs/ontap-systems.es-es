...
---
= Mueva y reemplace la tornillería - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puede usar el siguiente vídeo o los pasos tabulados para reemplazar el chasis; asume la extracción y sustitución del bisel:
