...
---
= Sustituye la batería NVMEM de tu sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puede usar el siguiente vídeo o los pasos tabulados para reemplazar la batería de NVMEM:
...
Después de reemplazar el componente en el módulo controlador, debes volver a instalar el módulo controlador en el chasis y luego arrancarlo.
