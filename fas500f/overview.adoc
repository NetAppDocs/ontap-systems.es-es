...
---
= Especificaciones clave para un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta las especificaciones seleccionadas del sistema de almacenamiento FAS500f, correspondientes a un único par de alta disponibilidad. Visita https://hwu.netapp.com["Hardware Universe de NetApp"^] (HWU) para ver la lista completa de especificaciones del FAS500f.
