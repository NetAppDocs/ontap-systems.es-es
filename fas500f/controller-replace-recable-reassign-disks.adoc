...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS500f pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema FAS500f para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema FAS500f pueda reanudar su funcionamiento normal. Una vez que hayas restaurado y comprobado la configuración del sistema, vuelve a cablear el sistema y reasigna los discos.
...
.El futuro
Después de volver a cablear el sistema y reasignar los discos, necesitas link:controller-replace-restore-system-rma.html["complete el reemplazo de la controladora"].
