...
summary: Sustituyes la batería del reloj en tiempo real del módulo controlador para que los servicios y aplicaciones del sistema que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del reloj en tiempo real en un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puede utilizar el siguiente vídeo o los pasos tabulados para reemplazar la batería RTC:
...
+
image::../media/drw_a250_remove_rtc_batt.png[Cómo extraer la batería RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Número de llamada 1"]
| Tire con cuidado de la lengüeta para separarla del alojamiento de la batería. NOTA: Si lo tira agresivamente, puede desplazar la lengüeta. 
...
NOTE: Anote la polaridad de la batería.
...
+
image::../media/drw_a250_install_rtc_batt.png[Instalación de la batería RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Número de llamada 1"]
| Introduce la batería por debajo de la lengüeta de la carcasa de la batería, con el polo positivo hacia arriba. 
