...
---
= Instala un sistema FAS500f usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:../media/icon_square_1_green.png["Paso 1"]
 a| 
Conecta los puertos de interconexión de clúster entre sí con el cable de interconexión de clúster de 25 GbE
...
.. Selecciona *Red* en el panel izquierdo.
