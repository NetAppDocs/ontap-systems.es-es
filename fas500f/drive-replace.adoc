...
summary: Sustituye una unidad con error en tu sistema de almacenamiento FAS500f sin interrupciones mientras las operaciones de E/S están en curso. La plataforma registra un mensaje de advertencia y se iluminan los LED de fallo cuando falla una unidad, y el procedimiento de sustitución varía ligeramente según si la unidad es una SSD o un HDD. 
---
= Intercambia en caliente una unidad en tu sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad con error en tu sistema de almacenamiento FAS500f sin interrupciones mientras las operaciones de E/S están en curso. La plataforma registra un mensaje de advertencia y se iluminan los LED de fallo cuando falla una unidad, y el procedimiento de sustitución varía ligeramente según si la unidad es una SSD o un HDD.
