...
summary: Sustituye en caliente una unidad con error en tu sistema de almacenamiento FAS500f sin interrumpir el servicio mientras se están realizando operaciones de E/S. La plataforma registra un mensaje de advertencia y enciende los LED de fallo cuando falla una unidad, y el procedimiento de sustitución varía ligeramente dependiendo de si la unidad es una SSD o un HDD. 
---
= Intercambia en caliente una unidad en un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad con error en tu sistema de almacenamiento FAS500f sin interrumpir el servicio mientras se están realizando operaciones de E/S. La plataforma registra un mensaje de advertencia y enciende los LED de fallo cuando falla una unidad, y el procedimiento de sustitución varía ligeramente dependiendo de si la unidad es una SSD o un HDD.
