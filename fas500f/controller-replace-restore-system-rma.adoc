...
---
= Sustitución completa del controlador - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución del controlador de tu sistema FAS500f a pleno funcionamiento, debes restaurar la configuración de NetApp Storage Encryption (si es necesario), instalar licencias para el nuevo controlador y devolver la pieza averiada a NetApp, como se describe en las instrucciones de RMA enviadas con el kit.
