...
summary: Para completar la sustitución del controlador de tu sistema FAS500f, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para completar la sustitución de la controladora de tu sistema FAS500f, restaura la configuración de NetApp Storage Encryption (si es necesario), instala las licencias para la nueva controladora y devuelve la pieza defectuosa a NetApp tal y como se describe en las instrucciones de RMA enviadas con el kit.
