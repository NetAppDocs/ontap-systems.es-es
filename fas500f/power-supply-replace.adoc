...
---
= Intercambia en caliente una fuente de alimentación en tu sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Gira la palanca de la leva para extraer la fuente de alimentación del módulo controlador mientras presionas la lengüeta de bloqueo.
+
[CAUTION]
====
...
+
Las fuentes de alimentación se acoplan al conector interno y se bloquean en su sitio en una sola posición.
