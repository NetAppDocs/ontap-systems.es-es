...
summary: El soporte de arranque de tu sistema FAS500f almacena datos esenciales de firmware y configuración. Sustituirlo implica quitar el módulo controlador, retirar el soporte de arranque con problemas, instalar el soporte de arranque de repuesto y volver a instalar el módulo controlador. 
---
= Sustituye el soporte de arranque de tu sistema FAS500f usando el proceso automatizado de recuperación del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
El soporte de arranque de tu sistema FAS500f almacena datos esenciales de firmware y configuración. Sustituirlo implica quitar el módulo controlador, retirar el soporte de arranque con problemas, instalar el soporte de arranque de repuesto y volver a instalar el módulo controlador.
