...
summary: El medio de arranque almacena un conjunto primario y secundario de archivos de imagen de arranque que el sistema utiliza cuando se inicia. 
---
= Conoce cómo reemplazar el soporte de arranque en un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Descubre para qué sirve el soporte de arranque y qué debes esperar antes de reemplazarlo en un sistema ASA C400, incluidos los requisitos de la unidad flash USB y de red.
