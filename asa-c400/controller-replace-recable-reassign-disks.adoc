...
summary: Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema ASA C400 pueda reanudar su funcionamiento normal. 
---
= Devuelve el controlador en un sistema ASA C400 para reanudar el funcionamiento normal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devuelve el control de los recursos de almacenamiento al controlador de sustitución para que tu sistema ASA C400 pueda reanudar su funcionamiento normal.
