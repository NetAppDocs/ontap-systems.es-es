...
---
= Flujo de trabajo para reemplazar el chasis del ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Revisa qué puedes esperar, incluyendo el nivel de interrupción y los requisitos previos, antes de reemplazar el chasis en un sistema ASA C400.
