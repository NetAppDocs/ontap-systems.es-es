...
summary: Sustituye la batería del reloj en tiempo real de tu módulo controlador ASA C400 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando. 
---
= Sustituye la batería del RTC en un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restablece la sincronización horaria precisa en un sistema ASA C400 reemplazando la batería del RTC en el módulo controlador.
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[Retire el módulo del controlador]
...
.Animación: Sustituya la batería del RTC
video::12ea4bc1-75e2-43e7-be91-b0310000fd34[panopto]
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[Extraiga la batería de RTC]
