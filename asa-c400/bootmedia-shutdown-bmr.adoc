...
summary: Apaga el controlador de tu sistema de almacenamiento ASA C400 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el medio de arranque. 
---
= Apaga el controlador de tu sistema ASA C400 durante el proceso de recuperación automática del arranque
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento ASA C400 para evitar la pérdida de datos y mantener la estabilidad del sistema durante el proceso automático de recuperación del medio de arranque.
