...
---
= Sustituir una tarjeta PCIe o mezzanine en un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Extrae y sustituye una tarjeta PCIe o mezzanine defectuosa del módulo controlador de un sistema ASA C400.
