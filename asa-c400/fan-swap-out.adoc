...
---
= Cambia un ventilador intercambiable en caliente en tu sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de un módulo de ventilador averiado en tu sistema ASA C400 sin interrumpir el servicio para mantener un flujo de aire adecuado y la refrigeración del sistema.
