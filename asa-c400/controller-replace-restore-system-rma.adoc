...
summary: Para restablecer el funcionamiento completo de tu sistema ASA C400, restaura la configuración de NetApp Storage Encryption si es necesario, instala licencias para el nuevo controlador y devuelve la pieza averiada a NetApp. 
---
