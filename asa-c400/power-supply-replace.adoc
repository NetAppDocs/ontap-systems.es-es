...
summary: Sustituye una fuente de alimentación en tu sistema ASA C400 desconectando la PSU objetivo de la fuente de alimentación, desenchufando el cable de alimentación, retirando la PSU antigua, instalando la PSU de reemplazo y luego volviéndola a conectar a la fuente de alimentación. 
---
= Intercambia en caliente una fuente de alimentación en un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una fuente de alimentación averiada en un sistema ASA C400 sin apagar el controlador.
