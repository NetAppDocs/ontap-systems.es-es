...
---
= Instala y configura un sistema ASA C400 siguiendo las instrucciones gráficas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sigue las instrucciones ilustradas para instalar en rack, cablear y poner en marcha rápidamente un sistema ASA C400.
