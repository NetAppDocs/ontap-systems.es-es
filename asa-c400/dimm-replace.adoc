...
summary: Sustituye un módulo DIMM de tu módulo controlador ASA C400 cuando el sistema registre un número creciente de códigos de corrección de errores corregibles o errores ECC no corregibles. No reemplazar un módulo DIMM defectuoso puede causar un pánico del sistema. 
---
= Sustituye un módulo DIMM en un sistema ASA C400 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema ASA C400 cuando el sistema de almacenamiento detecte un número excesivo de errores corregibles de código de corrección de errores (ECC) o un error ECC no corregible, lo cual normalmente es causado por una sola falla de DIMM.
...
|===
Los módulos DIMM se encuentran en los zócalos 2, 4, 13 y 15. El NVDIMM se encuentra en la ranura 11.
