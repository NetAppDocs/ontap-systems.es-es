...
---
= Sustituye la batería del NVDIMM en un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye la batería del NVDIMM en tu sistema ASA C400 quitando el módulo controlador, cambiando la batería y volviendo a instalar el módulo controlador.
