...
summary: Apaga el controlador de tu sistema de almacenamiento ASA C400 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el controlador. 
---
= Apaga el controlador defectuoso de tu sistema ASA C400 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador de tu sistema de almacenamiento ASA C400 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el controlador.
...
====
.El futuro
Después de apagar el controlador ASA C400, necesitas link:controller-replace-move-hardware.html["sustituya el controlador"].
