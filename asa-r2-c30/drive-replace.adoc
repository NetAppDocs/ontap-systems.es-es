...
summary: Realiza un intercambio en caliente de una unidad en tu sistema de almacenamiento ASA C30 cuando una unidad tenga error o necesite una actualización. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema. 
---
= Intercambia en caliente una unidad en un sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad en tu sistema de almacenamiento ASA C30 cuando una unidad tenga error o necesite una actualización. El proceso de sustitución consiste en identificar la unidad con error, extraerla de forma segura e instalar una nueva unidad para garantizar el acceso continuo a los datos y el rendimiento del sistema.
