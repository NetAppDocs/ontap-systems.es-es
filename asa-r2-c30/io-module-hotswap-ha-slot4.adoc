...
summary: 'El módulo de E/S de clúster y alta disponibilidad (HA) admite interconexiones para agrupamiento en clústeres y alta disponibilidad. Puede intercambiar el módulo en caliente en su sistema de almacenamiento ASA C30 cuando falle y si su sistema de almacenamiento cumple con los requisitos específicos.' 
---
