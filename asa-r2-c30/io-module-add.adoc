...
summary: Agregue un módulo de E/S a su sistema de almacenamiento ASA C30 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos. 
---
= Agrega un módulo de I/O a un sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Agregue un módulo de E/S a su sistema de almacenamiento ASA C30 para mejorar la conectividad de red y ampliar la capacidad de su sistema para manejar el tráfico de datos.

Puede agregar un módulo de E/S a su sistema de almacenamiento ASA C30 si hay ranuras disponibles. Si todas las ranuras están ocupadas, puede reemplazar un módulo existente para agregar uno nuevo.
