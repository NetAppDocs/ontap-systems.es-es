...
summary: Antes de sustituir el medio de arranque de tu sistema de almacenamiento ASA C30, asegúrate de que cumples los requisitos y consideraciones necesarios para que la sustitución se realice correctamente. Esto incluye verificar que tienes el medio de arranque de reemplazo correcto, confirmar que el puerto e0M wrench del controlador con problemas funciona correctamente y determinar si Onboard Key Manager o External Key Manager están habilitados. 
---
= Revisa los requisitos para la recuperación automática del soporte de arranque en tu sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
