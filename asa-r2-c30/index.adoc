...
summary: Para los sistemas de almacenamiento ASA C30, se pueden realizar procedimientos de mantenimiento en los componentes siguientes. 
---
= Mantener el hardware de ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para los sistemas de almacenamiento ASA C30, se pueden realizar procedimientos de mantenimiento en los componentes siguientes.
