...
summary: Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento ASA C30 si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP. 
---
= Realiza un intercambio en caliente de un módulo de E/S en tu sistema ASA C30 sin necesidad de apagarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes intercambiar en caliente un módulo de E/S Ethernet en tu sistema de almacenamiento ASA C30 si un módulo falla y tu sistema de almacenamiento cumple todos los requisitos de versión de ONTAP.
