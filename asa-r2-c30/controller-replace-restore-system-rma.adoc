...
summary: Para completar la sustitución del controlador de tu sistema de almacenamiento ASA C30, primero restaura la configuración de NetApp Storage Encryption si es necesario e instala las licencias necesarias en el nuevo controlador. Luego, confirma que las interfaces lógicas están reportando a sus puertos de origen y realiza una comprobación del estado del clúster. Por último, registra el número de serie del nuevo controlador y luego devuelve la pieza averiada a NetApp. 
---
= Completa la sustitución del controlador de un sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
