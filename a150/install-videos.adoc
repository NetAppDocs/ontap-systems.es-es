...
---
= Instala un sistema AFF A150 siguiendo las instrucciones en vídeo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala y conecta tu sistema de almacenamiento AFF A150 siguiendo las instrucciones paso a paso del vídeo.
