...
---
= Sustituye el chasis de tu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el chasis de tu sistema AFF A150 cuando un fallo de hardware lo requiera. El proceso de sustitución implica mover las fuentes de alimentación, las unidades y los módulos controladores del chasis con problemas al chasis de reemplazo.
