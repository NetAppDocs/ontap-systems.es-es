...
---
= Sustituye el controlador en un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A150 cuando lo requiera un fallo de hardware. El proceso de sustitución consiste en retirar el módulo de controlador con fallo, mover los componentes FRU al controlador de reemplazo, instalar el módulo de controlador de reemplazo en el chasis e iniciar el sistema en modo de mantenimiento.
