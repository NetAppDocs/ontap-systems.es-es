...
---
= Intercambia en caliente una unidad en un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye en caliente una unidad con error en tu sistema AFF A150 sin interrumpir el servicio, incluso mientras se están realizando operaciones de E/S, para recuperar la capacidad de almacenamiento y el rendimiento del sistema.
