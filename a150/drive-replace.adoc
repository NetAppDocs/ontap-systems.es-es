...
---
= Sustituye una unidad en tu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad con error en tu sistema AFF A150 sin interrumpir el servicio mientras se están realizando operaciones de E/S para restablecer la capacidad de almacenamiento y el rendimiento.
