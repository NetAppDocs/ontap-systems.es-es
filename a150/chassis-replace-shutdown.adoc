...
---
= Apaga los controladores AFF A150 para reemplazar el chasis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga los controladores de tu sistema de almacenamiento AFF A150 para evitar la pérdida de datos y asegurar la estabilidad del sistema cuando reemplaces el chasis.
