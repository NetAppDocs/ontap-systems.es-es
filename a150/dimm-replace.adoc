...
summary: Debes sustituir un DIMM en el controlador cuando tu sistema de almacenamiento encuentre errores como errores CECC excesivos basados en alertas de Health Monitor o errores ECC no corregibles, normalmente causados por una falla de un solo DIMM que impide que el sistema de almacenamiento arranque ONTAP. 
---
= Sustituye un módulo DIMM en tu sistema AFF A150 para solucionar errores de memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un módulo DIMM en tu sistema AFF A150 cuando el sistema de almacenamiento detecte un número excesivo de errores de memoria corregibles (CECC) o no corregibles. Estos errores pueden impedir que el sistema de almacenamiento arranque ONTAP.
