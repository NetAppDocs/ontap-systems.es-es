...
[role="lead"]
Aprenda a instalar su sistema AFF A150.

Si tiene una configuración de MetroCluster, utilice https://["Documentación de MetroCluster"^].
...
[role="lead"]
Para instalar su sistema AFF A150, cree una cuenta en el sitio de soporte de NetApp, registre su sistema y obtenga las claves de licencia. También es necesario realizar el inventario del número y tipo de cables adecuados para el sistema y recopilar información específica de la red.
...
.. https://["Registre su sistema"].


. Descargue e instale https://["Config Advisor"] en el portátil.
. Realice un inventario y anote el número y los tipos de cables recibidos.
+
En la siguiente tabla se identifican los tipos de cables que pueden recibir. Si recibe un cable que no aparece en la tabla, consulte https://["Hardware Universe de NetApp"] para localizar el cable e identificar su uso.
...
|===
. https://["Descargue y complete la Hoja de datos de configuración de clúster"].
...
. Configure el sistema con los datos recogidos en el https://["Guía de configuración de ONTAP"].
. Configure su cuenta y descargue Active IQ Config Advisor:
+
.. Inicie sesión en su https://["cuenta existente o cuenta create and"].
.. https://["Regístrese"] su sistema.
.. Descargue https://["Active IQ Config Advisor"].


. Compruebe el estado del sistema ejecutando Config Advisor.
. Después de completar la configuración inicial, vaya a la https://["Documentación de ONTAP"] Sitio para obtener información sobre la configuración de características adicionales en ONTAP.
...
NOTE: El formato de la dirección es https://[].
