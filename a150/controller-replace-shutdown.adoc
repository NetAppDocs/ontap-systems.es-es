...
---
= Apaga el controlador en tu sistema AFF A150 antes de reemplazar el controlador
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema de almacenamiento AFF A150 para evitar la pérdida de datos y asegurar la estabilidad del sistema al reemplazar el controlador.
