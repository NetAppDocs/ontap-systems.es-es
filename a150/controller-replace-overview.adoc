...
---
= Revisa los requisitos antes de sustituir el controlador de tu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador en tu sistema AFF A150, asegúrate de que cumples con los requisitos necesarios para que el reemplazo sea exitoso. Verifica que todas las bandejas de discos estén funcionando correctamente, que el controlador en buen estado pueda hacerse cargo del controlador con problemas y que elijas el procedimiento de reemplazo correcto para tu versión de ONTAP.
