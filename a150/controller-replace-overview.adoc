...
---
= Consulta los requisitos para sustituir el controlador de tu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF A150, asegúrate de cumplir los requisitos necesarios para que la sustitución sea exitosa. Esto incluye verificar que todas las bandejas de discos funcionan correctamente, que el controlador en buen estado puede hacerse cargo del controlador con problemas y que eliges el procedimiento de sustitución correcto para tu versión de ONTAP.
