...
---
= Arranca la imagen de recuperación en un sistema AFF A150 usando el proceso de arranque manual de recuperación
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Una vez instalado el nuevo soporte de arranque en tu sistema AFF A150, arranca la imagen de recuperación de ONTAP desde una unidad USB para restaurar el sistema de archivos y comprobar las variables de entorno.
