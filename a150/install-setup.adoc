...
---
= Elige cómo instalar tu sistema de almacenamiento AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Elige el formato que prefieras para instalar tu sistema de almacenamiento AFF A150: instrucciones detalladas paso a paso, guía gráfica rápida o instrucciones en vídeo.
