...
[role="lead"]
Verifica el estado de HA del chasis, vuelve a los agregados, y devuelve la parte con error a NetApp para completar el reemplazo del chasis de tu sistema AFF A150.
