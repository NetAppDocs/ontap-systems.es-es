...
---
= Completa la sustitución del chasis de un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Este procedimiento completa la sustitución del chasis de tu sistema AFF A150 verificando el estado de alta disponibilidad (HA), cambiando de nuevo los agregados y devolviendo el chasis averiado a NetApp.
