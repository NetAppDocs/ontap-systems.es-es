...
---
= Instala tu sistema AFF A150 usando instrucciones detalladas paso a paso
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instala tu sistema de almacenamiento AFF A150 siguiendo estas instrucciones detalladas paso a paso, desde la preparación del sitio hasta la puesta en marcha del clúster ONTAP.
...
*Advertencia:* Si vas a instalar ONTAP 9.13.1P8 - 9.13.1P11, ONTAP 9.14.1P1 - 9.14.1P7 u ONTAP 9.15.1 - 9.15.1P2 y tu sistema contiene 10 o más unidades de estado sólido internas, realiza pasos adicionales para preparar el sistema para la instalación. Consulta el problema  https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-285173["CONTAP-285173: ADP no deja una partición raíz de repuesto en un AFF A150 con 10 o más unidades internas"^].
...
** Cables de red adicionales para conectar tu sistema al switch de red y al portátil o a la consola con un navegador web
** Un ordenador portátil o una consola con conexión RJ-45 y acceso a un navegador web
...
Instalas tu sistema en un rack de cuatro montantes o en un armario de sistema NetApp, según corresponda.
...
Interconexión en clúster
 ...
 a| 
image::../media/icon_square_2_orange.png[Número de llamada 2]
 a| 
Las controladoras a los switches de red de datos del host
 ...
 a| 
image::../media/icon_square_3_purple.png[Número de llamada 3]
 a| 
...
--
Configuraciones de red Ethernet:: Utiliza el cable RJ45 de categoría 6 para cablear los puertos e0c hasta e0f a tu red principal, como se muestra en la siguiente ilustración.
+
--
...
** Controladora 2: Puerto 0b al puerto IOM B 3 en la última bandeja de unidades de la pila. + image:../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png["Conector mini-SAS a mini-SAS"] MINI-SAS HD a mini-SAS HD cables
...
.. Selecciona *Red* en el panel de la izquierda, haz clic con el botón derecho y selecciona *refresh*.
