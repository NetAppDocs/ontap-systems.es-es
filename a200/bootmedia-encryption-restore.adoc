...
summary: Restaurar el cifrado en el medio de arranque de reemplazo. El sistema AFF A200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque. 
---
= Restablece el cifrado en el soporte de arranque de un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaurar el cifrado en el medio de arranque de reemplazo. El sistema AFF A200 solo admite procedimientos de recuperación de medios de arranque manuales. No se admite la recuperación automática de medios de arranque.
