...
---
= Sustituir un módulo DIMM en tu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye un DIMM en tu sistema AFF A200 cuando el sistema de almacenamiento detecta un número excesivo de errores ECC corregibles o un error ECC no corregible, lo que normalmente es causado por una falla en un solo DIMM.
