...
---
= Intercambia en caliente una fuente de alimentación en un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza el intercambio en caliente de una fuente de alimentación en tu sistema AFF A200 apagando, desconectando y retirando la unidad averiada, luego instala y vuelve a conectar la de reemplazo.
...
+
Si tiene un sistema AFF A200, se libera una solapa de plástico dentro de la ranura ahora vacía para cubrir la apertura y mantener el flujo de aire y la refrigeración.
