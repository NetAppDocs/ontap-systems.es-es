...
---
= Intercambia en caliente una unidad en un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Realiza un intercambio en caliente de una unidad con error en tu sistema AFF A200 sin interrumpir el I/O. El AFF A200 es compatible tanto con SSD como con HDD, cada uno con su propio procedimiento de sustitución.
