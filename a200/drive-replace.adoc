...
---
= Sustituye una unidad en un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye una unidad con error en tu sistema AFF A200 sin interrumpir el I/O. El AFF A200 es compatible tanto con unidades SSD como con HDD, y cada una tiene un procedimiento de sustitución específico.
