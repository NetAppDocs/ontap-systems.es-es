...
---
= Completa la sustitución del controlador de un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del controlador de tu sistema AFF A200 restableciendo la configuración de cifrado de almacenamiento de NetApp (si es necesario), instalando licencias para el nuevo controlador y devolviendo la unidad con error a NetApp.
