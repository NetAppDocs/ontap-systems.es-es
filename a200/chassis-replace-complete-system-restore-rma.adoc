...
---
= Completa la sustitución del chasis de un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sustitución del chasis de tu sistema AFF A200 comprobando el estado de alta disponibilidad (HA) del chasis y devolviendo el componente con error a NetApp.
