...
---
= Revisa los requisitos antes de sustituir el controlador de tu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de sustituir el controlador de tu sistema AFF A200, revisa los requisitos previos para el procedimiento de sustitución y selecciona el adecuado para tu versión de ONTAP.
