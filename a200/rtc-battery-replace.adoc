...
---
= Cambia la batería del reloj en tiempo real de tu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cambia la batería del reloj en tiempo real (RTC) de tu sistema AFF A200 para garantizar que los servicios y aplicaciones que dependen de una sincronización horaria precisa sigan funcionando.
