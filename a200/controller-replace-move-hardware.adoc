...
---
= Sustituir el controlador en un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sustituye el controlador de tu sistema AFF A200 retirando el controlador defectuoso, trasladando los componentes FRU al módulo controlador de repuesto, instalándolo en el chasis y arrancando en modo de mantenimiento.
...
IMPORTANT: Durante el proceso de arranque, puede ver los siguientes mensajes:
