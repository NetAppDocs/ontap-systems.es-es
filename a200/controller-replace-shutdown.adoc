...
---
= Apaga el controlador defectuoso de tu sistema AFF A200 antes de reemplazarlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Apaga el controlador defectuoso de tu sistema AFF A200 antes de reemplazarlo, tomando el control y deteniéndolo hasta que aparezca el indicador LOADER.
